...
> bool, date, datetime, dict, float, int, list, str, none_type presigned_upload_url_connect_v1_presigned_url()
...
from openapi_client.api import presigned_urls__connect_v1_api
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = presigned_urls__connect_v1_api.PresignedUrlsConnectV1Api(api_client)
    ...
    try:
        # Request a presigned upload URL for a new Custom Connector Plugin.
        api_response = api_instance.presigned_upload_url_connect_v1_presigned_url(unknown_base_type=unknown_base_type)
        pprint(api_response)
