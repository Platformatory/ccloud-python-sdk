...
> bool, date, datetime, dict, float, int, list, str, none_type create_ksqldbcm_v2_cluster()
...
from openapi_client.api import clusters__ksqldbcm_v2_api
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = clusters__ksqldbcm_v2_api.ClustersKsqldbcmV2Api(api_client)
    ...
    try:
        # Create a Cluster
        api_response = api_instance.create_ksqldbcm_v2_cluster(unknown_base_type=unknown_base_type)
        pprint(api_response)
...
> bool, date, datetime, dict, float, int, list, str, none_type get_ksqldbcm_v2_cluster(environment, id)
...
> bool, date, datetime, dict, float, int, list, str, none_type list_ksqldbcm_v2_clusters(environment)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List of Clusters
        api_response = api_instance.list_ksqldbcm_v2_clusters(environment)
        pprint(api_response)
    except openapi_client.ApiException as e:
