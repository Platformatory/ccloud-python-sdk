...
> bool, date, datetime, dict, float, int, list, str, none_type create_notifications_v1_integration()
...
from openapi_client.api import integrations__notifications_v1_api
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = integrations__notifications_v1_api.IntegrationsNotificationsV1Api(api_client)
    ...
    try:
        # Create an Integration
        api_response = api_instance.create_notifications_v1_integration(unknown_base_type=unknown_base_type)
        pprint(api_response)
...
> bool, date, datetime, dict, float, int, list, str, none_type get_notifications_v1_integration(id)
...
> bool, date, datetime, dict, float, int, list, str, none_type list_notifications_v1_integrations()
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Test a Webhook, Slack or Microsoft Teams integration
        api_instance.test_notifications_v1_integration(unknown_base_type=unknown_base_type)
    except openapi_client.ApiException as e:
...
> bool, date, datetime, dict, float, int, list, str, none_type update_notifications_v1_integration(id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = integrations__notifications_v1_api.IntegrationsNotificationsV1Api(api_client)
    id = "id_example" # str | The unique identifier for the integration.
    notifications_v1_integration = NotificationsV1Integration(
        metadata=None,
        display_name="Slack integration",
        description="A Slack channel integration",
        target=None,
    ) # NotificationsV1Integration |  (optional)

    # example passing only required values which don't have defaults set
    try:
        # Update an Integration
        api_response = api_instance.update_notifications_v1_integration(id)
        pprint(api_response)
    except openapi_client.ApiException as e:
