...
> bool, date, datetime, dict, float, int, list, str, none_type create_networking_v1_peering()
...
from openapi_client.api import peerings__networking_v1_api
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = peerings__networking_v1_api.PeeringsNetworkingV1Api(api_client)
    ...
    try:
        # Create a Peering
        api_response = api_instance.create_networking_v1_peering(unknown_base_type=unknown_base_type)
        pprint(api_response)
...
> bool, date, datetime, dict, float, int, list, str, none_type get_networking_v1_peering(environment, id)
...
> bool, date, datetime, dict, float, int, list, str, none_type list_networking_v1_peerings(environment)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    spec_display_name = MultipleSearchFilter(["prod-peering-uscentral1","prod-peering-use1"]) # MultipleSearchFilter | Filter the results by exact match for spec.display_name. Pass multiple times to see results matching any of the values. (optional)
    ...
    try:
        # List of Peerings
        api_response = api_instance.list_networking_v1_peerings(environment)
        pprint(api_response)
    except openapi_client.ApiException as e:
...
> bool, date, datetime, dict, float, int, list, str, none_type update_networking_v1_peering(id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update a Peering
        api_response = api_instance.update_networking_v1_peering(id)
        pprint(api_response)
    except openapi_client.ApiException as e:
    ...
    try:
        # Update a Peering
        api_response = api_instance.update_networking_v1_peering(id, unknown_base_type=unknown_base_type)
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling PeeringsNetworkingV1Api->update_networking_v1_peering: %s\n" % e)
```
