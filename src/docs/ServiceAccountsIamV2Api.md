...
> bool, date, datetime, dict, float, int, list, str, none_type create_iam_v2_service_account()
...
from openapi_client.api import service_accounts__iam_v2_api
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = service_accounts__iam_v2_api.ServiceAccountsIamV2Api(api_client)
    ...
    try:
        # Create a Service Account
        api_response = api_instance.create_iam_v2_service_account(unknown_base_type=unknown_base_type)
        pprint(api_response)
...
> bool, date, datetime, dict, float, int, list, str, none_type get_iam_v2_service_account(id)
...
> bool, date, datetime, dict, float, int, list, str, none_type list_iam_v2_service_accounts()
...
> bool, date, datetime, dict, float, int, list, str, none_type update_iam_v2_service_account(id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = service_accounts__iam_v2_api.ServiceAccountsIamV2Api(api_client)
    id = "id_example" # str | The unique identifier for the service account.
    iam_v2_service_account_update = IamV2ServiceAccountUpdate(
        metadata=None,
        description="Doc's repair bot for the DeLorean",
    ) # IamV2ServiceAccountUpdate |  (optional)

    # example passing only required values which don't have defaults set
    try:
        # Update a Service Account
        api_response = api_instance.update_iam_v2_service_account(id)
        pprint(api_response)
    except openapi_client.ApiException as e:
