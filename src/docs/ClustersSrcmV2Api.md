...
> bool, date, datetime, dict, float, int, list, str, none_type create_srcm_v2_cluster()
...
from openapi_client.api import clusters__srcm_v2_api
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = clusters__srcm_v2_api.ClustersSrcmV2Api(api_client)
    ...
    try:
        # Create a Cluster
        api_response = api_instance.create_srcm_v2_cluster(unknown_base_type=unknown_base_type)
        pprint(api_response)
...
# **get_srcm_v2_cluster**
> bool, date, datetime, dict, float, int, list, str, none_type get_srcm_v2_cluster(environment, id)
...
> bool, date, datetime, dict, float, int, list, str, none_type list_srcm_v2_clusters(environment)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List of Clusters
        api_response = api_instance.list_srcm_v2_clusters(environment)
        pprint(api_response)
    except openapi_client.ApiException as e:
...
> bool, date, datetime, dict, float, int, list, str, none_type update_srcm_v2_cluster(id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update a Cluster
        api_response = api_instance.update_srcm_v2_cluster(id)
        pprint(api_response)
    except openapi_client.ApiException as e:
    ...
    try:
        # Update a Cluster
        api_response = api_instance.update_srcm_v2_cluster(id, unknown_base_type=unknown_base_type)
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling ClustersSrcmV2Api->update_srcm_v2_cluster: %s\n" % e)
```
