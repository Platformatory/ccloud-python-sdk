...
> bool, date, datetime, dict, float, int, list, str, none_type create_iam_v2_invitation()
...
from openapi_client.api import invitations__iam_v2_api
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = invitations__iam_v2_api.InvitationsIamV2Api(api_client)
    ...
    try:
        # Create an Invitation
        api_response = api_instance.create_iam_v2_invitation(unknown_base_type=unknown_base_type)
        pprint(api_response)
...
> bool, date, datetime, dict, float, int, list, str, none_type get_iam_v2_invitation(id)
...
> bool, date, datetime, dict, float, int, list, str, none_type list_iam_v2_invitations()
