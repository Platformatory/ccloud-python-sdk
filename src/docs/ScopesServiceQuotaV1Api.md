...
> bool, date, datetime, dict, float, int, list, str, none_type get_service_quota_v1_scope(id)
...
from openapi_client.api import scopes__service_quota_v1_api
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = scopes__service_quota_v1_api.ScopesServiceQuotaV1Api(api_client)
...
> bool, date, datetime, dict, float, int, list, str, none_type list_service_quota_v1_scopes()
