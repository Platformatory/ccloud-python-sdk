...
> bool, date, datetime, dict, float, int, list, str, none_type create_networking_v1_private_link_attachment()
...
from openapi_client.api import private_link_attachments__networking_v1_api
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = private_link_attachments__networking_v1_api.PrivateLinkAttachmentsNetworkingV1Api(api_client)
    ...
    try:
        # Create a Private Link Attachment
        api_response = api_instance.create_networking_v1_private_link_attachment(unknown_base_type=unknown_base_type)
        pprint(api_response)
...
> bool, date, datetime, dict, float, int, list, str, none_type get_networking_v1_private_link_attachment(environment, id)
...
> bool, date, datetime, dict, float, int, list, str, none_type list_networking_v1_private_link_attachments(environment)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    spec_display_name = MultipleSearchFilter(["prod-gcp-us-central1","prod-aws-useast1"]) # MultipleSearchFilter | Filter the results by exact match for spec.display_name. Pass multiple times to see results matching any of the values. (optional)
    ...
    try:
        # List of Private Link Attachments
        api_response = api_instance.list_networking_v1_private_link_attachments(environment)
        pprint(api_response)
    except openapi_client.ApiException as e:
...
> bool, date, datetime, dict, float, int, list, str, none_type update_networking_v1_private_link_attachment(id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update a Private Link Attachment
        api_response = api_instance.update_networking_v1_private_link_attachment(id)
        pprint(api_response)
    except openapi_client.ApiException as e:
    ...
    try:
        # Update a Private Link Attachment
        api_response = api_instance.update_networking_v1_private_link_attachment(id, unknown_base_type=unknown_base_type)
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling PrivateLinkAttachmentsNetworkingV1Api->update_networking_v1_private_link_attachment: %s\n" % e)
```
