...
class Error(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            id (str): A unique identifier for this particular occurrence of the problem.. [optional]  # noqa: E501
            status (str): The HTTP status code applicable to this problem, expressed as a string value.. [optional]  # noqa: E501
            code (str): An application-specific error code, expressed as a string value.. [optional]  # noqa: E501
            title (str): A short, human-readable summary of the problem. It **SHOULD NOT** change from occurrence to occurrence of the problem, except for purposes of localization.. [optional]  # noqa: E501
