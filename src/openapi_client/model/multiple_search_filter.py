...
class MultipleSearchFilter(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """MultipleSearchFilter - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([str]): Filter a collection by a string search for one or more values.  # noqa: E501

        Keyword Args:
            value ([str]): Filter a collection by a string search for one or more values.  # noqa: E501
