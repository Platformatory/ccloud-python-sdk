...
class NotificationsV1UserEmailTarget(ModelNormal):
    ...
    def _from_openapi_data(cls, user, *args, **kwargs):  # noqa: E501
        """NotificationsV1UserEmailTarget - a model defined in OpenAPI

        Args:
            user (str): ID of the user

        Keyword Args:
            kind (str): Email Integration type for User. defaults to "UserEmail", must be one of ["UserEmail", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "UserEmail")
