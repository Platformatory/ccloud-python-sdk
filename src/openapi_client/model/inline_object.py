...
class InlineObject(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            name (str): Name of the connector to create.. [optional]  # noqa: E501
            config ({str: (str,)}): Configuration parameters for the connector. All values should be strings.. [optional]  # noqa: E501
        """
