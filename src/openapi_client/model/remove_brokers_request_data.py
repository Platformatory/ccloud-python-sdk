...
class RemoveBrokersRequestData(ModelNormal):
    ...
    attribute_map = {
        'broker_ids': 'broker_ids',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, broker_ids, *args, **kwargs):  # noqa: E501
        """RemoveBrokersRequestData - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, broker_ids, *args, **kwargs):  # noqa: E501
        """RemoveBrokersRequestData - a model defined in OpenAPI
