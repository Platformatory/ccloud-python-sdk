...
def lazy_import():
    ...
    globals()['RemoveBrokerTaskData'] = RemoveBrokerTaskData
    globals()['RemoveBrokerTaskDataListAllOf'] = RemoveBrokerTaskDataListAllOf
    globals()['ResourceCollection'] = ResourceCollection
    globals()['ResourceCollectionMetadata'] = ResourceCollectionMetadata


class RemoveBrokerTaskDataList(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'data': ([RemoveBrokerTaskData],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """RemoveBrokerTaskDataList - a model defined in OpenAPI

        Keyword Args:
            kind (str):
            metadata (ResourceCollectionMetadata):
            data ([RemoveBrokerTaskData]):
