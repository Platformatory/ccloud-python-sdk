...
class ConnectV1CustomConnectorPlugin(ModelNormal):
    ...
    validations = {
        ...
        ('documentation_link',): {
            'max_length': 512,
            'regex': {
                'pattern': r'^$|^(http:\/\/|https:\/\/).+',  # noqa: E501
            },
        },
        ('connector_class',): {
            'max_length': 150,
            'regex': {
                'pattern': r'^(([a-zA-Z][a-zA-Z_$0-9]*(\.[a-zA-Z][a-zA-Z_$0-9]*)*)\.)?([a-zA-Z][a-zA-Z_$0-9]*)$',  # noqa: E501
            },
        },
    }
    ...
    def openapi_types():
        ...
        return {
            ...
            'content_format': (str,),  # noqa: E501
            'description': (str,),  # noqa: E501
            'documentation_link': (str,),  # noqa: E501
            'connector_class': (str,),  # noqa: E501
            'connector_type': (str,),  # noqa: E501
            'sensitive_config_properties': ([str],),  # noqa: E501
            'upload_source': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'content_format': 'content_format',  # noqa: E501
        'description': 'description',  # noqa: E501
        'documentation_link': 'documentation_link',  # noqa: E501
        'connector_class': 'connector_class',  # noqa: E501
        'connector_type': 'connector_type',  # noqa: E501
        'sensitive_config_properties': 'sensitive_config_properties',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ConnectV1CustomConnectorPlugin - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            api_version (str): APIVersion defines the schema version of this representation of a resource.. [optional] if omitted the server will use the default value of "connect/v1"  # noqa: E501
            kind (str): Kind defines the object this REST resource represents.. [optional] if omitted the server will use the default value of "CustomConnectorPlugin"  # noqa: E501
            ...
            display_name (str): Display name of Custom Connector Plugin.. [optional]  # noqa: E501
            content_format (str): Archive format of Custom Connector Plugin.. [optional]  # noqa: E501
            description (str): Description of Custom Connector Plugin.. [optional]  # noqa: E501
            documentation_link (str): Document link of Custom Connector Plugin.. [optional]  # noqa: E501
            connector_class (str): Java class or alias for connector. You can get connector class from connector documentation provided by developer.. [optional]  # noqa: E501
            connector_type (str): Custom Connector type. . [optional]  # noqa: E501
            sensitive_config_properties ([str]): A sensitive property is a connector configuration property that must be hidden after a user enters property value when setting up connector.. [optional]  # noqa: E501
            upload_source ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): [immutable] Upload source of Custom Connector Plugin. Only required in `create` request, will be ignored in `read`, `update` or `list`.. [optional]  # noqa: E501
        """
