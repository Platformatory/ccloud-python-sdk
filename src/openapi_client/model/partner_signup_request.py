...
class PartnerSignupRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, organization, entitlement, *args, **kwargs):  # noqa: E501
        """PartnerSignupRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, organization, entitlement, *args, **kwargs):  # noqa: E501
        """PartnerSignupRequest - a model defined in OpenAPI
