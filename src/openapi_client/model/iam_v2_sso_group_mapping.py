...
class IamV2SsoGroupMapping(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """IamV2SsoGroupMapping - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            api_version (str): APIVersion defines the schema version of this representation of a resource.. [optional] if omitted the server will use the default value of "iam.v2/sso"  # noqa: E501
            kind (str): Kind defines the object this REST resource represents.. [optional] if omitted the server will use the default value of "GroupMapping"  # noqa: E501
            ...
            display_name (str): The name of the group mapping.. [optional]  # noqa: E501
            description (str): A description explaining the purpose and use of the group mapping.. [optional]  # noqa: E501
            filter (str): A single group identifier or a condition based on [supported CEL operators](https://docs.confluent.io/cloud/current/access-management/authenticate/sso/group-mapping/overview.html#supported-cel-operators-for-group-mapping) that defines which groups are included.. [optional]  # noqa: E501
            principal (str): The unique federated identity associated with this group mapping.. [optional]  # noqa: E501
            state (str): The current state of the group mapping.. [optional]  # noqa: E501
        """
