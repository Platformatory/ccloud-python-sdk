...
def lazy_import():
    ...
    globals()['AlterMirrorStatusResponseData'] = AlterMirrorStatusResponseData
    globals()['AlterMirrorStatusResponseDataListAllOf'] = AlterMirrorStatusResponseDataListAllOf
    globals()['ResourceCollection'] = ResourceCollection
    globals()['ResourceCollectionMetadata'] = ResourceCollectionMetadata


class AlterMirrorStatusResponseDataList(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'data': ([AlterMirrorStatusResponseData],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AlterMirrorStatusResponseDataList - a model defined in OpenAPI

        Keyword Args:
            kind (str):
            metadata (ResourceCollectionMetadata):
            data ([AlterMirrorStatusResponseData]):
