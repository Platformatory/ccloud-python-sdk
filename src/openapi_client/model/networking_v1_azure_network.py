...
class NetworkingV1AzureNetwork(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'private_link_service_aliases': ({str: (str,)},),  # noqa: E501
            'private_link_service_resource_ids': ({str: (str,)},),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'private_link_service_aliases': 'private_link_service_aliases',  # noqa: E501
        'private_link_service_resource_ids': 'private_link_service_resource_ids',  # noqa: E501
    }

    read_only_vars = {
        'vnet',  # noqa: E501
        'subscription',  # noqa: E501
        'private_link_service_aliases',  # noqa: E501
        'private_link_service_resource_ids',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, vnet, subscription, *args, **kwargs):  # noqa: E501
        """NetworkingV1AzureNetwork - a model defined in OpenAPI

        Args:
            vnet (str): The resource ID of the Confluent Cloud VNet.
            subscription (str): The Azure Subscription ID associated with the Confluent Cloud VPC.

        Keyword Args:
            kind (str): Network kind type.. defaults to "AzureNetwork", must be one of ["AzureNetwork", ]  # noqa: E501
            ...
            private_link_service_aliases ({str: (str,)}): The mapping of zones to Private Link Service Aliases if available. Keys are zones and values are [Azure Private Link Service Aliases](https://docs.microsoft.com/en-us/azure/private-link/private-link-service-overview#share-your-service). . [optional]  # noqa: E501
            private_link_service_resource_ids ({str: (str,)}): The mapping of zones to Private Link Service Resource IDs if available. Keys are zones and values are [Azure Private Link Service Resource IDs](https://docs.microsoft.com/en-us/azure/private-link/private-link-service-overview#share-your-service). . [optional]  # noqa: E501
        """

        kind = kwargs.get('kind', "AzureNetwork")
