...
class RowFieldType(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'name': (str,),  # noqa: E501
            'field_type': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, field_type, *args, **kwargs):  # noqa: E501
        """RowFieldType - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            description (str): The description of the field.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, field_type, *args, **kwargs):  # noqa: E501
        """RowFieldType - a model defined in OpenAPI
