...
class NetworkingV1ZoneInfo(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NetworkingV1ZoneInfo - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            zone_id (str): Cloud provider zone id. [optional]  # noqa: E501
            cidr (str): The IPv4 [CIDR block](https://en.wikipedia.org/wiki/Classless_Inter-Domain_Routing) to used for this network. Must be a `/27`. Required for VPC peering and AWS TransitGateway. . [optional]  # noqa: E501
        """
