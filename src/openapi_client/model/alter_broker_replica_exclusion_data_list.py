...
def lazy_import():
    ...
    globals()['AlterBrokerReplicaExclusionData'] = AlterBrokerReplicaExclusionData
    globals()['AlterBrokerReplicaExclusionDataListAllOf'] = AlterBrokerReplicaExclusionDataListAllOf
    globals()['ResourceCollection'] = ResourceCollection
    globals()['ResourceCollectionMetadata'] = ResourceCollectionMetadata


class AlterBrokerReplicaExclusionDataList(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            'kind': (str,),  # noqa: E501
            'metadata': (ResourceCollectionMetadata,),  # noqa: E501
            'data': ([AlterBrokerReplicaExclusionData],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AlterBrokerReplicaExclusionDataList - a model defined in OpenAPI

        Keyword Args:
            kind (str):
            metadata (ResourceCollectionMetadata):
            data ([AlterBrokerReplicaExclusionData]):
