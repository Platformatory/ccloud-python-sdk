...
class NotificationsV1SubscriptionList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """NotificationsV1SubscriptionList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. defaults to "SubscriptionList", must be one of ["SubscriptionList", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "SubscriptionList")
