...
def lazy_import():
    ...
    globals()['NetworkingV1GcpPscServiceAttachment'] = NetworkingV1GcpPscServiceAttachment


class NetworkingV1GcpPrivateLinkAttachmentStatus(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'kind': (str,),  # noqa: E501
            'service_attachments': ([NetworkingV1GcpPscServiceAttachment],),  # noqa: E501
        }
    ...
    attribute_map = {
        'kind': 'kind',  # noqa: E501
        'service_attachments': 'service_attachments',  # noqa: E501
    }

    read_only_vars = {
        'kind',  # noqa: E501
        'service_attachments',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, service_attachments, *args, **kwargs):  # noqa: E501
        """NetworkingV1GcpPrivateLinkAttachmentStatus - a model defined in OpenAPI

        Args:
            service_attachments ([NetworkingV1GcpPscServiceAttachment]): Array of GCP PSC Service attachments that can be used to connect PSC Endpoints for each zone. 

        Keyword Args:
            kind (str): PrivateLinkAttachmentStatus kind.. defaults to "GcpPrivateLinkAttachmentStatus", must be one of ["GcpPrivateLinkAttachmentStatus", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "GcpPrivateLinkAttachmentStatus")
