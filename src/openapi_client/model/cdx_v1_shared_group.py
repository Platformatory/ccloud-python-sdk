...
class CdxV1SharedGroup(ModelNormal):
    ...
    attribute_map = {
        'kind': 'kind',  # noqa: E501
        'group_prefix': 'group_prefix',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, group_prefix, *args, **kwargs):  # noqa: E501
        """CdxV1SharedGroup - a model defined in OpenAPI

        Args:
            group_prefix (str): The consumer group prefix

        Keyword Args:
            kind (str): The resource kind. defaults to "Group", must be one of ["Group", ]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, group_prefix, *args, **kwargs):  # noqa: E501
        """CdxV1SharedGroup - a model defined in OpenAPI
