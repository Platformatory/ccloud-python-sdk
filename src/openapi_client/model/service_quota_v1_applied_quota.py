...
class ServiceQuotaV1AppliedQuota(ModelNormal):
    ...
    allowed_values = {
        ('api_version',): {
            'SERVICE-QUOTA/V1': "service-quota/v1",
        },
        ('kind',): {
    ...
    def openapi_types():
        ...
        return {
            ...
            'default_limit': (int,),  # noqa: E501
            'applied_limit': (int,),  # noqa: E501
            'usage': (int,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'default_limit': 'default_limit',  # noqa: E501
        'applied_limit': 'applied_limit',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ServiceQuotaV1AppliedQuota - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            api_version (str): APIVersion defines the schema version of this representation of a resource.. [optional] if omitted the server will use the default value of "service-quota/v1"  # noqa: E501
            kind (str): Kind defines the object this REST resource represents.. [optional] if omitted the server will use the default value of "AppliedQuota"  # noqa: E501
            ...
            scope (str): The applied scope that this quota belongs to.. [optional]  # noqa: E501
            display_name (str): A human-readable name for the quota type name.. [optional]  # noqa: E501
            default_limit (int): The default service quota value. . [optional]  # noqa: E501
            applied_limit (int): The latest applied service quota value, taking into account any limit adjustments. . [optional]  # noqa: E501
            usage (int): Show the quota usage value if the quota usage is available for this quota. . [optional]  # noqa: E501
            user (bool, date, datetime, dict, float, int, list, str, none_type): The user associated with this object.. [optional]  # noqa: E501
            organization (bool, date, datetime, dict, float, int, list, str, none_type): A unique organization id to associate a specific organization to this quota.. [optional]  # noqa: E501
            environment (bool, date, datetime, dict, float, int, list, str, none_type): The environment ID the quota is associated with. . [optional]  # noqa: E501
            network (bool, date, datetime, dict, float, int, list, str, none_type): The network ID the quota is associated with. . [optional]  # noqa: E501
            kafka_cluster (bool, date, datetime, dict, float, int, list, str, none_type): The kafka cluster ID the quota is associated with. . [optional]  # noqa: E501
        """
