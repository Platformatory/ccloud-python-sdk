...
class NotificationsV1WebhookTarget(ModelNormal):
    ...
    def _from_openapi_data(cls, url, *args, **kwargs):  # noqa: E501
        """NotificationsV1WebhookTarget - a model defined in OpenAPI

        Args:
            url (str): URL endpoint for the webhook

        Keyword Args:
            kind (str): Integration Type. defaults to "Webhook", must be one of ["Webhook", ]  # noqa: E501
