...
class IamV2IdentityPoolList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """IamV2IdentityPoolList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. defaults to "IdentityPoolList", must be one of ["IdentityPoolList", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "IdentityPoolList")
