...
class OrgV2OrganizationList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """OrgV2OrganizationList - a model defined in OpenAPI
        ...
        Keyword Args:
            api_version (str): APIVersion defines the schema version of this representation of a resource.. defaults to "org/v2", must be one of ["org/v2", ]  # noqa: E501
        ...
        api_version = kwargs.get('api_version', "org/v2")
