...
class CdxV1AzureNetwork(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CdxV1AzureNetwork - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            private_link_service_aliases ({str: (str,)}): The mapping of zones to PrivateLink Service Aliases if available.  Keys are zones and values are [Azure PrivateLink Service Aliases](https://docs.microsoft.com/en-us/azure/private-link/private-link-service-overview#share-your-service) . [optional]  # noqa: E501
        """
