...
class NetworkingV1AwsNetwork(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'private_link_endpoint_service': (str,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'private_link_endpoint_service': 'private_link_endpoint_service',  # noqa: E501
    }

    read_only_vars = {
        'vpc',  # noqa: E501
        'account',  # noqa: E501
        'private_link_endpoint_service',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, vpc, account, *args, **kwargs):  # noqa: E501
        """NetworkingV1AwsNetwork - a model defined in OpenAPI

        Args:
            vpc (str): The Confluent Cloud VPC ID.
            account (str): The AWS account ID associated with the Confluent Cloud VPC.

        Keyword Args:
            kind (str): Network kind type.. defaults to "AwsNetwork", must be one of ["AwsNetwork", ]  # noqa: E501
            ...
            private_link_endpoint_service (str): The endpoint service of the Confluent Cloud VPC. (used for PrivateLink) if available.. [optional]  # noqa: E501
        """

        kind = kwargs.get('kind', "AwsNetwork")
