...
class NetworkingV1AwsPrivateLinkAttachmentConnection(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, vpc_endpoint_id, *args, **kwargs):  # noqa: E501
        """NetworkingV1AwsPrivateLinkAttachmentConnection - a model defined in OpenAPI

        Args:
            vpc_endpoint_id (str): Id of a VPC Endpoint that is connected to the VPC Endpoint service.

        Keyword Args:
            kind (str): PrivateLinkAttachmentConnection kind.. defaults to "AwsPrivateLinkAttachmentConnection", must be one of ["AwsPrivateLinkAttachmentConnection", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "AwsPrivateLinkAttachmentConnection")
    ...
    @convert_js_args_to_python_args
    def __init__(self, vpc_endpoint_id, *args, **kwargs):  # noqa: E501
        """NetworkingV1AwsPrivateLinkAttachmentConnection - a model defined in OpenAPI
