...
class SrcmV3ClusterList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """SrcmV3ClusterList - a model defined in OpenAPI
        ...
        Keyword Args:
            api_version (str): APIVersion defines the schema version of this representation of a resource.. defaults to "srcm/v3", must be one of ["srcm/v3", ]  # noqa: E501
        ...
        api_version = kwargs.get('api_version', "srcm/v3")
