...
class FcpmV2ComputePoolList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """FcpmV2ComputePoolList - a model defined in OpenAPI
        ...
        Keyword Args:
            api_version (str): APIVersion defines the schema version of this representation of a resource.. defaults to "fcpm/v2", must be one of ["fcpm/v2", ]  # noqa: E501
            kind (str): Kind defines the object this REST resource represents.. defaults to "ComputePoolList", must be one of ["ComputePoolList", ]  # noqa: E501
        ...
        api_version = kwargs.get('api_version', "fcpm/v2")
        kind = kwargs.get('kind', "ComputePoolList")
