...
class NetworkingV1PrivateLinkAccessStatus(ModelNormal):
    ...
    def _from_openapi_data(cls, phase, *args, **kwargs):  # noqa: E501
        """NetworkingV1PrivateLinkAccessStatus - a model defined in OpenAPI

        Args:
            phase (str): The lifecycle phase of the PrivateLink access configuration:    PROVISIONING: PrivateLink access provisioning is in progress;    READY:  PrivateLink access is ready;    FAILED: PrivateLink access is in a failed state;    DEPROVISIONING: PrivateLink access deprovisioning is in progress; 
        ...
        Keyword Args:
            ...
            error_code (str): Error code if PrivateLink access is in a failed state. May be used for programmatic error checking.. [optional]  # noqa: E501
            error_message (str): Displayable error message if PrivateLink access is in a failed state. [optional]  # noqa: E501
        """
