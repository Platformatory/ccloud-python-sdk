...
def lazy_import():
    ...
    globals()['RowFieldType'] = RowFieldType


class DataType(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'scale': (int,),  # noqa: E501
            'key_type': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'value_type': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'element_type': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'fields': ([RowFieldType],),  # noqa: E501
            'resolution': (str,),  # noqa: E501
            'fractional_precision': (int,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'element_type': 'element_type',  # noqa: E501
        'fields': 'fields',  # noqa: E501
        'resolution': 'resolution',  # noqa: E501
        'fractional_precision': 'fractional_precision',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, nullable, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            length (int): The length of the data type.. [optional]  # noqa: E501
            precision (int): The precision of the data type.. [optional]  # noqa: E501
            scale (int): The scale of the data type.. [optional]  # noqa: E501
            key_type (bool, date, datetime, dict, float, int, list, str, none_type): The type of the key in the data type (if applicable).. [optional]  # noqa: E501
            value_type (bool, date, datetime, dict, float, int, list, str, none_type): The type of the value in the data type (if applicable).. [optional]  # noqa: E501
            element_type (bool, date, datetime, dict, float, int, list, str, none_type): The type of the element in the data type (if applicable).. [optional]  # noqa: E501
            fields ([RowFieldType]): The fields of the element in the data type (if applicable).. [optional]  # noqa: E501
            resolution (str): The resolution of the data type (if applicable).. [optional]  # noqa: E501
            fractional_precision (int): The fractional precision of the data type (if applicable).. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, nullable, *args, **kwargs):  # noqa: E501
        """DataType - a model defined in OpenAPI
