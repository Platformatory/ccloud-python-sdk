...
class NetworkingV1IpAddressList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """NetworkingV1IpAddressList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. defaults to "IpAddressList", must be one of ["IpAddressList", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "IpAddressList")
