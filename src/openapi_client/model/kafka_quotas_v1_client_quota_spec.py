...
def lazy_import():
    ...
    globals()['GlobalObjectReference'] = GlobalObjectReference


class KafkaQuotasV1ClientQuotaSpec(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'throughput': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'cluster': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'principals': ([GlobalObjectReference],),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """KafkaQuotasV1ClientQuotaSpec - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            display_name (str): The name of the client quota.. [optional]  # noqa: E501
            description (str): A human readable description for the client quota.. [optional]  # noqa: E501
            throughput ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Throughput for the client quota.. [optional]  # noqa: E501
            cluster (bool, date, datetime, dict, float, int, list, str, none_type): The ID of the Dedicated Kafka cluster where the client quota is applied. . [optional]  # noqa: E501
            principals ([GlobalObjectReference]): A list of principals to apply a client quota to. Use `\"<default>\"` to apply a client quota to all service accounts (see [Control application usage with Client Quotas](https://docs.confluent.io/cloud/current/clusters/client-quotas.html#control-application-usage-with-client-quotas) for more details). . [optional]  # noqa: E501
