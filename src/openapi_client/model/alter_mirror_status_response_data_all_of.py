...
class AlterMirrorStatusResponseDataAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, mirror_topic_name, error_message, error_code, mirror_lags, *args, **kwargs):  # noqa: E501
        """AlterMirrorStatusResponseDataAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, mirror_topic_name, error_message, error_code, mirror_lags, *args, **kwargs):  # noqa: E501
        """AlterMirrorStatusResponseDataAllOf - a model defined in OpenAPI
