...
def lazy_import():
    ...
    globals()['AlterConfigBatchRequestDataData'] = AlterConfigBatchRequestDataData


class AlterConfigBatchRequestData(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([AlterConfigBatchRequestDataData],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """AlterConfigBatchRequestData - a model defined in OpenAPI

        Args:
            data ([AlterConfigBatchRequestDataData]):
