...
class ConsumerLagDataAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, cluster_id, consumer_group_id, topic_name, partition_id, current_offset, log_end_offset, lag, consumer_id, client_id, *args, **kwargs):  # noqa: E501
        """ConsumerLagDataAllOf - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            instance_id (str, none_type): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, cluster_id, consumer_group_id, topic_name, partition_id, current_offset, log_end_offset, lag, consumer_id, client_id, *args, **kwargs):  # noqa: E501
        """ConsumerLagDataAllOf - a model defined in OpenAPI
