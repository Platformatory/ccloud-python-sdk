...
class PartnerV2OrganizationList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """PartnerV2OrganizationList - a model defined in OpenAPI
        ...
        Keyword Args:
            api_version (str): APIVersion defines the schema version of this representation of a resource.. defaults to "partner/v2", must be one of ["partner/v2", ]  # noqa: E501
            kind (str): Kind defines the object this REST resource represents.. defaults to "OrganizationList", must be one of ["OrganizationList", ]  # noqa: E501
        ...
        api_version = kwargs.get('api_version', "partner/v2")
        kind = kwargs.get('kind', "OrganizationList")
