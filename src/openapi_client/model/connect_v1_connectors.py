...
class ConnectV1Connectors(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ConnectV1Connectors - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}]): List of active task configs that have been created by the connector.  # noqa: E501

        Keyword Args:
            value ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}]): List of active task configs that have been created by the connector.  # noqa: E501
