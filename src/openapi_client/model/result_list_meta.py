...
class ResultListMeta(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ResultListMeta - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            _self (str): Self is a Uniform Resource Locator (URL) at which an object can be addressed. This URL encodes the service location, API version, and other particulars necessary to locate the resource at a point in time. [optional]  # noqa: E501
            next (str): A URL that can be followed to get the next batch of results.. [optional]  # noqa: E501
