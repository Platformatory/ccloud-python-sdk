...
class FcpmV2ComputePoolSpec(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FcpmV2ComputePoolSpec - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            display_name (str): The name of the Flink compute pool.. [optional]  # noqa: E501
            cloud (str): The cloud service provider that runs the compute pool.. [optional]  # noqa: E501
            http_endpoint (str): The API endpoint of the Flink compute pool.. [optional]  # noqa: E501
            region (str): Flink compute pools in the region provided will be able to use this identity pool. [optional]  # noqa: E501
            max_cfu (int): Maximum number of Confluent Flink Units (CFUs) that the Flink compute pool should auto-scale to. . [optional]  # noqa: E501
            ...
            network (bool, date, datetime, dict, float, int, list, str, none_type): The network to which this belongs.. [optional]  # noqa: E501
        """
