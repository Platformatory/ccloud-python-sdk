...
def lazy_import():
    ...
    globals()['ConnectV1ConnectorTasks'] = ConnectV1ConnectorTasks


class ConnectV1Connector(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'tasks': ([ConnectV1ConnectorTasks],),  # noqa: E501
            'type': (str,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, name, config, *args, **kwargs):  # noqa: E501
        """ConnectV1Connector - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            tasks ([ConnectV1ConnectorTasks]): List of active tasks generated by the connector. [optional]  # noqa: E501
            type (str): Type of connector, sink or source. [optional]  # noqa: E501
        """
