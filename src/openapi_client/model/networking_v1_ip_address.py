...
class NetworkingV1IpAddress(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NetworkingV1IpAddress - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. [optional] if omitted the server will use the default value of "IpAddress"  # noqa: E501
            ip_prefix (str): The IP Address range.. [optional]  # noqa: E501
            cloud (str): The cloud service provider in which the address exists.. [optional]  # noqa: E501
            region (str): The region/location where the IP Address is in use.. [optional]  # noqa: E501
            services (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
            address_type (str): Whether the address is used for egress or ingress.. [optional]  # noqa: E501
        """
