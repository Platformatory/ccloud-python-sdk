...
class ConnectV1UploadSourcePresignedUrl(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, location, upload_id, *args, **kwargs):  # noqa: E501
        """ConnectV1UploadSourcePresignedUrl - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, location, upload_id, *args, **kwargs):  # noqa: E501
        """ConnectV1UploadSourcePresignedUrl - a model defined in OpenAPI
