...
class SrcmV2ClusterList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """SrcmV2ClusterList - a model defined in OpenAPI
        ...
        Keyword Args:
            api_version (str): APIVersion defines the schema version of this representation of a resource.. defaults to "srcm/v2", must be one of ["srcm/v2", ]  # noqa: E501
        ...
        api_version = kwargs.get('api_version', "srcm/v2")
