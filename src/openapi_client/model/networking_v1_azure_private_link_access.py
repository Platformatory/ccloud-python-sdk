...
class NetworkingV1AzurePrivateLinkAccess(ModelNormal):
    ...
    def _from_openapi_data(cls, subscription, *args, **kwargs):  # noqa: E501
        """NetworkingV1AzurePrivateLinkAccess - a model defined in OpenAPI
        ...
        Keyword Args:
            kind (str): PrivateLink kind type.. defaults to "AzurePrivateLinkAccess", must be one of ["AzurePrivateLinkAccess", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "AzurePrivateLinkAccess")
