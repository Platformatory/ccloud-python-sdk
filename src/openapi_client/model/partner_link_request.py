...
class PartnerLinkRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'entitlement': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, token, organization, entitlement, *args, **kwargs):  # noqa: E501
        """PartnerLinkRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, token, organization, entitlement, *args, **kwargs):  # noqa: E501
        """PartnerLinkRequest - a model defined in OpenAPI
