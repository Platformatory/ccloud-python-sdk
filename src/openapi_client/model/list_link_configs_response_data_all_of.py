...
class ListLinkConfigsResponseDataAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, cluster_id, name, value, read_only, sensitive, source, synonyms, link_name, *args, **kwargs):  # noqa: E501
        """ListLinkConfigsResponseDataAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, cluster_id, name, value, read_only, sensitive, source, synonyms, link_name, *args, **kwargs):  # noqa: E501
        """ListLinkConfigsResponseDataAllOf - a model defined in OpenAPI
