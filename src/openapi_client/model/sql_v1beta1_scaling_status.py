...
class SqlV1beta1ScalingStatus(ModelNormal):
    ...
    attribute_map = {
        'scaling_state': 'scaling_state',  # noqa: E501
        'last_updated': 'last_updated',  # noqa: E501
    }

    read_only_vars = {
        'scaling_state',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SqlV1beta1ScalingStatus - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            scaling_state (str): OK: The statement runs at the right scale. PENDING_SCALE_DOWN: The statement requires less resources, and will be scaled down in the near future. PENDING_SCALE_UP: The statement requires more resources, and will be scaled up in the near future. POOL_EXHAUSTED: The statement requires more resources, but not enough resources are available. . [optional]  # noqa: E501
            last_updated (datetime): The last time the scaling status was updated.. [optional]  # noqa: E501
        """
