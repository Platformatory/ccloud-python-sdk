...
class NetworkingV1SupportedConnectionTypes(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """NetworkingV1SupportedConnectionTypes - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([str]): The connection types this network supports..  # noqa: E501

        Keyword Args:
            value ([str]): The connection types this network supports..  # noqa: E501
