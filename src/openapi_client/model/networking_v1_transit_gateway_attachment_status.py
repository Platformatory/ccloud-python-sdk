...
class NetworkingV1TransitGatewayAttachmentStatus(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, phase, *args, **kwargs):  # noqa: E501
        """NetworkingV1TransitGatewayAttachmentStatus - a model defined in OpenAPI

        Args:
            phase (str): The lifecycle phase of the TGW attachment:    PROVISIONING: attachment provisioning is in progress;    PENDING_ACCEPT: attachment request is pending acceptance by the customer;    READY:  attachment is ready;    FAILED: attachment is in a failed state;    DEPROVISIONING: attachment deprovisioning is in progress;    DISCONNECTED: attachment was manually deleted directly in the cloud provider by the customer;    ERROR: invalid customer input during attachment creation. 
        ...
        Keyword Args:
            ...
            error_code (str): Error code if TGW attachment is in a failed state. May be used for programmatic error checking.. [optional]  # noqa: E501
            error_message (str): Displayable error message if TGW attachment is in a failed state. [optional]  # noqa: E501
            cloud ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): The cloud-specific TGW attachment details.. [optional]  # noqa: E501
        """
