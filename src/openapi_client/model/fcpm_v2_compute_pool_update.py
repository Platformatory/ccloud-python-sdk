...
def lazy_import():
    ...
    globals()['FcpmV2ComputePoolSpecUpdate'] = FcpmV2ComputePoolSpecUpdate
    globals()['FcpmV2ComputePoolStatus'] = FcpmV2ComputePoolStatus


class FcpmV2ComputePoolUpdate(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'spec': (FcpmV2ComputePoolSpecUpdate,),  # noqa: E501
            'status': (FcpmV2ComputePoolStatus,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FcpmV2ComputePoolUpdate - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            api_version (str): APIVersion defines the schema version of this representation of a resource.. [optional] if omitted the server will use the default value of "fcpm/v2"  # noqa: E501
            kind (str): Kind defines the object this REST resource represents.. [optional] if omitted the server will use the default value of "ComputePool"  # noqa: E501
            ...
            spec (FcpmV2ComputePoolSpecUpdate): [optional]  # noqa: E501
            status (FcpmV2ComputePoolStatus): [optional]  # noqa: E501
        """
