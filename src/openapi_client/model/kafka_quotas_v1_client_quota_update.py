...
def lazy_import():
    ...
    globals()['KafkaQuotasV1ClientQuotaSpecUpdate'] = KafkaQuotasV1ClientQuotaSpecUpdate


class KafkaQuotasV1ClientQuotaUpdate(ModelNormal):
    ...
    allowed_values = {
        ('api_version',): {
            'KAFKA-QUOTAS/V1': "kafka-quotas/v1",
        },
        ('kind',): {
    ...
    def openapi_types():
        ...
        return {
            ...
            'spec': (KafkaQuotasV1ClientQuotaSpecUpdate,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """KafkaQuotasV1ClientQuotaUpdate - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            api_version (str): APIVersion defines the schema version of this representation of a resource.. [optional] if omitted the server will use the default value of "kafka-quotas/v1"  # noqa: E501
            kind (str): Kind defines the object this REST resource represents.. [optional] if omitted the server will use the default value of "ClientQuota"  # noqa: E501
            ...
            spec (KafkaQuotasV1ClientQuotaSpecUpdate): [optional]  # noqa: E501
        """
