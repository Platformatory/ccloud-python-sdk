...
def lazy_import():
    ...
    globals()['ClusterConfigData'] = ClusterConfigData
    globals()['ClusterConfigDataListAllOf'] = ClusterConfigDataListAllOf
    globals()['ResourceCollection'] = ResourceCollection
    globals()['ResourceCollectionMetadata'] = ResourceCollectionMetadata


class ClusterConfigDataList(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'data': ([ClusterConfigData],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ClusterConfigDataList - a model defined in OpenAPI
