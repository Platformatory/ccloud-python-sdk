...
class NetworkingV1PrivateLinkAttachmentStatus(ModelNormal):
    ...
    def _from_openapi_data(cls, phase, *args, **kwargs):  # noqa: E501
        """NetworkingV1PrivateLinkAttachmentStatus - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            error_code (str): Error code if PrivateLink attachment is in a failed state. May be used for programmatic error checking.. [optional]  # noqa: E501
            error_message (str): Displayable error message if PrivateLink attachment is in a failed state.. [optional]  # noqa: E501
            dns_domain (str): The root DNS domain for the PrivateLink attachment.. [optional]  # noqa: E501
            cloud ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): The cloud specific status of the PrivateLink attachment. These will be populated when the PrivateLink attachment reaches the WAITING_FOR_CONNECTIONS state.. [optional]  # noqa: E501
        """
