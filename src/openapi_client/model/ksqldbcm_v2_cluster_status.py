...
class KsqldbcmV2ClusterStatus(ModelNormal):
    ...
    attribute_map = {
        ...
        'topic_prefix': 'topic_prefix',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, phase, is_paused, storage, *args, **kwargs):  # noqa: E501
        """KsqldbcmV2ClusterStatus - a model defined in OpenAPI

        Args:
            phase (str): Status of the ksqlDB cluster.
            is_paused (bool): Tells you if the cluster has been paused
            storage (int): Amount of storage (in GB) provisioned to this cluster
        ...
        Keyword Args:
            ...
            http_endpoint (str): The dataplane endpoint of the ksqlDB cluster.. [optional]  # noqa: E501
            topic_prefix (str): Topic name prefix used by this ksqlDB cluster. Used to assign ACLs for this ksqlDB cluster to use.. [optional]  # noqa: E501
        """
