...
def lazy_import():
    ...
    globals()['SrcmV2ClusterSpec'] = SrcmV2ClusterSpec
    globals()['SrcmV2ClusterStatus'] = SrcmV2ClusterStatus


class SrcmV2Cluster(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'spec': (SrcmV2ClusterSpec,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SrcmV2Cluster - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            spec (SrcmV2ClusterSpec): [optional]  # noqa: E501
