...
class NetworkingV1NetworkLinkEndpointList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """NetworkingV1NetworkLinkEndpointList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. defaults to "NetworkLinkEndpointList", must be one of ["NetworkLinkEndpointList", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "NetworkLinkEndpointList")
