...
class PartnerV2EntitlementList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """PartnerV2EntitlementList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. defaults to "EntitlementList", must be one of ["EntitlementList", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "EntitlementList")
