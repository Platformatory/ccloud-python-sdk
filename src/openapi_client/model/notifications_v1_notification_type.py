...
class NotificationsV1NotificationType(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'subscription_priority': (str,),  # noqa: E501
            'is_included_in_plan': (bool,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'subscription_priority': 'subscription_priority',  # noqa: E501
        'is_included_in_plan': 'is_included_in_plan',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NotificationsV1NotificationType - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            api_version (str): APIVersion defines the schema version of this representation of a resource.. [optional] if omitted the server will use the default value of "notifications/v1"  # noqa: E501
            kind (str): Kind defines the object this REST resource represents.. [optional] if omitted the server will use the default value of "NotificationType"  # noqa: E501
            ...
            display_name (str): Human readable display name of the notification type . [optional]  # noqa: E501
            category (str): Represents the group with which the notification is associated. Notifications are grouped under certain categories for better organization. - BILLING_LICENSING: All billing, payments or licensing related notifications are grouped here. - SECURITY: All Confluent Cloud and Platform security related notifications are grouped here. - SERVICE: All Confluent services (eg. Kafka, Schema Registry, Connect etc.) related notifications are   grouped here. - ACCOUNT: All Confluent account related notifications are grouped here. For example: Billing, payment or license related notifications are grouped in BILLING_LICENSING category. . [optional]  # noqa: E501
            description (str): Human readable description of the notification type . [optional]  # noqa: E501
            subscription_priority (str): Indicates whether the notification is auto-subscribed and if the user can opt-out. - REQUIRED: the user is auto-subscribed to this notification and can't opt-out. - RECOMMENDED: the user is auto-subscribed to this notification and can opt-out. - OPTIONAL: the user is not auto-subscribed to this notification but can explicitly subscribe to it. . [optional]  # noqa: E501
            is_included_in_plan (bool): Whether this notification is available to subscribe or not as per the user's current billing plan. . [optional]  # noqa: E501
            severity (str): Severity indicates the impact of this notification. - CRITICAL: a high impact notification which needs immediate attention. - WARN: a warning notification which can be addressed now or later. - INFO: an informational notification. . [optional]  # noqa: E501
        """
