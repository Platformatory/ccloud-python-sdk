...
class ClusterConfigDataAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, config_type, *args, **kwargs):  # noqa: E501
        """ClusterConfigDataAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, config_type, *args, **kwargs):  # noqa: E501
        """ClusterConfigDataAllOf - a model defined in OpenAPI
