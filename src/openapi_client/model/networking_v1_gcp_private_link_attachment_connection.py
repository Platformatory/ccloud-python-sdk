...
class NetworkingV1GcpPrivateLinkAttachmentConnection(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, private_service_connect_connection_id, *args, **kwargs):  # noqa: E501
        """NetworkingV1GcpPrivateLinkAttachmentConnection - a model defined in OpenAPI

        Args:
            private_service_connect_connection_id (str): Id of the Private Service connection.

        Keyword Args:
            kind (str): PrivateLinkAttachmentConnection kind.. defaults to "GcpPrivateLinkAttachmentConnection", must be one of ["GcpPrivateLinkAttachmentConnection", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "GcpPrivateLinkAttachmentConnection")
