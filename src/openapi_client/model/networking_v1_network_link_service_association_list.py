...
class NetworkingV1NetworkLinkServiceAssociationList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """NetworkingV1NetworkLinkServiceAssociationList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. defaults to "NetworkLinkServiceAssociationList", must be one of ["NetworkLinkServiceAssociationList", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "NetworkLinkServiceAssociationList")
