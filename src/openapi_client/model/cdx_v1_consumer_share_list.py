...
class CdxV1ConsumerShareList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """CdxV1ConsumerShareList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. defaults to "ConsumerShareList", must be one of ["ConsumerShareList", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "ConsumerShareList")
