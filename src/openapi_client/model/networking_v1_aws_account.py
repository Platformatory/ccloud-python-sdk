...
class NetworkingV1AwsAccount(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """NetworkingV1AwsAccount - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): The AWS account ID.  # noqa: E501

        Keyword Args:
            value (str): The AWS account ID.  # noqa: E501
