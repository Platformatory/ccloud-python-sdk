...
class StsV1TokenExchangeReply(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'issued_token_type': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'issued_token_type': 'issued_token_type',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, access_token, issued_token_type, token_type, expires_in, *args, **kwargs):  # noqa: E501
        """StsV1TokenExchangeReply - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, access_token, issued_token_type, token_type, expires_in, *args, **kwargs):  # noqa: E501
        """StsV1TokenExchangeReply - a model defined in OpenAPI
