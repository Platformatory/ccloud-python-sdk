...
class IamV2ApiKeyList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """IamV2ApiKeyList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. defaults to "ApiKeyList", must be one of ["ApiKeyList", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "ApiKeyList")
