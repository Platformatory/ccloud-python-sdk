...
class ByokV1GcpKey(ModelNormal):
    ...
    attribute_map = {
        ...
        'kind': 'kind',  # noqa: E501
        'security_group': 'security_group',  # noqa: E501
    }

    read_only_vars = {
        'security_group',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, key_id, *args, **kwargs):  # noqa: E501
        """ByokV1GcpKey - a model defined in OpenAPI

        Args:
            key_id (str): The Google Cloud Platform key ID. 

        Keyword Args:
            kind (str): BYOK kind type. . defaults to "GcpKey", must be one of ["GcpKey", ]  # noqa: E501
            ...
            security_group (str): The Google security group created for this key. . [optional]  # noqa: E501
        """

        kind = kwargs.get('kind', "GcpKey")
