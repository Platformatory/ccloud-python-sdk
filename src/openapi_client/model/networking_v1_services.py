...
class NetworkingV1Services(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """NetworkingV1Services - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([str]): The service types that will use the address..  # noqa: E501

        Keyword Args:
            value ([str]): The service types that will use the address..  # noqa: E501
