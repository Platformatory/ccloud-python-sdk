...
class NetworkingV1GcpPrivateServiceConnectAccess(ModelNormal):
    ...
    def _from_openapi_data(cls, project, *args, **kwargs):  # noqa: E501
        """NetworkingV1GcpPrivateServiceConnectAccess - a model defined in OpenAPI
        ...
        Keyword Args:
            kind (str): PrivateLink kind type.. defaults to "GcpPrivateServiceConnectAccess", must be one of ["GcpPrivateServiceConnectAccess", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "GcpPrivateServiceConnectAccess")
