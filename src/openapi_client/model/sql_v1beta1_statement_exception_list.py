...
class SqlV1beta1StatementExceptionList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """SqlV1beta1StatementExceptionList - a model defined in OpenAPI
        ...
        Keyword Args:
            api_version (str): APIVersion defines the schema version of this representation of a resource.. defaults to "sql/v1beta1", must be one of ["sql/v1beta1", ]  # noqa: E501
            kind (str): Kind defines the object this REST resource represents.. defaults to "StatementExceptionList", must be one of ["StatementExceptionList", ]  # noqa: E501
        ...
        api_version = kwargs.get('api_version', "sql/v1beta1")
        kind = kwargs.get('kind', "StatementExceptionList")
