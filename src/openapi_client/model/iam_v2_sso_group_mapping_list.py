...
class IamV2SsoGroupMappingList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """IamV2SsoGroupMappingList - a model defined in OpenAPI
        ...
        Keyword Args:
            api_version (str): APIVersion defines the schema version of this representation of a resource.. defaults to "iam.v2/sso", must be one of ["iam.v2/sso", ]  # noqa: E501
            kind (str): Kind defines the object this REST resource represents.. defaults to "GroupMappingList", must be one of ["GroupMappingList", ]  # noqa: E501
        ...
        api_version = kwargs.get('api_version', "iam.v2/sso")
        kind = kwargs.get('kind', "GroupMappingList")
