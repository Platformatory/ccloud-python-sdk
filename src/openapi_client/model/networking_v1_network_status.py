...
class NetworkingV1NetworkStatus(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'phase': (str,),  # noqa: E501
            'supported_connection_types': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'active_connection_types': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'error_code': (str,),  # noqa: E501
            'error_message': (str,),  # noqa: E501
            'dns_domain': (str,),  # noqa: E501
            'zonal_subdomains': ({str: (str,)},),  # noqa: E501
    ...
    attribute_map = {
        ...
        'supported_connection_types': 'supported_connection_types',  # noqa: E501
        'active_connection_types': 'active_connection_types',  # noqa: E501
        'error_code': 'error_code',  # noqa: E501
        'error_message': 'error_message',  # noqa: E501
        'dns_domain': 'dns_domain',  # noqa: E501
        'zonal_subdomains': 'zonal_subdomains',  # noqa: E501
        'cloud': 'cloud',  # noqa: E501
    }

    read_only_vars = {
        'phase',  # noqa: E501
        'supported_connection_types',  # noqa: E501
        'active_connection_types',  # noqa: E501
        'error_code',  # noqa: E501
        'error_message',  # noqa: E501
        'dns_domain',  # noqa: E501
        'zonal_subdomains',  # noqa: E501
        'cloud',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, phase, supported_connection_types, active_connection_types, *args, **kwargs):  # noqa: E501
        """NetworkingV1NetworkStatus - a model defined in OpenAPI

        Args:
            phase (str): The lifecyle phase of the network:  PROVISIONING:  network provisioning is in progress;  READY:  network is ready;  FAILED: provisioning failed;  DEPROVISIONING: network deprovisioning is in progress; 
            supported_connection_types (bool, date, datetime, dict, float, int, list, str, none_type):
            active_connection_types (bool, date, datetime, dict, float, int, list, str, none_type):
        ...
        Keyword Args:
            ...
            error_code (str): Error code if network is in a failed state. May be used for programmatic error checking.. [optional]  # noqa: E501
            error_message (str): Displayable error message if network is in a failed state. [optional]  # noqa: E501
            dns_domain (str): The root DNS domain for the network if applicable. Present on networks that support PrivateLink.. [optional]  # noqa: E501
            zonal_subdomains ({str: (str,)}): The DNS subdomain for each zone. Present on networks that support PrivateLink. Keys are zones and values are DNS domains. . [optional]  # noqa: E501
            cloud ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): The cloud-specific network details. These will be populated when the network reaches the READY state.. [optional]  # noqa: E501
        """
        ...
        self.active_connection_types = active_connection_types
