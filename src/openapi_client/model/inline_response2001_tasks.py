...
class InlineResponse2001Tasks(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, state, worker_id, *args, **kwargs):  # noqa: E501
        """InlineResponse2001Tasks - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, state, worker_id, *args, **kwargs):  # noqa: E501
        """InlineResponse2001Tasks - a model defined in OpenAPI
