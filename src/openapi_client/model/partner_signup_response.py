...
class PartnerSignupResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, organization_id, sso_url, *args, **kwargs):  # noqa: E501
        """PartnerSignupResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            display_message (str): The display message contains useful information which is shown on the Marketplace UI to the customers.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, organization_id, sso_url, *args, **kwargs):  # noqa: E501
        """PartnerSignupResponse - a model defined in OpenAPI
