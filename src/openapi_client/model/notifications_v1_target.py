...
def lazy_import():
    ...
    globals()['NotificationsV1MsTeamsTarget'] = NotificationsV1MsTeamsTarget
    globals()['NotificationsV1RoleEmailTarget'] = NotificationsV1RoleEmailTarget
    globals()['NotificationsV1SlackTarget'] = NotificationsV1SlackTarget
    globals()['NotificationsV1UserEmailTarget'] = NotificationsV1UserEmailTarget
    globals()['NotificationsV1WebhookTarget'] = NotificationsV1WebhookTarget


class NotificationsV1Target(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'MsTeams': NotificationsV1MsTeamsTarget,
            'RoleEmail': NotificationsV1RoleEmailTarget,
            'Slack': NotificationsV1SlackTarget,
            'UserEmail': NotificationsV1UserEmailTarget,
            'Webhook': NotificationsV1WebhookTarget,
            'notifications.v1.MsTeamsTarget': NotificationsV1MsTeamsTarget,
            'notifications.v1.RoleEmailTarget': NotificationsV1RoleEmailTarget,
            'notifications.v1.SlackTarget': NotificationsV1SlackTarget,
            'notifications.v1.UserEmailTarget': NotificationsV1UserEmailTarget,
            'notifications.v1.WebhookTarget': NotificationsV1WebhookTarget,
        }
        if not val:
            return None
        return {'kind': val}
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NotificationsV1Target - a model defined in OpenAPI

        Keyword Args:
            kind (str): Integration Type. defaults to "MsTeams", must be one of ["MsTeams", ]  # noqa: E501
            ...
            webhook_url (str): MS Teams Webhook URL for the particular team channel. [optional]  # noqa: E501
            role_name (str): name of the role. [optional]  # noqa: E501
            user (str): ID of the user. [optional]  # noqa: E501
            url (str): URL endpoint for the webhook. [optional]  # noqa: E501
        """

        kind = kwargs.get('kind', "MsTeams")
