...
def lazy_import():
    ...
    globals()['ListLinkConfigsResponseData'] = ListLinkConfigsResponseData
    globals()['ListLinkConfigsResponseDataListAllOf'] = ListLinkConfigsResponseDataListAllOf
    globals()['ResourceCollection'] = ResourceCollection
    globals()['ResourceCollectionMetadata'] = ResourceCollectionMetadata


class ListLinkConfigsResponseDataList(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'data': ([ListLinkConfigsResponseData],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ListLinkConfigsResponseDataList - a model defined in OpenAPI

        Keyword Args:
            kind (str):
            metadata (ResourceCollectionMetadata):
            data ([ListLinkConfigsResponseData]):
