...
class SdV1PipelineList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """SdV1PipelineList - a model defined in OpenAPI
        ...
        Keyword Args:
            api_version (str): APIVersion defines the schema version of this representation of a resource.. defaults to "sd/v1", must be one of ["sd/v1", ]  # noqa: E501
            kind (str): Kind defines the object this REST resource represents.. defaults to "PipelineList", must be one of ["PipelineList", ]  # noqa: E501
        ...
        api_version = kwargs.get('api_version', "sd/v1")
        kind = kwargs.get('kind', "PipelineList")
