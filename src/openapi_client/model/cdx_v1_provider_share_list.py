...
class CdxV1ProviderShareList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """CdxV1ProviderShareList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. defaults to "ProviderShareList", must be one of ["ProviderShareList", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "ProviderShareList")
