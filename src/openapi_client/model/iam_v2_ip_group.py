...
class IamV2IpGroup(ModelNormal):
    ...
    attribute_map = {
        ...
        'cidr_blocks': 'cidr_blocks',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """IamV2IpGroup - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. [optional] if omitted the server will use the default value of "IpGroup"  # noqa: E501
            ...
            group_name (str): A human readable name for an IP Group. Can contain any unicode letter or number, the ASCII space character, or any of the following special characters: `[`, `]`, `|`, `&`, `+`, `-`, `_`, `/`, `.`, `,`. . [optional]  # noqa: E501
            cidr_blocks ([str]): A list of CIDRs.. [optional]  # noqa: E501
        """
