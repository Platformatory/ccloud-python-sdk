...
class ObjectMeta(ModelNormal):
    ...
    def _from_openapi_data(cls, _self, *args, **kwargs):  # noqa: E501
        ...
        Args:
            _self (str): Self is a Uniform Resource Locator (URL) at which an object can be addressed. This URL encodes the service location, API version, and other particulars necessary to locate the resource at a point in time
        ...
        Keyword Args:
            ...
            resource_name (str): Resource Name is a Uniform Resource Identifier (URI) that is globally unique across space and time. It is represented as a Confluent Resource Name. [optional]  # noqa: E501
            created_at (datetime): The date and time at which this object was created. It is represented in RFC3339 format and is in UTC.. [optional]  # noqa: E501
            updated_at (datetime): The date and time at which this object was last updated. It is represented in RFC3339 format and is in UTC.. [optional]  # noqa: E501
            deleted_at (datetime): The date and time at which this object was (or will be) deleted. It is represented in RFC3339 format and is in UTC.. [optional]  # noqa: E501
        """
