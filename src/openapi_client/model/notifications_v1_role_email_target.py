...
class NotificationsV1RoleEmailTarget(ModelNormal):
    ...
    def _from_openapi_data(cls, role_name, *args, **kwargs):  # noqa: E501
        """NotificationsV1RoleEmailTarget - a model defined in OpenAPI

        Args:
            role_name (str): name of the role

        Keyword Args:
            kind (str): Email Integration type for Role. defaults to "RoleEmail", must be one of ["RoleEmail", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "RoleEmail")
