...
class NetworkingV1NetworkLinkServiceList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """NetworkingV1NetworkLinkServiceList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. defaults to "NetworkLinkServiceList", must be one of ["NetworkLinkServiceList", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "NetworkLinkServiceList")
