...
class CmkV2ClusterSpec(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'kafka_bootstrap_endpoint': (str,),  # noqa: E501
            ...
            'byok': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'kafka_bootstrap_endpoint': 'kafka_bootstrap_endpoint',  # noqa: E501
    ...
    read_only_vars = {
        'kafka_bootstrap_endpoint',  # noqa: E501
        'http_endpoint',  # noqa: E501
        'api_endpoint',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CmkV2ClusterSpec - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            display_name (str): The name of the cluster.. [optional]  # noqa: E501
            availability (str): The availability zone configuration of the cluster . [optional]  # noqa: E501
            cloud (str): The cloud service provider in which the cluster is running.. [optional]  # noqa: E501
            region (str): The cloud service provider region where the cluster is running.. [optional]  # noqa: E501
            config (bool, date, datetime, dict, float, int, list, str, none_type): The configuration of the Kafka cluster.  Note: Clusters can be upgraded from Basic to Standard, but cannot be downgraded from Standard to Basic. . [optional]  # noqa: E501
            kafka_bootstrap_endpoint (str): The bootstrap endpoint used by Kafka clients to connect to the cluster.. [optional]  # noqa: E501
            http_endpoint (str): The cluster HTTP request URL.. [optional]  # noqa: E501
            api_endpoint (str): The Kafka API cluster endpoint used by Kafka clients to connect to the cluster.. [optional]  # noqa: E501
            ...
            network (bool, date, datetime, dict, float, int, list, str, none_type): The network associated with this object.. [optional]  # noqa: E501
            byok (bool, date, datetime, dict, float, int, list, str, none_type): The byok associated with this object.. [optional]  # noqa: E501
        """
