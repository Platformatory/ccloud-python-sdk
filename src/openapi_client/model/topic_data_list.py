...
def lazy_import():
    ...
    globals()['TopicData'] = TopicData
    globals()['TopicDataListAllOf'] = TopicDataListAllOf


class TopicDataList(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TopicDataList - a model defined in OpenAPI
