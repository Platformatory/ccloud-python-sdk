...
class CdxV1EmailConsumerRestriction(ModelNormal):
    ...
    def _from_openapi_data(cls, email, *args, **kwargs):  # noqa: E501
        """CdxV1EmailConsumerRestriction - a model defined in OpenAPI

        Args:
            email (str): Email based matching for the consumers

        Keyword Args:
            kind (str): The resource kind. defaults to "Email", must be one of ["Email", ]  # noqa: E501
