...
class ByokV1Key(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'key': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ByokV1Key - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            api_version (str): APIVersion defines the schema version of this representation of a resource.. [optional] if omitted the server will use the default value of "byok/v1"  # noqa: E501
            kind (str): Kind defines the object this REST resource represents.. [optional] if omitted the server will use the default value of "Key"  # noqa: E501
            ...
            key ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): The cloud-specific key details.  For AWS, provide the corresponding `key_arn`.  For Azure, provide the corresponding `key_id`.  For GCP, provide the corresponding `key_id`. . [optional]  # noqa: E501
            provider (str): The cloud provider of the Key.. [optional]  # noqa: E501
            state (str): The state of the key:   AVAILABLE: key can be used for a Kafka cluster provisioning   IN_USE: key is already in use by a Kafka cluster provisioning . [optional]  # noqa: E501
        """
