...
class NetworkingV1AwsPrivateLinkAttachmentStatus(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'kind': (str,),  # noqa: E501
            'vpc_endpoint_service': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
        }
    ...
    attribute_map = {
        'kind': 'kind',  # noqa: E501
        'vpc_endpoint_service': 'vpc_endpoint_service',  # noqa: E501
    }

    read_only_vars = {
        'kind',  # noqa: E501
        'vpc_endpoint_service',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, vpc_endpoint_service, *args, **kwargs):  # noqa: E501
        """NetworkingV1AwsPrivateLinkAttachmentStatus - a model defined in OpenAPI

        Args:
            vpc_endpoint_service ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): AWS VPC Endpoint Service that can be used to establish connections for all zones. 

        Keyword Args:
            kind (str): PrivateLinkAttachmentStatus kind.. defaults to "AwsPrivateLinkAttachmentStatus", must be one of ["AwsPrivateLinkAttachmentStatus", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "AwsPrivateLinkAttachmentStatus")
