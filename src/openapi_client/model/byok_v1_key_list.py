...
class ByokV1KeyList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """ByokV1KeyList - a model defined in OpenAPI
        ...
        Keyword Args:
            api_version (str): APIVersion defines the schema version of this representation of a resource.. defaults to "byok/v1", must be one of ["byok/v1", ]  # noqa: E501
            kind (str): Kind defines the object this REST resource represents.. defaults to "KeyList", must be one of ["KeyList", ]  # noqa: E501
        ...
        api_version = kwargs.get('api_version', "byok/v1")
        kind = kwargs.get('kind', "KeyList")
