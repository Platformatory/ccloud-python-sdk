...
class NetworkingV1PrivateLinkAccessList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """NetworkingV1PrivateLinkAccessList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. defaults to "PrivateLinkAccessList", must be one of ["PrivateLinkAccessList", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "PrivateLinkAccessList")
