...
class CmkV2Enterprise(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CmkV2Enterprise - a model defined in OpenAPI

        Args:

        Keyword Args:
            kind (str): Enterprise cluster type. . defaults to "Enterprise", must be one of ["Enterprise", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "Enterprise")
