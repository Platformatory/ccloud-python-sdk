...
class BrokerReplicaExclusionRequestData(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, broker_id, reason, *args, **kwargs):  # noqa: E501
        """BrokerReplicaExclusionRequestData - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, broker_id, reason, *args, **kwargs):  # noqa: E501
        """BrokerReplicaExclusionRequestData - a model defined in OpenAPI
