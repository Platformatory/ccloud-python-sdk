...
class CreateAclRequestData(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, resource_type, resource_name, pattern_type, principal, host, operation, permission, *args, **kwargs):  # noqa: E501
        """CreateAclRequestData - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, resource_type, resource_name, pattern_type, principal, host, operation, permission, *args, **kwargs):  # noqa: E501
        """CreateAclRequestData - a model defined in OpenAPI
