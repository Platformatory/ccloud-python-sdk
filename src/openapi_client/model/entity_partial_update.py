...
def lazy_import():
    ...
    globals()['PartialUpdateParams'] = PartialUpdateParams


class EntityPartialUpdate(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'update': ([PartialUpdateParams],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """EntityPartialUpdate - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            update ([PartialUpdateParams]): The updated entities.. [optional]  # noqa: E501
        """
