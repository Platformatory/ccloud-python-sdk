...
def lazy_import():
    ...
    globals()['ExporterReference'] = ExporterReference


class RegisterExporterRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'references': ([ExporterReference],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """RegisterExporterRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            references ([ExporterReference]): References to other schemas. [optional]  # noqa: E501
        """
