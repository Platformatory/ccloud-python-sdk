...
def lazy_import():
    ...
    globals()['BrokerReplicaExclusionData'] = BrokerReplicaExclusionData
    globals()['BrokerReplicaExclusionDataListAllOf'] = BrokerReplicaExclusionDataListAllOf
    globals()['ResourceCollection'] = ResourceCollection
    globals()['ResourceCollectionMetadata'] = ResourceCollectionMetadata


class BrokerReplicaExclusionDataList(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'data': ([BrokerReplicaExclusionData],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """BrokerReplicaExclusionDataList - a model defined in OpenAPI

        Keyword Args:
            kind (str):
            metadata (ResourceCollectionMetadata):
            data ([BrokerReplicaExclusionData]):
