...
class NetworkingV1AzurePeering(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, tenant, vnet, customer_region, *args, **kwargs):  # noqa: E501
        """NetworkingV1AzurePeering - a model defined in OpenAPI
        ...
        Keyword Args:
            kind (str): Peering kind type.. defaults to "AzurePeering", must be one of ["AzurePeering", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "AzurePeering")
    ...
    @convert_js_args_to_python_args
    def __init__(self, tenant, vnet, customer_region, *args, **kwargs):  # noqa: E501
        """NetworkingV1AzurePeering - a model defined in OpenAPI
