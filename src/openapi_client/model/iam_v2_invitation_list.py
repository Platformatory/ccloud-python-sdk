...
class IamV2InvitationList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """IamV2InvitationList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. defaults to "InvitationList", must be one of ["InvitationList", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "InvitationList")
