...
class NetworkingV1PrivateLinkAttachmentList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """NetworkingV1PrivateLinkAttachmentList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. defaults to "PrivateLinkAttachmentList", must be one of ["PrivateLinkAttachmentList", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "PrivateLinkAttachmentList")
