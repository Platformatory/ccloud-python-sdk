...
class NetworkingV1AwsPrivateLinkAccess(ModelNormal):
    ...
    def _from_openapi_data(cls, account, *args, **kwargs):  # noqa: E501
        """NetworkingV1AwsPrivateLinkAccess - a model defined in OpenAPI
        ...
        Keyword Args:
            kind (str): PrivateLink kind type.. defaults to "AwsPrivateLinkAccess", must be one of ["AwsPrivateLinkAccess", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "AwsPrivateLinkAccess")
