...
class NetworkingV1TransitGatewayAttachmentSpec(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NetworkingV1TransitGatewayAttachmentSpec - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            display_name (str): The name of the TGW attachment. [optional]  # noqa: E501
            cloud ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): The cloud-specific Transit Gateway details.. [optional]  # noqa: E501
