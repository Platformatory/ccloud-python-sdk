...
class AclDataList(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AclDataList - a model defined in OpenAPI
