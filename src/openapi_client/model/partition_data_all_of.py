...
class PartitionDataAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, cluster_id, topic_name, partition_id, replicas, reassignment, *args, **kwargs):  # noqa: E501
        """PartitionDataAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, cluster_id, topic_name, partition_id, replicas, reassignment, *args, **kwargs):  # noqa: E501
        """PartitionDataAllOf - a model defined in OpenAPI
