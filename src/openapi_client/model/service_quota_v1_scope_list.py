...
class ServiceQuotaV1ScopeList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """ServiceQuotaV1ScopeList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. defaults to "ScopeList", must be one of ["ScopeList", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "ScopeList")
