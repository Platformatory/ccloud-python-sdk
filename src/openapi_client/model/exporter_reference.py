...
class ExporterReference(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'subject_rename_format': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'subject_rename_format': 'subjectRenameFormat',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ExporterReference - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            name (str): Name of the exporter. [optional]  # noqa: E501
            context_type (str): Context type of the exporter. One of CUSTOM, NONE or AUTO (default). [optional]  # noqa: E501
            context (str): Customized context of the exporter if contextType equals CUSTOM.. [optional]  # noqa: E501
            subjects ([str]): Name of each exporter subject. [optional]  # noqa: E501
            subject_rename_format (str): Format string for the subject name in the destination cluster, which may contain ${subject} as a placeholder for the originating subject name. For example, dc_${subject} for the subject orders will map to the destination subject name dc_orders.. [optional]  # noqa: E501
            config ({str: (str,)}): The map containing exporter’s configurations. [optional]  # noqa: E501
        """
