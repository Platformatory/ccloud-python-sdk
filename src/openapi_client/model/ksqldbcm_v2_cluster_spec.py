...
class KsqldbcmV2ClusterSpec(ModelNormal):
    ...
    validations = {
        ('display_name',): {
            'regex': {
                'pattern': r'^(?:[0-9A-Za-z\-])[\w-]{0,31}$',  # noqa: E501
            },
        },
    }
    ...
    def openapi_types():
        ...
        return {
            ...
            'use_detailed_processing_log': (bool,),  # noqa: E501
            'csu': (int,),  # noqa: E501
            'kafka_cluster': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'credential_identity': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'use_detailed_processing_log': 'use_detailed_processing_log',  # noqa: E501
        'csu': 'csu',  # noqa: E501
        'kafka_cluster': 'kafka_cluster',  # noqa: E501
        'credential_identity': 'credential_identity',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """KsqldbcmV2ClusterSpec - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            display_name (str): The name of the ksqlDB cluster.. [optional]  # noqa: E501
            use_detailed_processing_log (bool): This flag controls whether you want to include the row data in the processing log topic. Turn it off if you don't want to emit sensitive information to the processing log . [optional] if omitted the server will use the default value of True  # noqa: E501
            csu (int): The number of CSUs (Confluent Streaming Units) in a ksqlDB cluster.. [optional]  # noqa: E501
            ...
            credential_identity (bool, date, datetime, dict, float, int, list, str, none_type): The credential_identity to which this belongs. The credential_identity can be one of iam.v2.User, iam.v2.ServiceAccount.. [optional]  # noqa: E501
