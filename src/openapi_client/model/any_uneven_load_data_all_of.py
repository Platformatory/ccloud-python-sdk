...
class AnyUnevenLoadDataAllOf(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'status_updated_at': (datetime,),  # noqa: E501
            'previous_status_updated_at': (datetime,),  # noqa: E501
            'broker_tasks': (Relationship,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'status_updated_at': 'status_updated_at',  # noqa: E501
        'previous_status_updated_at': 'previous_status_updated_at',  # noqa: E501
        'broker_tasks': 'broker_tasks',  # noqa: E501
        'error_code': 'error_code',  # noqa: E501
        'error_message': 'error_message',  # noqa: E501
    }

    read_only_vars = {
        'status_updated_at',  # noqa: E501
        'previous_status_updated_at',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, cluster_id, status, previous_status, status_updated_at, previous_status_updated_at, broker_tasks, *args, **kwargs):  # noqa: E501
        """AnyUnevenLoadDataAllOf - a model defined in OpenAPI

        Args:
            cluster_id (str):
            status (str):
            previous_status (str):
            status_updated_at (datetime): The date and time at which this task was created.
            previous_status_updated_at (datetime): The date and time at which this task was created.
        ...
        self.previous_status_updated_at = previous_status_updated_at
        self.broker_tasks = broker_tasks
    ...
    @convert_js_args_to_python_args
    def __init__(self, cluster_id, status, previous_status, broker_tasks, *args, **kwargs):  # noqa: E501
        """AnyUnevenLoadDataAllOf - a model defined in OpenAPI
