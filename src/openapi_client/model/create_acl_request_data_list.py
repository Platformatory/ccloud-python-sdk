...
def lazy_import():
    ...
    globals()['CreateAclRequestData'] = CreateAclRequestData
    globals()['CreateAclRequestDataListAllOf'] = CreateAclRequestDataListAllOf


class CreateAclRequestDataList(ModelComposed):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([CreateAclRequestData],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CreateAclRequestDataList - a model defined in OpenAPI

        Keyword Args:
            data ([CreateAclRequestData]):
