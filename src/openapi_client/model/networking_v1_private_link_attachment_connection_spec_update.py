...
class NetworkingV1PrivateLinkAttachmentConnectionSpecUpdate(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NetworkingV1PrivateLinkAttachmentConnectionSpecUpdate - a model defined in OpenAPI
