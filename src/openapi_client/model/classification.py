...
class Classification(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'attributes': ({str: ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},)},),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            attributes ({str: ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},)}): The tag attributes. [optional]  # noqa: E501
