...
class SqlV1beta1StatementResult(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, *args, **kwargs):  # noqa: E501
        """SqlV1beta1StatementResult - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. defaults to "StatementResult", must be one of ["StatementResult", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "StatementResult")
