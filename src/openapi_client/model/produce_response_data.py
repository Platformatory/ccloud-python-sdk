...
class ProduceResponseData(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, size, type, *args, **kwargs):  # noqa: E501
        """ProduceResponseData - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, size, type, *args, **kwargs):  # noqa: E501
        """ProduceResponseData - a model defined in OpenAPI
