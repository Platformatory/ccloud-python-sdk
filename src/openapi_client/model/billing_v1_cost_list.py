...
class BillingV1CostList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """BillingV1CostList - a model defined in OpenAPI
        ...
        Keyword Args:
            api_version (str): APIVersion defines the schema version of this representation of a resource.. defaults to "billing/v1", must be one of ["billing/v1", ]  # noqa: E501
            kind (str): Kind defines the object this REST resource represents.. defaults to "CostList", must be one of ["CostList", ]  # noqa: E501
        ...
        api_version = kwargs.get('api_version', "billing/v1")
        kind = kwargs.get('kind', "CostList")
