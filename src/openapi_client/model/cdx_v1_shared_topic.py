...
class CdxV1SharedTopic(ModelNormal):
    ...
    def _from_openapi_data(cls, topic, *args, **kwargs):  # noqa: E501
        """CdxV1SharedTopic - a model defined in OpenAPI

        Args:
            topic (str): The topic name

        Keyword Args:
            kind (str): The shared resource kind. defaults to "Topic", must be one of ["Topic", ]  # noqa: E501
