...
class CmkV2Basic(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CmkV2Basic - a model defined in OpenAPI

        Args:

        Keyword Args:
            kind (str): Basic cluster type. . defaults to "Basic", must be one of ["Basic", ]  # noqa: E501
