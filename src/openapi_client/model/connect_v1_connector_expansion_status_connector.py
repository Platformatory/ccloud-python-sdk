...
class ConnectV1ConnectorExpansionStatusConnector(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, state, worker_id, *args, **kwargs):  # noqa: E501
        """ConnectV1ConnectorExpansionStatusConnector - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            trace (str): Exception message in case of an error.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, state, worker_id, *args, **kwargs):  # noqa: E501
        """ConnectV1ConnectorExpansionStatusConnector - a model defined in OpenAPI
