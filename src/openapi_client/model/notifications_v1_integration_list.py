...
class NotificationsV1IntegrationList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """NotificationsV1IntegrationList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. defaults to "IntegrationList", must be one of ["IntegrationList", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "IntegrationList")
