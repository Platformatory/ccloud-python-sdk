...
class ConnectV1PresignedUrl(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'upload_form_data': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'upload_form_data': 'upload_form_data',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ConnectV1PresignedUrl - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. [optional] if omitted the server will use the default value of "PresignedUrl"  # noqa: E501
            content_format (str): Content format of the Custom Connector Plugin archive.. [optional]  # noqa: E501
            upload_id (str): Unique identifier of this upload.. [optional]  # noqa: E501
            upload_url (str): Upload URL for the Custom Connector Plugin archive.. [optional]  # noqa: E501
            upload_form_data ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Upload form data of the Custom Connector Plugin. All values should be strings.. [optional]  # noqa: E501
        """
