...
class BrokerConfigDataAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, broker_id, *args, **kwargs):  # noqa: E501
        """BrokerConfigDataAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, broker_id, *args, **kwargs):  # noqa: E501
        """BrokerConfigDataAllOf - a model defined in OpenAPI
