...
class InlineResponse2001Connector(ModelNormal):
    ...
    def _from_openapi_data(cls, state, worker_id, *args, **kwargs):  # noqa: E501
        """InlineResponse2001Connector - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            trace (str): The exception name in case of error.. [optional]  # noqa: E501
        """
