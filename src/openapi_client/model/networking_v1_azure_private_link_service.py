...
class NetworkingV1AzurePrivateLinkService(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, zone, private_link_service_alias, private_link_service_resource_id, *args, **kwargs):  # noqa: E501
        """NetworkingV1AzurePrivateLinkService - a model defined in OpenAPI
