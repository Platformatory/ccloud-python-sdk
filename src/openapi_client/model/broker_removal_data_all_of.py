...
class BrokerRemovalDataAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, cluster_id, broker_id, broker_task, broker, *args, **kwargs):  # noqa: E501
        """BrokerRemovalDataAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, cluster_id, broker_id, broker_task, broker, *args, **kwargs):  # noqa: E501
        """BrokerRemovalDataAllOf - a model defined in OpenAPI
