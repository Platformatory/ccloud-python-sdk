...
def lazy_import():
    ...
    globals()['NetworkingV1ZoneInfo'] = NetworkingV1ZoneInfo


class NetworkingV1ZonesInfo(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """NetworkingV1ZonesInfo - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([NetworkingV1ZoneInfo]): Cloud provider zones metadata..  # noqa: E501

        Keyword Args:
            value ([NetworkingV1ZoneInfo]): Cloud provider zones metadata..  # noqa: E501
