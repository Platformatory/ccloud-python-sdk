...
class KsqldbcmV2ClusterList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """KsqldbcmV2ClusterList - a model defined in OpenAPI
        ...
        Keyword Args:
            api_version (str): APIVersion defines the schema version of this representation of a resource.. defaults to "ksqldbcm/v2", must be one of ["ksqldbcm/v2", ]  # noqa: E501
            kind (str): Kind defines the object this REST resource represents.. defaults to "ClusterList", must be one of ["ClusterList", ]  # noqa: E501
        ...
        api_version = kwargs.get('api_version', "ksqldbcm/v2")
        kind = kwargs.get('kind', "ClusterList")
