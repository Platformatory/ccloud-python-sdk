...
class AzureSSOConfig(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, kind, tenant_id, *args, **kwargs):  # noqa: E501
        """AzureSSOConfig - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, kind, tenant_id, *args, **kwargs):  # noqa: E501
        """AzureSSOConfig - a model defined in OpenAPI
