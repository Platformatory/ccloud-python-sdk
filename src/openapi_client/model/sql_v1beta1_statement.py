...
def lazy_import():
    ...
    globals()['SqlV1beta1StatementSpec'] = SqlV1beta1StatementSpec
    globals()['SqlV1beta1StatementStatus'] = SqlV1beta1StatementStatus


class SqlV1beta1Statement(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'spec': (SqlV1beta1StatementSpec,),  # noqa: E501
            'status': (SqlV1beta1StatementStatus,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SqlV1beta1Statement - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            api_version (str): APIVersion defines the schema version of this representation of a resource.. [optional] if omitted the server will use the default value of "sql/v1beta1"  # noqa: E501
            kind (str): Kind defines the object this REST resource represents.. [optional] if omitted the server will use the default value of "Statement"  # noqa: E501
            metadata (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
            name (str): The user provided name of the resource, unique within this environment.. [optional]  # noqa: E501
            organization_id (str): The unique identifier for the organization.. [optional]  # noqa: E501
            environment_id (str): The unique identifier for the environment.. [optional]  # noqa: E501
            spec (SqlV1beta1StatementSpec): [optional]  # noqa: E501
            status (SqlV1beta1StatementStatus): [optional]  # noqa: E501
        """
