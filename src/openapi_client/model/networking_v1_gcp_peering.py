...
class NetworkingV1GcpPeering(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'import_custom_routes': (bool,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'import_custom_routes': 'import_custom_routes',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, project, vpc_network, *args, **kwargs):  # noqa: E501
        """NetworkingV1GcpPeering - a model defined in OpenAPI
        ...
        Keyword Args:
            kind (str): Peering kind type.. defaults to "GcpPeering", must be one of ["GcpPeering", ]  # noqa: E501
            ...
            import_custom_routes (bool): Enable customer route import. For more information, see [Importing custom routes](https://cloud.google.com/vpc/docs/vpc-peering#importing-exporting-routes). . [optional] if omitted the server will use the default value of False  # noqa: E501
        """

        kind = kwargs.get('kind', "GcpPeering")
    ...
    @convert_js_args_to_python_args
    def __init__(self, project, vpc_network, *args, **kwargs):  # noqa: E501
        """NetworkingV1GcpPeering - a model defined in OpenAPI
