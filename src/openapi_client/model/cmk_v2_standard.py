...
class CmkV2Standard(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CmkV2Standard - a model defined in OpenAPI

        Args:

        Keyword Args:
            kind (str): Standard cluster type. . defaults to "Standard", must be one of ["Standard", ]  # noqa: E501
