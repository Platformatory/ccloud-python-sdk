...
class IamV2RoleBinding(ModelNormal):
    ...
    validations = {
        ...
        ('principal',): {
            'regex': {
                'pattern': r'(^User:.+$)|(^Group:.+$)',  # noqa: E501
            },
        },
        ('crn_pattern',): {
            'regex': {
    ...
    attribute_map = {
        ...
        'crn_pattern': 'crn_pattern',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """IamV2RoleBinding - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. [optional] if omitted the server will use the default value of "RoleBinding"  # noqa: E501
            ...
            principal (str): The principal User or Group to bind the role to. [optional]  # noqa: E501
            role_name (str): The name of the role to bind to the principal. [optional]  # noqa: E501
            crn_pattern (str): A CRN that specifies the scope and resource patterns necessary for the role to bind. [optional]  # noqa: E501
        """
