...
class BalancerStatusDataAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, cluster_id, status, any_uneven_load, broker_tasks, *args, **kwargs):  # noqa: E501
        """BalancerStatusDataAllOf - a model defined in OpenAPI
        ...
        self.status = status
        self.any_uneven_load = any_uneven_load
    ...
    @convert_js_args_to_python_args
    def __init__(self, cluster_id, status, any_uneven_load, broker_tasks, *args, **kwargs):  # noqa: E501
        """BalancerStatusDataAllOf - a model defined in OpenAPI
