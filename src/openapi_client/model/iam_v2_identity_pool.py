...
class IamV2IdentityPool(ModelNormal):
    ...
    attribute_map = {
        ...
        'identity_claim': 'identity_claim',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """IamV2IdentityPool - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. [optional] if omitted the server will use the default value of "IdentityPool"  # noqa: E501
            ...
            display_name (str): The name of the `IdentityPool`.. [optional]  # noqa: E501
            description (str): A description of how this `IdentityPool` is used. [optional]  # noqa: E501
            identity_claim (str): The JSON Web Token (JWT) claim to extract the authenticating identity to Confluent resources from (see [Registered Claim Names](https://datatracker.ietf.org/doc/html/rfc7519#section-4.1) for more details). This appears in the audit log records, showing, for example, that \"identity Z used identity pool X to access topic A\".. [optional]  # noqa: E501
            ...
            principal (str): Represents the federated identity associated with this pool.. [optional]  # noqa: E501
            state (str): The current state of the identity pool. [optional]  # noqa: E501
        """
