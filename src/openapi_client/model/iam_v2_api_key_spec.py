...
class IamV2ApiKeySpec(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """IamV2ApiKeySpec - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            secret (str): The API key secret. Only provided in `create` responses, not in `get` or `list`.. [optional]  # noqa: E501
            display_name (str): A human readable name for the API key. [optional]  # noqa: E501
            description (str): A human readable description for the API key. [optional]  # noqa: E501
            owner (bool, date, datetime, dict, float, int, list, str, none_type): The owner to which this belongs. The owner can be one of iam.v2.User, iam.v2.ServiceAccount.. [optional]  # noqa: E501
