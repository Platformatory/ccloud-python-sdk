...
class ConnectV1ConnectorErrorError(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ConnectV1ConnectorErrorError - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            code (int): Error code for the type of error. [optional]  # noqa: E501
