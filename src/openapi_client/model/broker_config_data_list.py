...
def lazy_import():
    ...
    globals()['BrokerConfigData'] = BrokerConfigData
    globals()['BrokerConfigDataListAllOf'] = BrokerConfigDataListAllOf
    globals()['ResourceCollection'] = ResourceCollection
    globals()['ResourceCollectionMetadata'] = ResourceCollectionMetadata


class BrokerConfigDataList(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'data': ([BrokerConfigData],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """BrokerConfigDataList - a model defined in OpenAPI
