...
class KafkaQuotasV1ClientQuotaList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """KafkaQuotasV1ClientQuotaList - a model defined in OpenAPI
        ...
        Keyword Args:
            api_version (str): APIVersion defines the schema version of this representation of a resource.. defaults to "kafka-quotas/v1", must be one of ["kafka-quotas/v1", ]  # noqa: E501
            kind (str): Kind defines the object this REST resource represents.. defaults to "ClientQuotaList", must be one of ["ClientQuotaList", ]  # noqa: E501
        ...
        api_version = kwargs.get('api_version', "kafka-quotas/v1")
        kind = kwargs.get('kind', "ClientQuotaList")
