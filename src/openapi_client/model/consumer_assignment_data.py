...
def lazy_import():
    ...
    globals()['ConsumerAssignmentDataAllOf'] = ConsumerAssignmentDataAllOf
    globals()['Relationship'] = Relationship
    globals()['Resource'] = Resource
    globals()['ResourceMetadata'] = ResourceMetadata


class ConsumerAssignmentData(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'partition': (Relationship,),  # noqa: E501
            'lag': (Relationship,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ConsumerAssignmentData - a model defined in OpenAPI
