...
class ConnectV1CustomConnectorPluginList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """ConnectV1CustomConnectorPluginList - a model defined in OpenAPI
        ...
        Keyword Args:
            api_version (str): APIVersion defines the schema version of this representation of a resource.. defaults to "connect/v1", must be one of ["connect/v1", ]  # noqa: E501
            kind (str): Kind defines the object this REST resource represents.. defaults to "CustomConnectorPluginList", must be one of ["CustomConnectorPluginList", ]  # noqa: E501
        ...
        api_version = kwargs.get('api_version', "connect/v1")
        kind = kwargs.get('kind', "CustomConnectorPluginList")
