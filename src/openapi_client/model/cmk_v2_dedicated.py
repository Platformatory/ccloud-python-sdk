...
class CmkV2Dedicated(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'kind': (str,),  # noqa: E501
            'cku': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, cku, *args, **kwargs):  # noqa: E501
        """CmkV2Dedicated - a model defined in OpenAPI
        ...
        Keyword Args:
            kind (str): Dedicated cluster type. . defaults to "Dedicated", must be one of ["Dedicated", ]  # noqa: E501
            ...
            encryption_key (str): The id of the encryption key that is used to encrypt the data in the Kafka cluster. (e.g. for Amazon Web Services, the Amazon Resource Name of the key). . [optional]  # noqa: E501
            zones ([str]): The list of zones the cluster is in.  On AWS, zones are AWS [AZ IDs](https://docs.aws.amazon.com/ram/latest/userguide/working-with-az-ids.html)  (e.g. use1-az3)  On GCP, zones are GCP [zones](https://cloud.google.com/compute/docs/regions-zones)  (e.g. us-central1-c). . [optional]  # noqa: E501
        """

        kind = kwargs.get('kind', "Dedicated")
    ...
    @convert_js_args_to_python_args
    def __init__(self, cku, *args, **kwargs):  # noqa: E501
        """CmkV2Dedicated - a model defined in OpenAPI
