...
class NotificationsV1SlackTarget(ModelNormal):
    ...
    def _from_openapi_data(cls, webhook_url, *args, **kwargs):  # noqa: E501
        """NotificationsV1SlackTarget - a model defined in OpenAPI

        Args:
            webhook_url (str): Slack Webhook URL for the particular Slack channel

        Keyword Args:
            kind (str): Integration Type. defaults to "Slack", must be one of ["Slack", ]  # noqa: E501
