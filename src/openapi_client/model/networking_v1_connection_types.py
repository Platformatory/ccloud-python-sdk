...
class NetworkingV1ConnectionTypes(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """NetworkingV1ConnectionTypes - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([str]): The connection types requested for use with the network..  # noqa: E501

        Keyword Args:
            value ([str]): The connection types requested for use with the network..  # noqa: E501
