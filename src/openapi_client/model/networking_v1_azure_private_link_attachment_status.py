...
def lazy_import():
    ...
    globals()['NetworkingV1AzurePrivateLinkService'] = NetworkingV1AzurePrivateLinkService


class NetworkingV1AzurePrivateLinkAttachmentStatus(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'kind': (str,),  # noqa: E501
            'private_link_services': ([NetworkingV1AzurePrivateLinkService],),  # noqa: E501
        }
    ...
    attribute_map = {
        'kind': 'kind',  # noqa: E501
        'private_link_services': 'private_link_services',  # noqa: E501
    }

    read_only_vars = {
        'kind',  # noqa: E501
        'private_link_services',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, private_link_services, *args, **kwargs):  # noqa: E501
        """NetworkingV1AzurePrivateLinkAttachmentStatus - a model defined in OpenAPI

        Args:
            private_link_services ([NetworkingV1AzurePrivateLinkService]): Array of Azure PrivateLink services that can be used to connect PrivateEndpoints for each availability zone. 

        Keyword Args:
            kind (str): PrivateLinkAttachmentStatus kind.. defaults to "AzurePrivateLinkAttachmentStatus", must be one of ["AzurePrivateLinkAttachmentStatus", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "AzurePrivateLinkAttachmentStatus")
        ...
        self.kind = kind
        self.private_link_services = private_link_services
