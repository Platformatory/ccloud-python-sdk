...
class CdxV1ConsumerSharedResourceList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """CdxV1ConsumerSharedResourceList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. defaults to "ConsumerSharedResourceList", must be one of ["ConsumerSharedResourceList", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "ConsumerSharedResourceList")
