...
def lazy_import():
    ...
    globals()['IamV2JwksObject'] = IamV2JwksObject


class IamV2IdentityProvider(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'keys': ([IamV2JwksObject],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """IamV2IdentityProvider - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            api_version (str): APIVersion defines the schema version of this representation of a resource.. [optional] if omitted the server will use the default value of "iam/v2"  # noqa: E501
            kind (str): Kind defines the object this REST resource represents.. [optional] if omitted the server will use the default value of "IdentityProvider"  # noqa: E501
            ...
            display_name (str): The name of the Provider.. [optional]  # noqa: E501
            description (str): A description for your provider. [optional]  # noqa: E501
            state (str): The current state of the provider. [optional]  # noqa: E501
            issuer (str): A publicly reachable issuer URI for the Identity Provider. The unique issuer URI string represents the entity for issuing tokens.. [optional]  # noqa: E501
            jwks_uri (str): A publicly reachable JSON Web Key Set (JWKS) URI for the Identity Provider. A JSON Web Key Set (JWKS) provides a set of keys containing the public keys used to verify any JSON Web Token (JWT) issued by your OAuth 2.0 identity provider.. [optional]  # noqa: E501
            keys ([IamV2JwksObject]): The JWKS provided by the Provider. We only express the `kid` and `alg` for each key set. [optional]  # noqa: E501
        """
