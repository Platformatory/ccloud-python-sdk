...
class ConstraintDef(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ConstraintDef - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            params ({str: ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},)}): The params. [optional]  # noqa: E501
        """
