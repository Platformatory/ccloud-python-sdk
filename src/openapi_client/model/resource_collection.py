...
class ResourceCollection(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, kind, metadata, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, kind, metadata, *args, **kwargs):  # noqa: E501
        """ResourceCollection - a model defined in OpenAPI
