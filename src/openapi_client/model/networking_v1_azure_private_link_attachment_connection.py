...
class NetworkingV1AzurePrivateLinkAttachmentConnection(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, private_endpoint_resource_id, *args, **kwargs):  # noqa: E501
        """NetworkingV1AzurePrivateLinkAttachmentConnection - a model defined in OpenAPI

        Args:
            private_endpoint_resource_id (str): Resource Id of the PrivateEndpoint that is connected to the PrivateLink service. 

        Keyword Args:
            kind (str): PrivateLinkAttachmentConnection kind.. defaults to "AzurePrivateLinkAttachmentConnection", must be one of ["AzurePrivateLinkAttachmentConnection", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "AzurePrivateLinkAttachmentConnection")
    ...
    @convert_js_args_to_python_args
    def __init__(self, private_endpoint_resource_id, *args, **kwargs):  # noqa: E501
        """NetworkingV1AzurePrivateLinkAttachmentConnection - a model defined in OpenAPI
