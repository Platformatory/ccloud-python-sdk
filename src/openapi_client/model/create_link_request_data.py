...
def lazy_import():
    ...
    globals()['ConfigData'] = ConfigData


class CreateLinkRequestData(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'source_cluster_id': (str,),  # noqa: E501
            'destination_cluster_id': (str,),  # noqa: E501
            'remote_cluster_id': (str,),  # noqa: E501
            'cluster_link_id': (str,),  # noqa: E501
            'configs': ([ConfigData],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CreateLinkRequestData - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            source_cluster_id (str): [optional]  # noqa: E501
            destination_cluster_id (str): [optional]  # noqa: E501
            remote_cluster_id (str): The expected remote cluster ID.. [optional]  # noqa: E501
            cluster_link_id (str): The expected cluster link ID. Can be provided when creating the second side of a bidirectional link for validating the link ID is as expected. If it's not provided, it's inferred from the remote cluster.. [optional]  # noqa: E501
            configs ([ConfigData]): [optional]  # noqa: E501
        """
