...
class NetworkingV1TransitGatewayAttachmentList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """NetworkingV1TransitGatewayAttachmentList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. defaults to "TransitGatewayAttachmentList", must be one of ["TransitGatewayAttachmentList", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "TransitGatewayAttachmentList")
