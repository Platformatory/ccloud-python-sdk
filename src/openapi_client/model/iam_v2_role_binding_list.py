...
class IamV2RoleBindingList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """IamV2RoleBindingList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. defaults to "RoleBindingList", must be one of ["RoleBindingList", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "RoleBindingList")
