...
class NetworkingV1NetworkList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """NetworkingV1NetworkList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. defaults to "NetworkList", must be one of ["NetworkList", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "NetworkList")
