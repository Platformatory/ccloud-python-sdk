...
class NetworkingV1PrivateLinkAttachmentSpec(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NetworkingV1PrivateLinkAttachmentSpec - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            display_name (str): The name of the PrivateLink attachment.. [optional]  # noqa: E501
            cloud (str): The cloud service provider that hosts the resources to access with the PrivateLink attachment. . [optional]  # noqa: E501
            region (str): The cloud service provider region where the resources to be accessed using the PrivateLink attachment are located. . [optional]  # noqa: E501
