...
class NetworkingV1DnsConfig(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'resolution': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, resolution, *args, **kwargs):  # noqa: E501
        """NetworkingV1DnsConfig - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, resolution, *args, **kwargs):  # noqa: E501
        """NetworkingV1DnsConfig - a model defined in OpenAPI
