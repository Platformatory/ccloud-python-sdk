...
class ByokV1AzureKey(ModelNormal):
    ...
    attribute_map = {
        ...
        'key_vault_id': 'key_vault_id',  # noqa: E501
        'kind': 'kind',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key_id, key_vault_id, tenant_id, *args, **kwargs):  # noqa: E501
        """ByokV1AzureKey - a model defined in OpenAPI
        ...
        Keyword Args:
            kind (str): BYOK kind type. . defaults to "AzureKey", must be one of ["AzureKey", ]  # noqa: E501
            ...
            application_id (str): The Application ID created for this key-environment combination. . [optional]  # noqa: E501
        """

        kind = kwargs.get('kind', "AzureKey")
    ...
    @convert_js_args_to_python_args
    def __init__(self, key_id, key_vault_id, tenant_id, *args, **kwargs):  # noqa: E501
        """ByokV1AzureKey - a model defined in OpenAPI
