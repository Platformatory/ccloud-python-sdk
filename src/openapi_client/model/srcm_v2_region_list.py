...
class SrcmV2RegionList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """SrcmV2RegionList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. defaults to "RegionList", must be one of ["RegionList", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "RegionList")
