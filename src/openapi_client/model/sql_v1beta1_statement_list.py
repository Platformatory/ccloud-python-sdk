...
class SqlV1beta1StatementList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """SqlV1beta1StatementList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. defaults to "StatementList", must be one of ["StatementList", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "StatementList")
