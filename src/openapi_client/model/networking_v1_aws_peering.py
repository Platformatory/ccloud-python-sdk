...
def lazy_import():
    ...
    globals()['NetworkingV1Cidr'] = NetworkingV1Cidr


class NetworkingV1AwsPeering(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'vpc': (str,),  # noqa: E501
            'routes': ([NetworkingV1Cidr],),  # noqa: E501
            'customer_region': (str,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'customer_region': 'customer_region',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account, vpc, routes, customer_region, *args, **kwargs):  # noqa: E501
        """NetworkingV1AwsPeering - a model defined in OpenAPI
        ...
        Args:
            ...
            routes ([NetworkingV1Cidr]): The [CIDR blocks](https://en.wikipedia.org/wiki/Classless_Inter-Domain_Routing) of the VPC you are peering with Confluent Cloud network. This is used by Confluent Cloud network to route traffic back to your network. The CIDR block must be a private range and cannot overlap with the Confluent Cloud CIDR block. 
            customer_region (str): The region of the VPC you are peering with Confluent Cloud network.

        Keyword Args:
            kind (str): Peering kind type.. defaults to "AwsPeering", must be one of ["AwsPeering", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "AwsPeering")
    ...
    @convert_js_args_to_python_args
    def __init__(self, account, vpc, routes, customer_region, *args, **kwargs):  # noqa: E501
        """NetworkingV1AwsPeering - a model defined in OpenAPI
