...
class PartnerV2Entitlement(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'usage_reporting_id': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'usage_reporting_id': 'usage_reporting_id',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PartnerV2Entitlement - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            api_version (str): APIVersion defines the schema version of this representation of a resource.. [optional] if omitted the server will use the default value of "partner/v2"  # noqa: E501
            kind (str): Kind defines the object this REST resource represents.. [optional] if omitted the server will use the default value of "Entitlement"  # noqa: E501
            id (str): ID is the \"natural identifier\" for an object within its scope/namespace; it is normally unique across time but not space. That is, you can assume that the ID will not be reclaimed and reused after an object is deleted (\"time\"); however, it may collide with IDs for other object `kinds` or objects of the same `kind` within a different scope/namespace (\"space\").. [optional]  # noqa: E501
            metadata (ObjectMeta): [optional]  # noqa: E501
            external_id (str): The unique external ID of the entitlement (this should be unique to customer). [optional]  # noqa: E501
            name (str): The name of the entitlement. [optional]  # noqa: E501
            plan_id (str): The plan ID the entitlement. [optional]  # noqa: E501
            product_id (str): The product ID of the entitlement. [optional]  # noqa: E501
            usage_reporting_id (str): The usage reporting ID of the entitlement (if usage reporting uses a different ID, otherwise, same as external_id) . [optional]  # noqa: E501
            resource_id (str): The resource ID of the entitlement. [optional]  # noqa: E501
            organization (bool, date, datetime, dict, float, int, list, str, none_type): The organization associated with this object.. [optional]  # noqa: E501
        """
