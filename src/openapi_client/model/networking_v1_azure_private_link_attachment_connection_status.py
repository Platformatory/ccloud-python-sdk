...
class NetworkingV1AzurePrivateLinkAttachmentConnectionStatus(ModelNormal):
    ...
    allowed_values = {
        ('kind',): {
            'AZUREPRIVATELINKATTACHMENTCONNECTIONSTATUS': "AzurePrivateLinkAttachmentConnectionStatus",
        },
    }
    ...
    def openapi_types():
        ...
        return {
            'kind': (str,),  # noqa: E501
            'zone': (str,),  # noqa: E501
            'private_link_service_alias': (str,),  # noqa: E501
            'private_link_service_resource_id': (str,),  # noqa: E501
            'private_endpoint_resource_id': (str,),  # noqa: E501
        }
    ...
    attribute_map = {
        'kind': 'kind',  # noqa: E501
        'zone': 'zone',  # noqa: E501
        'private_link_service_alias': 'private_link_service_alias',  # noqa: E501
        'private_link_service_resource_id': 'private_link_service_resource_id',  # noqa: E501
        'private_endpoint_resource_id': 'private_endpoint_resource_id',  # noqa: E501
    }

    read_only_vars = {
        'zone',  # noqa: E501
        'private_link_service_alias',  # noqa: E501
        'private_link_service_resource_id',  # noqa: E501
        'private_endpoint_resource_id',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, zone, private_link_service_alias, private_link_service_resource_id, private_endpoint_resource_id, *args, **kwargs):  # noqa: E501
        """NetworkingV1AzurePrivateLinkAttachmentConnectionStatus - a model defined in OpenAPI

        Args:
            zone (str): Availability zone associated with the Azure PrivateLink service.
            private_link_service_alias (str): Azure PrivateLink service alias for the availability zone.
            private_link_service_resource_id (str): Azure PrivateLink service resource id for the availability zone.
            private_endpoint_resource_id (str): Resource Id of the PrivateEndpoint (if any) that is connected to the PrivateLink service for this availability zone. 

        Keyword Args:
            kind (str): PrivateLinkAttachmentConnectionStatus kind.. defaults to "AzurePrivateLinkAttachmentConnectionStatus", must be one of ["AzurePrivateLinkAttachmentConnectionStatus", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "AzurePrivateLinkAttachmentConnectionStatus")
        ...
        self.private_link_service_resource_id = private_link_service_resource_id
