...
class IamV2Invitation(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """IamV2Invitation - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. [optional] if omitted the server will use the default value of "Invitation"  # noqa: E501
            ...
            email (str): The user/invitee's email address. [optional]  # noqa: E501
            auth_type (str): The user/invitee's authentication type. Note that only the [OrganizationAdmin role](https://docs.confluent.io/cloud/current/access-management/access-control/cloud-rbac.html#organizationadmin) can invite AUTH_TYPE_LOCAL users to SSO organizations. The user's auth_type is set as AUTH_TYPE_SSO by default if the organization has SSO enabled. Otherwise, the user's auth_type is AUTH_TYPE_LOCAL by default. . [optional]  # noqa: E501
            status (str): The status of invitations. [optional]  # noqa: E501
            accepted_at (datetime, none_type): The timestamp that the invitation was accepted. [optional]  # noqa: E501
            expires_at (datetime): The timestamp that the invitation will expire. [optional]  # noqa: E501
            user (bool, date, datetime, dict, float, int, list, str, none_type): The user/invitee. [optional]  # noqa: E501
            creator (bool, date, datetime, dict, float, int, list, str, none_type): The invitation creator. [optional]  # noqa: E501
        """
