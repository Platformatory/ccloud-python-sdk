...
class NetworkingV1AwsVpcEndpointService(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, vpc_endpoint_service_name, *args, **kwargs):  # noqa: E501
        """NetworkingV1AwsVpcEndpointService - a model defined in OpenAPI

        Args:
            vpc_endpoint_service_name (str): Id of the VPC Endpoint service.
