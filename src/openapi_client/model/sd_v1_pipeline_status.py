...
class SdV1PipelineStatus(ModelNormal):
    ...
    attribute_map = {
        ...
        'topic_count': 'topic_count',  # noqa: E501
        'connector_count': 'connector_count',  # noqa: E501
        'query_count': 'query_count',  # noqa: E501
    }

    read_only_vars = {
        'state',  # noqa: E501
        'topic_count',  # noqa: E501
        'connector_count',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SdV1PipelineStatus - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            state (str): The current state of the pipeline.:   DRAFT:  the pipeline is a draft and not activated yet;   ACTIVATING:  the pipeline activation is in progress;   DEACTIVATING:  the pipeline deactivation is in progress;   ACTIVE:  the pipeline is actived and running;   FAILED:  the pipeline activation or deactivation failed;   DELETED:  the pipeline is deleted . [optional]  # noqa: E501
            topic_count (int): The number of Kafka topics defined in the pipeline.. [optional]  # noqa: E501
            connector_count (int): The number of connectors defined in the pipeline.. [optional]  # noqa: E501
            query_count (int): The number of KSQL queries defined in the pipeline.. [optional]  # noqa: E501
        """
