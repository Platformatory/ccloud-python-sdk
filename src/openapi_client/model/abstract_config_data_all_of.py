...
class AbstractConfigDataAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, cluster_id, name, is_default, is_read_only, is_sensitive, source, synonyms, *args, **kwargs):  # noqa: E501
        """AbstractConfigDataAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, cluster_id, name, is_default, is_read_only, is_sensitive, source, synonyms, *args, **kwargs):  # noqa: E501
        """AbstractConfigDataAllOf - a model defined in OpenAPI
