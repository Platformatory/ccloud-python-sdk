...
class NetworkingV1AwsTransitGatewayAttachmentStatus(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'transit_gateway_attachment_id': (str,),  # noqa: E501
            'kind': (str,),  # noqa: E501
        }
    ...
    attribute_map = {
        'transit_gateway_attachment_id': 'transit_gateway_attachment_id',  # noqa: E501
        'kind': 'kind',  # noqa: E501
    }

    read_only_vars = {
        'transit_gateway_attachment_id',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, transit_gateway_attachment_id, *args, **kwargs):  # noqa: E501
        """NetworkingV1AwsTransitGatewayAttachmentStatus - a model defined in OpenAPI

        Args:
            transit_gateway_attachment_id (str): The ID of the AWS Transit Gateway VPC Attachment that attaches Confluent VPC to Transit Gateway.
        ...
        Keyword Args:
            ...
            kind (str): AWS Transit Gateway Attachment Status kind type.. [optional] if omitted the server will use the default value of "AwsTransitGatewayAttachmentStatus"  # noqa: E501
        """
