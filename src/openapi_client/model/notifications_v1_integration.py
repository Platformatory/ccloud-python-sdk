...
class NotificationsV1Integration(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NotificationsV1Integration - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. [optional] if omitted the server will use the default value of "Integration"  # noqa: E501
            ...
            display_name (str): A human readable name for the particular integration . [optional]  # noqa: E501
            description (str): A human readable description for the particular integration . [optional]  # noqa: E501
            target (bool, date, datetime, dict, float, int, list, str, none_type): Integration-specific details (integration targets) . [optional]  # noqa: E501
        """
