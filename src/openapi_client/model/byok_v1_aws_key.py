...
class ByokV1AwsKey(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key_arn, *args, **kwargs):  # noqa: E501
        """ByokV1AwsKey - a model defined in OpenAPI

        Args:
            key_arn (str): The Amazon Resource Name (ARN) of an AWS KMS key. 

        Keyword Args:
            kind (str): BYOK kind type. . defaults to "AwsKey", must be one of ["AwsKey", ]  # noqa: E501
            ...
            roles ([str]): The Amazon Resource Names (ARNs) of IAM Roles created for this key-environment combination. . [optional]  # noqa: E501
        """

        kind = kwargs.get('kind', "AwsKey")
    ...
    @convert_js_args_to_python_args
    def __init__(self, key_arn, *args, **kwargs):  # noqa: E501
        """ByokV1AwsKey - a model defined in OpenAPI
