...
class ConsumerAssignmentDataAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, cluster_id, consumer_group_id, consumer_id, topic_name, partition_id, partition, lag, *args, **kwargs):  # noqa: E501
        """ConsumerAssignmentDataAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, cluster_id, consumer_group_id, consumer_id, topic_name, partition_id, partition, lag, *args, **kwargs):  # noqa: E501
        """ConsumerAssignmentDataAllOf - a model defined in OpenAPI
