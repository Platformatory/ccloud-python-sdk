...
class BillingV1Cost(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'network_access_type': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'network_access_type': 'network_access_type',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """BillingV1Cost - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            api_version (str): APIVersion defines the schema version of this representation of a resource.. [optional] if omitted the server will use the default value of "billing/v1"  # noqa: E501
            kind (str): Kind defines the object this REST resource represents.. [optional] if omitted the server will use the default value of "Cost"  # noqa: E501
            id (str): ID is the \"natural identifier\" for an object within its scope/namespace; it is normally unique across time but not space. That is, you can assume that the ID will not be reclaimed and reused after an object is deleted (\"time\"); however, it may collide with IDs for other object `kinds` or objects of the same `kind` within a different scope/namespace (\"space\").. [optional]  # noqa: E501
            start_date (date): Start date of time period (inclusive) to retrieve billing costs. It is represented in RFC3339 format and is in UTC.. [optional]  # noqa: E501
            end_date (date): End date of time period (exclusive) to retrieve billing costs. It is represented in RFC3339 format and is in UTC.. [optional]  # noqa: E501
            granularity (str): Granularity at which each line item is aggregated.. [optional] if omitted the server will use the default value of "DAILY"  # noqa: E501
            network_access_type (str): Network access type for the cluster.. [optional]  # noqa: E501
            product (str): Product name.. [optional]  # noqa: E501
            line_type (str): Type of the line item.. [optional]  # noqa: E501
            price (float): Price for the line item in dollars.. [optional]  # noqa: E501
            unit (str): Unit of the line item.. [optional]  # noqa: E501
            quantity (float): Quantity of the line item.. [optional]  # noqa: E501
            original_amount (float): Original amount accrued for this line item.. [optional]  # noqa: E501
            discount_amount (float): Amount discounted from the original amount in dollars.. [optional]  # noqa: E501
            amount (float): Final amount after deducting discounts.. [optional]  # noqa: E501
            resource (bool, date, datetime, dict, float, int, list, str, none_type): The resource for a given object. [optional]  # noqa: E501
        """
