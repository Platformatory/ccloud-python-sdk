...
class AclDataAllOf(ModelNormal):
    ...
    attribute_map = {
        ...
        'pattern_type': 'pattern_type',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, cluster_id, resource_type, resource_name, pattern_type, principal, host, operation, permission, *args, **kwargs):  # noqa: E501
        """AclDataAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, cluster_id, resource_type, resource_name, pattern_type, principal, host, operation, permission, *args, **kwargs):  # noqa: E501
        """AclDataAllOf - a model defined in OpenAPI
