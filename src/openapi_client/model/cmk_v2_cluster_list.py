...
class CmkV2ClusterList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """CmkV2ClusterList - a model defined in OpenAPI
        ...
        Keyword Args:
            api_version (str): APIVersion defines the schema version of this representation of a resource.. defaults to "cmk/v2", must be one of ["cmk/v2", ]  # noqa: E501
        ...
        api_version = kwargs.get('api_version', "cmk/v2")
