...
class FcpmV2ComputePoolStatus(ModelNormal):
    ...
    attribute_map = {
        ...
        'current_cfu': 'current_cfu',  # noqa: E501
    }

    read_only_vars = {
        'phase',  # noqa: E501
        'current_cfu',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, phase, current_cfu, *args, **kwargs):  # noqa: E501
        """FcpmV2ComputePoolStatus - a model defined in OpenAPI

        Args:
            phase (str): Status of the Flink compute pool.
            current_cfu (int): The number of Confluent Flink Units (CFUs) currently allocated to this Flink compute pool.
