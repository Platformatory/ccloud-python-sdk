...
class NetworkingV1PrivateLinkAttachmentConnectionList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """NetworkingV1PrivateLinkAttachmentConnectionList - a model defined in OpenAPI
        ...
        Keyword Args:
            api_version (str): APIVersion defines the schema version of this representation of a resource.. defaults to "networking/v1", must be one of ["networking/v1", ]  # noqa: E501
            kind (str): Kind defines the object this REST resource represents.. defaults to "PrivateLinkAttachmentConnectionList", must be one of ["PrivateLinkAttachmentConnectionList", ]  # noqa: E501
        ...
        api_version = kwargs.get('api_version', "networking/v1")
        kind = kwargs.get('kind', "PrivateLinkAttachmentConnectionList")
