...
class CdxV1SharedSubject(ModelNormal):
    ...
    def _from_openapi_data(cls, subject, *args, **kwargs):  # noqa: E501
        """CdxV1SharedSubject - a model defined in OpenAPI

        Args:
            subject (str): The subject name

        Keyword Args:
            kind (str): The shared resource kind. defaults to "Subject", must be one of ["Subject", ]  # noqa: E501
