...
class NetworkingV1GcpPrivateLinkAttachmentConnectionStatus(ModelNormal):
    ...
    allowed_values = {
        ('kind',): {
            'GCPPRIVATELINKATTACHMENTCONNECTIONSTATUS': "GcpPrivateLinkAttachmentConnectionStatus",
        },
    }
    ...
    def openapi_types():
        ...
        return {
            'kind': (str,),  # noqa: E501
            'zone': (str,),  # noqa: E501
            'private_service_connect_service_attachment': (str,),  # noqa: E501
            'private_service_connect_connection_id': (str,),  # noqa: E501
        }
    ...
    attribute_map = {
        'kind': 'kind',  # noqa: E501
        'zone': 'zone',  # noqa: E501
        'private_service_connect_service_attachment': 'private_service_connect_service_attachment',  # noqa: E501
        'private_service_connect_connection_id': 'private_service_connect_connection_id',  # noqa: E501
    }

    read_only_vars = {
        'zone',  # noqa: E501
        'private_service_connect_service_attachment',  # noqa: E501
        'private_service_connect_connection_id',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, zone, private_service_connect_service_attachment, private_service_connect_connection_id, *args, **kwargs):  # noqa: E501
        """NetworkingV1GcpPrivateLinkAttachmentConnectionStatus - a model defined in OpenAPI

        Args:
            zone (str): Zone associated with the GCP PrivateLink attachment connection.
            private_service_connect_service_attachment (str): GCP Private Service Connect ServiceAttachment for the zone.
            private_service_connect_connection_id (str): Id of the Private Service connection.

        Keyword Args:
            kind (str): PrivateLinkAttachmentConnectionStatus kind.. defaults to "GcpPrivateLinkAttachmentConnectionStatus", must be one of ["GcpPrivateLinkAttachmentConnectionStatus", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "GcpPrivateLinkAttachmentConnectionStatus")
        ...
        self.kind = kind
        self.zone = zone
        self.private_service_connect_service_attachment = private_service_connect_service_attachment
        self.private_service_connect_connection_id = private_service_connect_connection_id
