...
class TypedEnvScopedObjectReference(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, related, resource_name, *args, **kwargs):  # noqa: E501
        """TypedEnvScopedObjectReference - a model defined in OpenAPI

        Args:
            id (str): ID of the referred resource
            related (str): API URL for accessing or modifying the referred object
            resource_name (str): CRN reference to the referred resource
        ...
        Keyword Args:
            ...
            environment (str): Environment of the referred resource, if env-scoped. [optional]  # noqa: E501
            api_version (str): API group and version of the referred resource. [optional]  # noqa: E501
            kind (str): Kind of the referred resource. [optional]  # noqa: E501
        """
