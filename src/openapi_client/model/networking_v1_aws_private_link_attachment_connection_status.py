...
class NetworkingV1AwsPrivateLinkAttachmentConnectionStatus(ModelNormal):
    ...
    allowed_values = {
        ('kind',): {
            'AWSPRIVATELINKATTACHMENTCONNECTIONSTATUS': "AwsPrivateLinkAttachmentConnectionStatus",
        },
    }
    ...
    def openapi_types():
        ...
        return {
            'kind': (str,),  # noqa: E501
            'vpc_endpoint_service_name': (str,),  # noqa: E501
            'vpc_endpoint_id': (str,),  # noqa: E501
        }
    ...
    attribute_map = {
        'kind': 'kind',  # noqa: E501
        'vpc_endpoint_service_name': 'vpc_endpoint_service_name',  # noqa: E501
        'vpc_endpoint_id': 'vpc_endpoint_id',  # noqa: E501
    }

    read_only_vars = {
        'vpc_endpoint_service_name',  # noqa: E501
        'vpc_endpoint_id',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, vpc_endpoint_service_name, vpc_endpoint_id, *args, **kwargs):  # noqa: E501
        """NetworkingV1AwsPrivateLinkAttachmentConnectionStatus - a model defined in OpenAPI

        Args:
            vpc_endpoint_service_name (str): Id of the VPC Endpoint service used for PrivateLink.
            vpc_endpoint_id (str): Id of the VPC Endpoint (if any) that is connected to the VPC Endpoint service.

        Keyword Args:
            kind (str): PrivateLinkAttachmentConnectionStatus kind.. defaults to "AwsPrivateLinkAttachmentConnectionStatus", must be one of ["AwsPrivateLinkAttachmentConnectionStatus", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "AwsPrivateLinkAttachmentConnectionStatus")
