...
def lazy_import():
    ...
    globals()['ListMirrorTopicsResponseData'] = ListMirrorTopicsResponseData
    globals()['ListMirrorTopicsResponseDataListAllOf'] = ListMirrorTopicsResponseDataListAllOf
    globals()['ResourceCollection'] = ResourceCollection
    globals()['ResourceCollectionMetadata'] = ResourceCollectionMetadata


class ListMirrorTopicsResponseDataList(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'data': ([ListMirrorTopicsResponseData],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ListMirrorTopicsResponseDataList - a model defined in OpenAPI

        Keyword Args:
            kind (str):
            metadata (ResourceCollectionMetadata):
            data ([ListMirrorTopicsResponseData]):
