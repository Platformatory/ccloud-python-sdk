...
class NetworkingV1NetworkSpec(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'connection_types': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'cidr': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'zones': ([str],),  # noqa: E501
            'zones_info': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'dns_config': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'reserved_cidr': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'zones_info': 'zones_info',  # noqa: E501
        'dns_config': 'dns_config',  # noqa: E501
        'reserved_cidr': 'reserved_cidr',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NetworkingV1NetworkSpec - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            display_name (str): The name of the network. [optional]  # noqa: E501
            cloud (str): The cloud service provider in which the network exists.. [optional]  # noqa: E501
            region (str): The cloud service provider region in which the network exists.. [optional]  # noqa: E501
            connection_types (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
            cidr (bool, date, datetime, dict, float, int, list, str, none_type): The IPv4 [CIDR block](https://en.wikipedia.org/wiki/Classless_Inter-Domain_Routing) to used for this network. Must be `/16`. Required for VPC peering and AWS TransitGateway. . [optional]  # noqa: E501
            zones ([str]): The 3 availability zones for this network. They can optionally be specified for AWS networks used with PrivateLink, for GCP networks used with Private Service Connect, and for AWS and GCP networks used with Peering. Otherwise, they are automatically chosen by Confluent Cloud.  On AWS, zones are AWS [AZ IDs](https://docs.aws.amazon.com/ram/latest/userguide/working-with-az-ids.html)  (e.g. use1-az3)  On GCP, zones are GCP [zones](https://cloud.google.com/compute/docs/regions-zones)  (e.g. us-central1-c).  On Azure, zones are Confluent-chosen names (e.g. 1, 2, 3) since Azure does not  have universal zone identifiers. . [optional]  # noqa: E501
            zones_info (bool, date, datetime, dict, float, int, list, str, none_type): Each item represents information related to a single zone.  Note - The attribute is in a [Limited Availability lifecycle stage](https://docs.confluent.io/cloud/current/api.html#section/Versioning/API-Lifecycle-Policy) . [optional]  # noqa: E501
