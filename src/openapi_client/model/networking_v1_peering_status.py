...
class NetworkingV1PeeringStatus(ModelNormal):
    ...
    def _from_openapi_data(cls, phase, *args, **kwargs):  # noqa: E501
        """NetworkingV1PeeringStatus - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            error_code (str): Error code if peering is in a failed state. May be used for programmatic error checking.. [optional]  # noqa: E501
            error_message (str): Displayable error message if peering is in a failed state. [optional]  # noqa: E501
        """
