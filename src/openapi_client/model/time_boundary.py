...
class TimeBoundary(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TimeBoundary - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            start_time (str): The start time of format yyyy/MM/dd HH:mm:ss. [optional]  # noqa: E501
            end_time (str): The end time of format yyyy/MM/dd HH:mm:ss. [optional]  # noqa: E501
            time_zone (str): The time zone (see java.util.TimeZone). [optional]  # noqa: E501
        """
