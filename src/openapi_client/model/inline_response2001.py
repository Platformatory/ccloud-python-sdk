...
def lazy_import():
    ...
    globals()['InlineResponse2001Connector'] = InlineResponse2001Connector
...
class InlineResponse2001(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'name': (str,),  # noqa: E501
            'type': (str,),  # noqa: E501
            'connector': (InlineResponse2001Connector,),  # noqa: E501
    ...
    def _from_openapi_data(cls, name, type, connector, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            tasks ([InlineResponse2001Tasks]): The map containing the task status.. [optional]  # noqa: E501
        """
