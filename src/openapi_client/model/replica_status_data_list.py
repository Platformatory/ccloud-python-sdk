...
def lazy_import():
    ...
    globals()['ReplicaStatusData'] = ReplicaStatusData
    globals()['ReplicaStatusDataListAllOf'] = ReplicaStatusDataListAllOf
    globals()['ResourceCollection'] = ResourceCollection
    globals()['ResourceCollectionMetadata'] = ResourceCollectionMetadata


class ReplicaStatusDataList(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'data': ([ReplicaStatusData],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ReplicaStatusDataList - a model defined in OpenAPI

        Keyword Args:
            kind (str):
            metadata (ResourceCollectionMetadata):
            data ([ReplicaStatusData]):
