...
class NetworkingV1NetworkLinkServiceAssociationStatus(ModelNormal):
    ...
    def _from_openapi_data(cls, phase, *args, **kwargs):  # noqa: E501
        """NetworkingV1NetworkLinkServiceAssociationStatus - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            error_code (str): Error code if network link is in a failed state. May be used for programmatic error checking.. [optional]  # noqa: E501
            error_message (str): Displayable error message if network link is in a failed state. [optional]  # noqa: E501
            expires_at (datetime): The date and time when the request expires if it is not accepted by the target network admin.. [optional]  # noqa: E501
        """
