...
class SdV1PipelineSpec(ModelNormal):
    ...
    validations = {
        ('display_name',): {
            'max_length': 64,
            'regex': {
                'pattern': r'^[a-zA-Z0-9-_.!~*\'()]{1,64}$',  # noqa: E501
            },
        },
    }
    ...
    def openapi_types():
        ...
        return {
            ...
            'retained_topic_names': ([str],),  # noqa: E501
            'activated': (bool,),  # noqa: E501
            'activation_privilege': (bool,),  # noqa: E501
            'source_code': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'secrets': ({str: (str,)},),  # noqa: E501
            'environment': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'kafka_cluster': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'ksql_cluster': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'stream_governance_cluster': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'retained_topic_names': 'retained_topic_names',  # noqa: E501
        'activated': 'activated',  # noqa: E501
        'activation_privilege': 'activation_privilege',  # noqa: E501
        'source_code': 'source_code',  # noqa: E501
        'secrets': 'secrets',  # noqa: E501
        'environment': 'environment',  # noqa: E501
        'kafka_cluster': 'kafka_cluster',  # noqa: E501
        'ksql_cluster': 'ksql_cluster',  # noqa: E501
        'stream_governance_cluster': 'stream_governance_cluster',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SdV1PipelineSpec - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            display_name (str): The name of the pipeline.. [optional]  # noqa: E501
            description (str): The description of the pipeline.. [optional]  # noqa: E501
            retained_topic_names ([str]): A list of Kafka topic names from the activated pipeline to be retained when this pipeline is deactivated. . [optional]  # noqa: E501
            activated (bool): The desired state of the pipeline.. [optional] if omitted the server will use the default value of False  # noqa: E501
            activation_privilege (bool): Whether the pipeline has privileges to be activated.. [optional] if omitted the server will use the default value of False  # noqa: E501
            source_code ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): A map of source code format and statements that define this pipeline.. [optional]  # noqa: E501
            secrets ({str: (str,)}): A map of secrets used in the pipeline source code.. [optional]  # noqa: E501
            environment (bool, date, datetime, dict, float, int, list, str, none_type): The environment to which this belongs.. [optional]  # noqa: E501
            kafka_cluster (bool, date, datetime, dict, float, int, list, str, none_type): The kafka_cluster to which this belongs.. [optional]  # noqa: E501
            ksql_cluster (bool, date, datetime, dict, float, int, list, str, none_type): The ksql_cluster associated with this object.. [optional]  # noqa: E501
            stream_governance_cluster (bool, date, datetime, dict, float, int, list, str, none_type): The stream_governance_cluster associated with this object.. [optional]  # noqa: E501
        """
