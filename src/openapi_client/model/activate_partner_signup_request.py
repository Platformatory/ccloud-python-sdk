...
class ActivatePartnerSignupRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, user, organization_id, *args, **kwargs):  # noqa: E501
        """ActivatePartnerSignupRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, user, organization_id, *args, **kwargs):  # noqa: E501
        """ActivatePartnerSignupRequest - a model defined in OpenAPI
