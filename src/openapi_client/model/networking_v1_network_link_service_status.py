...
class NetworkingV1NetworkLinkServiceStatus(ModelNormal):
    ...
    def _from_openapi_data(cls, phase, *args, **kwargs):  # noqa: E501
        """NetworkingV1NetworkLinkServiceStatus - a model defined in OpenAPI

        Args:
            phase (str): The lifecycle phase of the network link service:  READY:  network link service is ready; 
        ...
        Keyword Args:
            ...
            error_code (str): Error code if network link service is in a failed state. May be used for programmatic error checking. . [optional]  # noqa: E501
            error_message (str): Displayable error message if network link service is in a failed state. [optional]  # noqa: E501
        """
