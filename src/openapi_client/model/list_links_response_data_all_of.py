...
class ListLinksResponseDataAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, link_name, cluster_link_id, topic_names, *args, **kwargs):  # noqa: E501
        """ListLinksResponseDataAllOf - a model defined in OpenAPI
        ...
        self.cluster_link_id = cluster_link_id
    ...
    @convert_js_args_to_python_args
    def __init__(self, link_name, cluster_link_id, topic_names, *args, **kwargs):  # noqa: E501
        """ListLinksResponseDataAllOf - a model defined in OpenAPI
