...
def lazy_import():
    ...
    globals()['ListLinksResponseData'] = ListLinksResponseData
    globals()['ListLinksResponseDataListAllOf'] = ListLinksResponseDataListAllOf
    globals()['ResourceCollection'] = ResourceCollection
    globals()['ResourceCollectionMetadata'] = ResourceCollectionMetadata


class ListLinksResponseDataList(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'data': ([ListLinksResponseData],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ListLinksResponseDataList - a model defined in OpenAPI

        Keyword Args:
            kind (str):
            metadata (ResourceCollectionMetadata):
            data ([ListLinksResponseData]):
