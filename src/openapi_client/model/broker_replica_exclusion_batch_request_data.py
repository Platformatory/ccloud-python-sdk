...
def lazy_import():
    ...
    globals()['BrokerReplicaExclusionRequestData'] = BrokerReplicaExclusionRequestData


class BrokerReplicaExclusionBatchRequestData(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([BrokerReplicaExclusionRequestData],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """BrokerReplicaExclusionBatchRequestData - a model defined in OpenAPI

        Args:
            data ([BrokerReplicaExclusionRequestData]):
