...
class NetworkingV1PeeringList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """NetworkingV1PeeringList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. defaults to "PeeringList", must be one of ["PeeringList", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "PeeringList")
