...
class CdxV1ConnectionTypes(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """CdxV1ConnectionTypes - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([str]): The network connection types of the provider shared cluster. If the shared cluster is on public internet, then the list will be empty .  # noqa: E501

        Keyword Args:
            value ([str]): The network connection types of the provider shared cluster. If the shared cluster is on public internet, then the list will be empty .  # noqa: E501
