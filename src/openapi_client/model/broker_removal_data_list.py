...
def lazy_import():
    ...
    globals()['BrokerRemovalData'] = BrokerRemovalData
    globals()['BrokerRemovalDataListAllOf'] = BrokerRemovalDataListAllOf
    globals()['ResourceCollection'] = ResourceCollection
    globals()['ResourceCollectionMetadata'] = ResourceCollectionMetadata


class BrokerRemovalDataList(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'data': ([BrokerRemovalData],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """BrokerRemovalDataList - a model defined in OpenAPI

        Keyword Args:
            kind (str):
            metadata (ResourceCollectionMetadata):
            data ([BrokerRemovalData]):
