...
class IamV2ServiceAccountList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """IamV2ServiceAccountList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. defaults to "ServiceAccountList", must be one of ["ServiceAccountList", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "ServiceAccountList")
