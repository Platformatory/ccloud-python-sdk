...
class NetworkingV1GcpNetwork(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'private_service_connect_service_attachments': ({str: (str,)},),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'vpc_network': 'vpc_network',  # noqa: E501
        'private_service_connect_service_attachments': 'private_service_connect_service_attachments',  # noqa: E501
    }

    read_only_vars = {
        'project',  # noqa: E501
        'vpc_network',  # noqa: E501
        'private_service_connect_service_attachments',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, project, vpc_network, *args, **kwargs):  # noqa: E501
        """NetworkingV1GcpNetwork - a model defined in OpenAPI

        Args:
            project (str): The GCP Project ID associated with the Confluent Cloud VPC.
            vpc_network (str): The network name of the Confluent Cloud VPC.

        Keyword Args:
            kind (str): Network kind type.. defaults to "GcpNetwork", must be one of ["GcpNetwork", ]  # noqa: E501
