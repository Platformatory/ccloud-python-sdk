...
class IamV2IdentityProviderList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """IamV2IdentityProviderList - a model defined in OpenAPI
        ...
        Keyword Args:
            api_version (str): APIVersion defines the schema version of this representation of a resource.. defaults to "iam/v2", must be one of ["iam/v2", ]  # noqa: E501
            kind (str): Kind defines the object this REST resource represents.. defaults to "IdentityProviderList", must be one of ["IdentityProviderList", ]  # noqa: E501
        ...
        api_version = kwargs.get('api_version', "iam/v2")
        kind = kwargs.get('kind', "IdentityProviderList")
