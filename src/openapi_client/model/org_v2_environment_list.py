...
class OrgV2EnvironmentList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """OrgV2EnvironmentList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. defaults to "EnvironmentList", must be one of ["EnvironmentList", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "EnvironmentList")
