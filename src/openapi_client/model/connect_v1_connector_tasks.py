...
class ConnectV1ConnectorTasks(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, connector, task, *args, **kwargs):  # noqa: E501
        """ConnectV1ConnectorTasks - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, connector, task, *args, **kwargs):  # noqa: E501
        """ConnectV1ConnectorTasks - a model defined in OpenAPI
