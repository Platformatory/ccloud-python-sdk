...
class CdxV1ProviderSharedResourceList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """CdxV1ProviderSharedResourceList - a model defined in OpenAPI
        ...
        Keyword Args:
            api_version (str): APIVersion defines the schema version of this representation of a resource.. defaults to "cdx/v1", must be one of ["cdx/v1", ]  # noqa: E501
            kind (str): Kind defines the object this REST resource represents.. defaults to "ProviderSharedResourceList", must be one of ["ProviderSharedResourceList", ]  # noqa: E501
        ...
        api_version = kwargs.get('api_version', "cdx/v1")
        kind = kwargs.get('kind', "ProviderSharedResourceList")
