...
class NotificationsV1NotificationTypeList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """NotificationsV1NotificationTypeList - a model defined in OpenAPI
        ...
        Keyword Args:
            api_version (str): APIVersion defines the schema version of this representation of a resource.. defaults to "notifications/v1", must be one of ["notifications/v1", ]  # noqa: E501
            kind (str): Kind defines the object this REST resource represents.. defaults to "NotificationTypeList", must be one of ["NotificationTypeList", ]  # noqa: E501
        ...
        api_version = kwargs.get('api_version', "notifications/v1")
        kind = kwargs.get('kind', "NotificationTypeList")
