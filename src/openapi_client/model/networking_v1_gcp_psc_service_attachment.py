...
class NetworkingV1GcpPscServiceAttachment(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, zone, private_service_connect_service_attachment, *args, **kwargs):  # noqa: E501
        """NetworkingV1GcpPscServiceAttachment - a model defined in OpenAPI

        Args:
            zone (str): Zone associated with the PSC Service attachment.
            private_service_connect_service_attachment (str): Id of a Private Service Connect Service Attachment in Confluent Cloud.
