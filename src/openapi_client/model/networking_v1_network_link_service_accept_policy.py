...
class NetworkingV1NetworkLinkServiceAcceptPolicy(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NetworkingV1NetworkLinkServiceAcceptPolicy - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            environments ([str]): List of environments from which connections can be accepted. All networks win the list of environment will be allowed. . [optional]  # noqa: E501
            networks ([str]): List of networks from which connections can be accepted. . [optional]  # noqa: E501
        """
