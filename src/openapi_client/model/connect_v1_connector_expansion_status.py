...
def lazy_import():
    ...
    globals()['ConnectV1ConnectorExpansionStatusConnector'] = ConnectV1ConnectorExpansionStatusConnector
    globals()['InlineResponse2001Tasks'] = InlineResponse2001Tasks


class ConnectV1ConnectorExpansionStatus(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'name': (str,),  # noqa: E501
            'type': (str,),  # noqa: E501
            'connector': (ConnectV1ConnectorExpansionStatusConnector,),  # noqa: E501
            'tasks': ([InlineResponse2001Tasks],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, type, connector, *args, **kwargs):  # noqa: E501
        """ConnectV1ConnectorExpansionStatus - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            tasks ([InlineResponse2001Tasks]): A map containing the task status.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, type, connector, *args, **kwargs):  # noqa: E501
        """ConnectV1ConnectorExpansionStatus - a model defined in OpenAPI
