...
class MirrorTopicStatus(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """MirrorTopicStatus - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str):, must be one of ["ACTIVE", "FAILED", "LINK_FAILED", "LINK_PAUSED", "PAUSED", "PENDING_STOPPED", "SOURCE_UNAVAILABLE", "STOPPED", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["ACTIVE", "FAILED", "LINK_FAILED", "LINK_PAUSED", "PAUSED", "PENDING_STOPPED", "SOURCE_UNAVAILABLE", "STOPPED", ]  # noqa: E501
