...
class CmkV2ClusterStatus(ModelNormal):
    ...
    def _from_openapi_data(cls, phase, *args, **kwargs):  # noqa: E501
        """CmkV2ClusterStatus - a model defined in OpenAPI

        Args:
            phase (str): The lifecyle phase of the cluster:   PROVISIONED:  cluster is provisioned;   PROVISIONING:  cluster provisioning is in progress;   FAILED:  provisioning failed 
        ...
        Keyword Args:
            ...
            cku (bool, date, datetime, dict, float, int, list, str, none_type): The number of Confluent Kafka Units (CKUs) the Dedicated cluster currently has. . [optional]  # noqa: E501
        """
