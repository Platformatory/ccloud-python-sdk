...
class IamV2IpGroupList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """IamV2IpGroupList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. defaults to "IpGroupList", must be one of ["IpGroupList", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "IpGroupList")
