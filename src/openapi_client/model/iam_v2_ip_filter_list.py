...
class IamV2IpFilterList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """IamV2IpFilterList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            kind (str): Kind defines the object this REST resource represents.. defaults to "IpFilterList", must be one of ["IpFilterList", ]  # noqa: E501
        ...
        kind = kwargs.get('kind', "IpFilterList")
