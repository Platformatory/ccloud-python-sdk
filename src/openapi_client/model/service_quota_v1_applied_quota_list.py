...
class ServiceQuotaV1AppliedQuotaList(ModelNormal):
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """ServiceQuotaV1AppliedQuotaList - a model defined in OpenAPI
        ...
        Keyword Args:
            api_version (str): APIVersion defines the schema version of this representation of a resource.. defaults to "service-quota/v1", must be one of ["service-quota/v1", ]  # noqa: E501
            kind (str): Kind defines the object this REST resource represents.. defaults to "AppliedQuotaList", must be one of ["AppliedQuotaList", ]  # noqa: E501
        ...
        api_version = kwargs.get('api_version', "service-quota/v1")
        kind = kwargs.get('kind', "AppliedQuotaList")
