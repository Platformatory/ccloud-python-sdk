...
class AppliedQuotasServiceQuotaV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_service_quota_v1_applied_quota_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/service-quota/v1/applied-quotas/{id}',
                'operation_id': 'get_service_quota_v1_applied_quota',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_service_quota_v1_applied_quotas_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/service-quota/v1/applied-quotas',
                'operation_id': 'list_service_quota_v1_applied_quotas',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_service_quota_v1_applied_quota(
        self,
        id,
        **kwargs
    ):
        ...
        >>> thread = api.get_service_quota_v1_applied_quota(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.get_service_quota_v1_applied_quota_endpoint.call_with_http_info(**kwargs)

    def list_service_quota_v1_applied_quotas(
        self,
        scope,
        **kwargs
    ):
        ...
        >>> thread = api.list_service_quota_v1_applied_quotas(scope, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['scope'] = \
            scope
        return self.list_service_quota_v1_applied_quotas_endpoint.call_with_http_info(**kwargs)
