...
class LifecycleConnectV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.pause_connectv1_connector_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/connect/v1/environments/{environment_id}/clusters/{kafka_cluster_id}/connectors/{connector_name}/pause',
                'operation_id': 'pause_connectv1_connector',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
        ...
        self.resume_connectv1_connector_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/connect/v1/environments/{environment_id}/clusters/{kafka_cluster_id}/connectors/{connector_name}/resume',
                'operation_id': 'resume_connectv1_connector',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
    ...
    def pause_connectv1_connector(
        ...
        **kwargs
        ...
        kwargs['kafka_cluster_id'] = \
            kafka_cluster_id
        return self.pause_connectv1_connector_endpoint.call_with_http_info(**kwargs)

    def resume_connectv1_connector(
        self,
        connector_name,
        environment_id,
        kafka_cluster_id,
        **kwargs
        ...
        kwargs['kafka_cluster_id'] = \
            kafka_cluster_id
        return self.resume_connectv1_connector_endpoint.call_with_http_info(**kwargs)
