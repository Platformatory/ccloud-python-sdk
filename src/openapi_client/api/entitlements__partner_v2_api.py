...
class EntitlementsPartnerV2Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_partner_v2_entitlement_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'oauth'
                ],
                'endpoint_path': '/partner/v2/entitlements',
                'operation_id': 'create_partner_v2_entitlement',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.get_partner_v2_entitlement_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'oauth'
                ],
                'endpoint_path': '/partner/v2/entitlements/{id}',
                'operation_id': 'get_partner_v2_entitlement',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_partner_v2_entitlements_endpoint = _Endpoint(
            settings={
                'response_type': (PartnerV2EntitlementList,),
                'auth': [
                    'oauth'
                ],
                'endpoint_path': '/partner/v2/entitlements',
                'operation_id': 'list_partner_v2_entitlements',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def create_partner_v2_entitlement(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.create_partner_v2_entitlement(async_req=True)
        >>> result = thread.get()
        ...
        return self.create_partner_v2_entitlement_endpoint.call_with_http_info(**kwargs)

    def get_partner_v2_entitlement(
        self,
        id,
        **kwargs
    ):
        ...
        >>> thread = api.get_partner_v2_entitlement(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.get_partner_v2_entitlement_endpoint.call_with_http_info(**kwargs)

    def list_partner_v2_entitlements(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.list_partner_v2_entitlements(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_partner_v2_entitlements_endpoint.call_with_http_info(**kwargs)
