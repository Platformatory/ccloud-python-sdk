...
class SubscriptionsNotificationsV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_notifications_v1_subscription_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key'
                ],
                'endpoint_path': '/notifications/v1/subscriptions',
                'operation_id': 'create_notifications_v1_subscription',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_notifications_v1_subscription_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'api-key'
                ],
                'endpoint_path': '/notifications/v1/subscriptions/{id}',
                'operation_id': 'delete_notifications_v1_subscription',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_notifications_v1_subscription_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key'
                ...
                'endpoint_path': '/notifications/v1/subscriptions/{id}',
                'operation_id': 'get_notifications_v1_subscription',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_notifications_v1_subscriptions_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key'
                ...
                'endpoint_path': '/notifications/v1/subscriptions',
                'operation_id': 'list_notifications_v1_subscriptions',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.update_notifications_v1_subscription_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key'
                ...
                'endpoint_path': '/notifications/v1/subscriptions/{id}',
                'operation_id': 'update_notifications_v1_subscription',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'id': 'path',
                    'notifications_v1_subscription_update': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def create_notifications_v1_subscription(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.create_notifications_v1_subscription(async_req=True)
        >>> result = thread.get()
        ...
        return self.create_notifications_v1_subscription_endpoint.call_with_http_info(**kwargs)

    def delete_notifications_v1_subscription(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.delete_notifications_v1_subscription_endpoint.call_with_http_info(**kwargs)

    def get_notifications_v1_subscription(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.get_notifications_v1_subscription_endpoint.call_with_http_info(**kwargs)

    def list_notifications_v1_subscriptions(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.list_notifications_v1_subscriptions(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_notifications_v1_subscriptions_endpoint.call_with_http_info(**kwargs)

    def update_notifications_v1_subscription(
        self,
        id,
        **kwargs
    ):
        ...
        >>> thread = api.update_notifications_v1_subscription(id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            notifications_v1_subscription_update (NotificationsV1SubscriptionUpdate): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['id'] = \
            id
        return self.update_notifications_v1_subscription_endpoint.call_with_http_info(**kwargs)
