...
class OrganizationsPartnerV2Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_partner_v2_organization_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'oauth'
                ],
                'endpoint_path': '/partner/v2/organizations/{id}',
                'operation_id': 'get_partner_v2_organization',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_partner_v2_organizations_endpoint = _Endpoint(
            settings={
                'response_type': (PartnerV2OrganizationList,),
                'auth': [
                    'oauth'
                ],
                'endpoint_path': '/partner/v2/organizations',
                'operation_id': 'list_partner_v2_organizations',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_partner_v2_organization(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.get_partner_v2_organization_endpoint.call_with_http_info(**kwargs)
    ...
    def list_partner_v2_organizations(
        ...
        **kwargs
        ...
        >>> thread = api.list_partner_v2_organizations(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_partner_v2_organizations_endpoint.call_with_http_info(**kwargs)
