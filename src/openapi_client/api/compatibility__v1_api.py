...
class CompatibilityV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.test_compatibility_by_subject_name_endpoint = _Endpoint(
            settings={
                'response_type': (CompatibilityCheckResponse,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/compatibility/subjects/{subject}/versions/{version}',
                'operation_id': 'test_compatibility_by_subject_name',
                'http_method': 'POST',
                'servers': [
                    {
        ...
        self.test_compatibility_for_subject_endpoint = _Endpoint(
            settings={
                'response_type': (CompatibilityCheckResponse,),
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/compatibility/subjects/{subject}/versions',
                'operation_id': 'test_compatibility_for_subject',
                'http_method': 'POST',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
    ...
    def test_compatibility_by_subject_name(
        ...
        **kwargs
        ...
        >>> thread = api.test_compatibility_by_subject_name(subject, version, register_schema_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['register_schema_request'] = \
            register_schema_request
        return self.test_compatibility_by_subject_name_endpoint.call_with_http_info(**kwargs)

    def test_compatibility_for_subject(
        self,
        subject,
        register_schema_request,
        **kwargs
        ...
        >>> thread = api.test_compatibility_for_subject(subject, register_schema_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['register_schema_request'] = \
            register_schema_request
        return self.test_compatibility_for_subject_endpoint.call_with_http_info(**kwargs)
