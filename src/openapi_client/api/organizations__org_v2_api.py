...
class OrganizationsOrgV2Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_org_v2_organization_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/org/v2/organizations/{id}',
                'operation_id': 'get_org_v2_organization',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_org_v2_organizations_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/org/v2/organizations',
                'operation_id': 'list_org_v2_organizations',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.update_org_v2_organization_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/org/v2/organizations/{id}',
                'operation_id': 'update_org_v2_organization',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def get_org_v2_organization(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.get_org_v2_organization_endpoint.call_with_http_info(**kwargs)

    def list_org_v2_organizations(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.list_org_v2_organizations(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_org_v2_organizations_endpoint.call_with_http_info(**kwargs)

    def update_org_v2_organization(
        self,
        id,
        **kwargs
    ):
        ...
        >>> thread = api.update_org_v2_organization(id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            org_v2_organization (OrgV2Organization): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['id'] = \
            id
        return self.update_org_v2_organization_endpoint.call_with_http_info(**kwargs)
