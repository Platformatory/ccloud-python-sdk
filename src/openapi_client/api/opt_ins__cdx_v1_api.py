...
class OptInsCdxV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_cdx_v1_opt_in_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key'
                ],
                'endpoint_path': '/cdx/v1/opt-in',
                'operation_id': 'get_cdx_v1_opt_in',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.update_cdx_v1_opt_in_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key'
                ...
                'endpoint_path': '/cdx/v1/opt-in',
                'operation_id': 'update_cdx_v1_opt_in',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def get_cdx_v1_opt_in(
        ...
        **kwargs
        ...
        return self.get_cdx_v1_opt_in_endpoint.call_with_http_info(**kwargs)

    def update_cdx_v1_opt_in(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.update_cdx_v1_opt_in(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            cdx_v1_opt_in (CdxV1OptIn): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.update_cdx_v1_opt_in_endpoint.call_with_http_info(**kwargs)
