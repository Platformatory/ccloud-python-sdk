...
class TopicV3Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_kafka_topic_endpoint = _Endpoint(
            settings={
                'response_type': (TopicData,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/topics',
            ...
            root_map={
                ...
                'location_map': {
                    'cluster_id': 'path',
                    'create_topic_request_data': 'body',
                },
        ...
        self.delete_kafka_topic_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/topics/{topic_name}',
        ...
        self.get_kafka_topic_endpoint = _Endpoint(
            settings={
                'response_type': (TopicData,),
                'auth': [
                    'external-access-token',
            ...
            root_map={
                ...
                'location_map': {
                    'cluster_id': 'path',
                    'topic_name': 'path',
                    'include_authorized_operations': 'query',
                },
                'collection_format_map': {
                }
            },
        ...
        self.list_kafka_topics_endpoint = _Endpoint(
            settings={
                'response_type': (TopicDataList,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/topics',
                'operation_id': 'list_kafka_topics',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
        ...
        self.update_partition_count_kafka_topic_endpoint = _Endpoint(
            settings={
                'response_type': (TopicData,),
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/topics/{topic_name}',
                'operation_id': 'update_partition_count_kafka_topic',
                'http_method': 'PATCH',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
            ...
            root_map={
                ...
                'location_map': {
                    'cluster_id': 'path',
                    'topic_name': 'path',
                    'update_partition_count_request_data': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def create_kafka_topic(
        ...
        **kwargs
        ...
        >>> thread = api.create_kafka_topic(cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            create_topic_request_data (CreateTopicRequestData): The topic creation request. Note that Confluent Cloud allows only specific replication factor values. Because of that the replication factor field should either be omitted or it should use one of the allowed values (see https://docs.confluent.io/cloud/current/client-apps/optimizing/durability.html).. [optional]
        ...
        kwargs['cluster_id'] = \
            cluster_id
        return self.create_kafka_topic_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_kafka_topic(
        ...
        **kwargs
        ...
        kwargs['topic_name'] = \
            topic_name
        return self.delete_kafka_topic_endpoint.call_with_http_info(**kwargs)
    ...
    def get_kafka_topic(
        ...
        **kwargs
        ...
        >>> thread = api.get_kafka_topic(cluster_id, topic_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['topic_name'] = \
            topic_name
        return self.get_kafka_topic_endpoint.call_with_http_info(**kwargs)
    ...
    def list_kafka_topics(
        ...
        **kwargs
        ...
        kwargs['cluster_id'] = \
            cluster_id
        return self.list_kafka_topics_endpoint.call_with_http_info(**kwargs)

    def update_partition_count_kafka_topic(
        self,
        cluster_id,
        topic_name,
        **kwargs
        ...
        >>> thread = api.update_partition_count_kafka_topic(cluster_id, topic_name, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            update_partition_count_request_data (UpdatePartitionCountRequestData): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['topic_name'] = \
            topic_name
        return self.update_partition_count_kafka_topic_endpoint.call_with_http_info(**kwargs)
