...
class TypesV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_business_metadata_defs_endpoint = _Endpoint(
            settings={
                'response_type': ([BusinessMetadataDefResponse],),
                'auth': [],
                'endpoint_path': '/catalog/v1/types/businessmetadatadefs',
                'operation_id': 'create_business_metadata_defs',
                'http_method': 'POST',
                'servers': [
                    {
        ...
        self.create_tag_defs_endpoint = _Endpoint(
            settings={
                'response_type': ([TagDefResponse],),
                'auth': [],
                'endpoint_path': '/catalog/v1/types/tagdefs',
                'operation_id': 'create_tag_defs',
                'http_method': 'POST',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.delete_business_metadata_def_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
                'endpoint_path': '/catalog/v1/types/businessmetadatadefs/{bmName}',
                'operation_id': 'delete_business_metadata_def',
                'http_method': 'DELETE',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.delete_tag_def_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
                'endpoint_path': '/catalog/v1/types/tagdefs/{tagName}',
                'operation_id': 'delete_tag_def',
                'http_method': 'DELETE',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.get_all_business_metadata_defs_endpoint = _Endpoint(
            settings={
                'response_type': ([BusinessMetadataDefResponse],),
                'auth': [],
                'endpoint_path': '/catalog/v1/types/businessmetadatadefs',
                'operation_id': 'get_all_business_metadata_defs',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.get_all_tag_defs_endpoint = _Endpoint(
            settings={
                'response_type': ([TagDefResponse],),
                'auth': [],
                'endpoint_path': '/catalog/v1/types/tagdefs',
                'operation_id': 'get_all_tag_defs',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.get_business_metadata_def_by_name_endpoint = _Endpoint(
            settings={
                'response_type': (BusinessMetadataDef,),
                'auth': [],
                'endpoint_path': '/catalog/v1/types/businessmetadatadefs/{bmName}',
                'operation_id': 'get_business_metadata_def_by_name',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.get_tag_def_by_name_endpoint = _Endpoint(
            settings={
                'response_type': (TagDef,),
                'auth': [],
                'endpoint_path': '/catalog/v1/types/tagdefs/{tagName}',
                'operation_id': 'get_tag_def_by_name',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.update_business_metadata_defs_endpoint = _Endpoint(
            settings={
                'response_type': ([BusinessMetadataDefResponse],),
                'auth': [],
                'endpoint_path': '/catalog/v1/types/businessmetadatadefs',
                'operation_id': 'update_business_metadata_defs',
                'http_method': 'PUT',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.update_tag_defs_endpoint = _Endpoint(
            settings={
                'response_type': ([TagDefResponse],),
                'auth': [],
                'endpoint_path': '/catalog/v1/types/tagdefs',
                'operation_id': 'update_tag_defs',
                'http_method': 'PUT',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
    ...
    def create_business_metadata_defs(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.create_business_metadata_defs(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            business_metadata_def ([BusinessMetadataDef]): The business metadata definitions to create. [optional]
        ...
        return self.create_business_metadata_defs_endpoint.call_with_http_info(**kwargs)
    ...
    def create_tag_defs(
        ...
        **kwargs
        ...
        >>> thread = api.create_tag_defs(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            tag_def ([TagDef]): The tag definitions to create. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.create_tag_defs_endpoint.call_with_http_info(**kwargs)

    def delete_business_metadata_def(
        self,
        bm_name,
        **kwargs
    ):
        ...
        kwargs['bm_name'] = \
            bm_name
        return self.delete_business_metadata_def_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_tag_def(
        ...
        **kwargs
        ...
        kwargs['tag_name'] = \
            tag_name
        return self.delete_tag_def_endpoint.call_with_http_info(**kwargs)

    def get_all_business_metadata_defs(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.get_all_business_metadata_defs(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.get_all_business_metadata_defs_endpoint.call_with_http_info(**kwargs)

    def get_all_tag_defs(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.get_all_tag_defs(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.get_all_tag_defs_endpoint.call_with_http_info(**kwargs)
    ...
    def get_business_metadata_def_by_name(
        ...
        **kwargs
        ...
        kwargs['bm_name'] = \
            bm_name
        return self.get_business_metadata_def_by_name_endpoint.call_with_http_info(**kwargs)

    def get_tag_def_by_name(
        self,
        tag_name,
        **kwargs
    ):
        ...
        kwargs['tag_name'] = \
            tag_name
        return self.get_tag_def_by_name_endpoint.call_with_http_info(**kwargs)

    def update_business_metadata_defs(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.update_business_metadata_defs(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            business_metadata_def ([BusinessMetadataDef]): The business metadata definitions to update. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.update_business_metadata_defs_endpoint.call_with_http_info(**kwargs)
    ...
    def update_tag_defs(
        ...
        **kwargs
        ...
        >>> thread = api.update_tag_defs(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            tag_def ([TagDef]): The tag definitions to update. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.update_tag_defs_endpoint.call_with_http_info(**kwargs)
