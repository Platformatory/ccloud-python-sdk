...
class ExportersV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_exporter_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                ...
                'endpoint_path': '/exporters/{name}',
                'operation_id': 'delete_exporter',
                'http_method': 'DELETE',
                'servers': [
                    {
        ...
        self.get_exporter_config_by_name_endpoint = _Endpoint(
            settings={
                'response_type': (ExporterConfigResponse,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/exporters/{name}/config',
                'operation_id': 'get_exporter_config_by_name',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.get_exporter_info_by_name_endpoint = _Endpoint(
            settings={
                'response_type': (ExporterReference,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/exporters/{name}',
                'operation_id': 'get_exporter_info_by_name',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.get_exporter_status_by_name_endpoint = _Endpoint(
            settings={
                'response_type': (ExporterStatusResponse,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/exporters/{name}/status',
                'operation_id': 'get_exporter_status_by_name',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.list_exporters_endpoint = _Endpoint(
            settings={
                'response_type': ([str],),
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/exporters',
                'operation_id': 'list_exporters',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.pause_exporter_by_name_endpoint = _Endpoint(
            settings={
                'response_type': (ExporterResponse,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/exporters/{name}/pause',
                'operation_id': 'pause_exporter_by_name',
                'http_method': 'PUT',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.register_exporter_endpoint = _Endpoint(
            settings={
                'response_type': (ExporterResponse,),
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/exporters',
                'operation_id': 'register_exporter',
                'http_method': 'POST',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.reset_exporter_by_name_endpoint = _Endpoint(
            settings={
                'response_type': (ExporterResponse,),
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/exporters/{name}/reset',
                'operation_id': 'reset_exporter_by_name',
                'http_method': 'PUT',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.resume_exporter_by_name_endpoint = _Endpoint(
            settings={
                'response_type': (ExporterResponse,),
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/exporters/{name}/resume',
                'operation_id': 'resume_exporter_by_name',
                'http_method': 'PUT',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.update_exporter_config_by_name_endpoint = _Endpoint(
            settings={
                'response_type': (ExporterResponse,),
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/exporters/{name}/config',
                'operation_id': 'update_exporter_config_by_name',
                'http_method': 'PUT',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.update_exporter_info_endpoint = _Endpoint(
            settings={
                'response_type': (ExporterResponse,),
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/exporters/{name}',
                'operation_id': 'update_exporter_info',
                'http_method': 'PUT',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
    ...
    def delete_exporter(
        ...
        **kwargs
        ...
        kwargs['name'] = \
            name
        return self.delete_exporter_endpoint.call_with_http_info(**kwargs)

    def get_exporter_config_by_name(
        self,
        name,
        **kwargs
    ):
        ...
        kwargs['name'] = \
            name
        return self.get_exporter_config_by_name_endpoint.call_with_http_info(**kwargs)

    def get_exporter_info_by_name(
        self,
        name,
        **kwargs
    ):
        ...
        kwargs['name'] = \
            name
        return self.get_exporter_info_by_name_endpoint.call_with_http_info(**kwargs)

    def get_exporter_status_by_name(
        self,
        name,
        **kwargs
    ):
        ...
        kwargs['name'] = \
            name
        return self.get_exporter_status_by_name_endpoint.call_with_http_info(**kwargs)
    ...
    def list_exporters(
        ...
        **kwargs
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_exporters_endpoint.call_with_http_info(**kwargs)

    def pause_exporter_by_name(
        self,
        name,
        **kwargs
    ):
        ...
        kwargs['name'] = \
            name
        return self.pause_exporter_by_name_endpoint.call_with_http_info(**kwargs)
    ...
    def register_exporter(
        ...
        **kwargs
        ...
        Args:
            exporter_reference (ExporterReference): Schema
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['exporter_reference'] = \
            exporter_reference
        return self.register_exporter_endpoint.call_with_http_info(**kwargs)

    def reset_exporter_by_name(
        self,
        name,
        **kwargs
    ):
        ...
        kwargs['name'] = \
            name
        return self.reset_exporter_by_name_endpoint.call_with_http_info(**kwargs)

    def resume_exporter_by_name(
        self,
        name,
        **kwargs
    ):
        ...
        kwargs['name'] = \
            name
        return self.resume_exporter_by_name_endpoint.call_with_http_info(**kwargs)

    def update_exporter_config_by_name(
        self,
        name,
        exporter_config_response,
        **kwargs
        ...
        Args:
            name (str): Name of the exporter
            exporter_config_response (ExporterConfigResponse): Exporter Update Request
        ...
        kwargs['name'] = \
            name
        kwargs['exporter_config_response'] = \
            exporter_config_response
        return self.update_exporter_config_by_name_endpoint.call_with_http_info(**kwargs)
    ...
    def update_exporter_info(
        ...
        **kwargs
        ...
        Args:
            name (str): Name of the exporter
            exporter_update_request (ExporterUpdateRequest): Exporter Update Request
        ...
        kwargs['name'] = \
            name
        kwargs['exporter_update_request'] = \
            exporter_update_request
        return self.update_exporter_info_endpoint.call_with_http_info(**kwargs)
