...
class InvitationsIamV2Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_iam_v2_invitation_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/iam/v2/invitations',
                'operation_id': 'create_iam_v2_invitation',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_iam_v2_invitation_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/iam/v2/invitations/{id}',
                'operation_id': 'delete_iam_v2_invitation',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_iam_v2_invitation_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/iam/v2/invitations/{id}',
                'operation_id': 'get_iam_v2_invitation',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_iam_v2_invitations_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/iam/v2/invitations',
                'operation_id': 'list_iam_v2_invitations',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def create_iam_v2_invitation(
        ...
        **kwargs
        ...
        >>> thread = api.create_iam_v2_invitation(async_req=True)
        >>> result = thread.get()
        ...
        return self.create_iam_v2_invitation_endpoint.call_with_http_info(**kwargs)

    def delete_iam_v2_invitation(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.delete_iam_v2_invitation_endpoint.call_with_http_info(**kwargs)

    def get_iam_v2_invitation(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.get_iam_v2_invitation_endpoint.call_with_http_info(**kwargs)

    def list_iam_v2_invitations(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.list_iam_v2_invitations(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_iam_v2_invitations_endpoint.call_with_http_info(**kwargs)
