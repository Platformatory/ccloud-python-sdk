...
class RoleBindingsIamV2Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_iam_v2_role_binding_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/iam/v2/role-bindings',
                'operation_id': 'create_iam_v2_role_binding',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_iam_v2_role_binding_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key',
                ...
                'endpoint_path': '/iam/v2/role-bindings/{id}',
                'operation_id': 'delete_iam_v2_role_binding',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_iam_v2_role_binding_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key',
                ...
                'endpoint_path': '/iam/v2/role-bindings/{id}',
                'operation_id': 'get_iam_v2_role_binding',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_iam_v2_role_bindings_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key',
                ...
                'endpoint_path': '/iam/v2/role-bindings',
                'operation_id': 'list_iam_v2_role_bindings',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def create_iam_v2_role_binding(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.create_iam_v2_role_binding(async_req=True)
        >>> result = thread.get()
        ...
        return self.create_iam_v2_role_binding_endpoint.call_with_http_info(**kwargs)

    def delete_iam_v2_role_binding(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.delete_iam_v2_role_binding_endpoint.call_with_http_info(**kwargs)

    def get_iam_v2_role_binding(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.get_iam_v2_role_binding_endpoint.call_with_http_info(**kwargs)

    def list_iam_v2_role_bindings(
        self,
        crn_pattern,
        **kwargs
    ):
        ...
        >>> thread = api.list_iam_v2_role_bindings(crn_pattern, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['crn_pattern'] = \
            crn_pattern
        return self.list_iam_v2_role_bindings_endpoint.call_with_http_info(**kwargs)
