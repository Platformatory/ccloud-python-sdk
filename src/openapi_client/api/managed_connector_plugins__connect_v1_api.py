...
class ManagedConnectorPluginsConnectV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.list_connectv1_connector_plugins_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/connect/v1/environments/{environment_id}/clusters/{kafka_cluster_id}/connector-plugins',
                'operation_id': 'list_connectv1_connector_plugins',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.validate_connectv1_connector_plugin_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/connect/v1/environments/{environment_id}/clusters/{kafka_cluster_id}/connector-plugins/{plugin_name}/config/validate',
                'operation_id': 'validate_connectv1_connector_plugin',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
    ...
    def list_connectv1_connector_plugins(
        ...
        **kwargs
        ...
        kwargs['kafka_cluster_id'] = \
            kafka_cluster_id
        return self.list_connectv1_connector_plugins_endpoint.call_with_http_info(**kwargs)

    def validate_connectv1_connector_plugin(
        self,
        plugin_name,
        environment_id,
        kafka_cluster_id,
        **kwargs
        ...
        >>> thread = api.validate_connectv1_connector_plugin(plugin_name, environment_id, kafka_cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['kafka_cluster_id'] = \
            kafka_cluster_id
        return self.validate_connectv1_connector_plugin_endpoint.call_with_http_info(**kwargs)
