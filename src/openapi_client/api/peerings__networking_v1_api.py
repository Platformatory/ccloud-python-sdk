...
class PeeringsNetworkingV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_networking_v1_peering_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/networking/v1/peerings',
                'operation_id': 'create_networking_v1_peering',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_networking_v1_peering_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'api-key',
                ...
                'endpoint_path': '/networking/v1/peerings/{id}',
                'operation_id': 'delete_networking_v1_peering',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_networking_v1_peering_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key',
                ...
                'endpoint_path': '/networking/v1/peerings/{id}',
                'operation_id': 'get_networking_v1_peering',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_networking_v1_peerings_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key',
                ...
                'endpoint_path': '/networking/v1/peerings',
                'operation_id': 'list_networking_v1_peerings',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.update_networking_v1_peering_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key',
                ...
                'endpoint_path': '/networking/v1/peerings/{id}',
                'operation_id': 'update_networking_v1_peering',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def create_networking_v1_peering(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.create_networking_v1_peering(async_req=True)
        >>> result = thread.get()
        ...
        return self.create_networking_v1_peering_endpoint.call_with_http_info(**kwargs)

    def delete_networking_v1_peering(
        self,
        environment,
        id,
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.delete_networking_v1_peering_endpoint.call_with_http_info(**kwargs)

    def get_networking_v1_peering(
        self,
        environment,
        id,
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.get_networking_v1_peering_endpoint.call_with_http_info(**kwargs)
    ...
    def list_networking_v1_peerings(
        ...
        **kwargs
        ...
        >>> thread = api.list_networking_v1_peerings(environment, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment'] = \
            environment
        return self.list_networking_v1_peerings_endpoint.call_with_http_info(**kwargs)

    def update_networking_v1_peering(
        self,
        id,
        **kwargs
    ):
        ...
        >>> thread = api.update_networking_v1_peering(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.update_networking_v1_peering_endpoint.call_with_http_info(**kwargs)
