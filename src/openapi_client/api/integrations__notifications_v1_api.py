...
class IntegrationsNotificationsV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_notifications_v1_integration_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key'
                ],
                'endpoint_path': '/notifications/v1/integrations',
                'operation_id': 'create_notifications_v1_integration',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_notifications_v1_integration_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'api-key'
                ],
                'endpoint_path': '/notifications/v1/integrations/{id}',
                'operation_id': 'delete_notifications_v1_integration',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_notifications_v1_integration_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key'
                ...
                'endpoint_path': '/notifications/v1/integrations/{id}',
                'operation_id': 'get_notifications_v1_integration',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_notifications_v1_integrations_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key'
                ...
                'endpoint_path': '/notifications/v1/integrations',
                'operation_id': 'list_notifications_v1_integrations',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.test_notifications_v1_integration_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'api-key'
                ],
                'endpoint_path': '/notifications/v1/integrations:test',
                'operation_id': 'test_notifications_v1_integration',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.update_notifications_v1_integration_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key'
                ...
                'endpoint_path': '/notifications/v1/integrations/{id}',
                'operation_id': 'update_notifications_v1_integration',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'id': 'path',
                    'notifications_v1_integration': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def create_notifications_v1_integration(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.create_notifications_v1_integration(async_req=True)
        >>> result = thread.get()
        ...
        return self.create_notifications_v1_integration_endpoint.call_with_http_info(**kwargs)

    def delete_notifications_v1_integration(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.delete_notifications_v1_integration_endpoint.call_with_http_info(**kwargs)

    def get_notifications_v1_integration(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.get_notifications_v1_integration_endpoint.call_with_http_info(**kwargs)

    def list_notifications_v1_integrations(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.list_notifications_v1_integrations(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_notifications_v1_integrations_endpoint.call_with_http_info(**kwargs)

    def test_notifications_v1_integration(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.test_notifications_v1_integration(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.test_notifications_v1_integration_endpoint.call_with_http_info(**kwargs)

    def update_notifications_v1_integration(
        self,
        id,
        **kwargs
    ):
        ...
        >>> thread = api.update_notifications_v1_integration(id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            notifications_v1_integration (NotificationsV1Integration): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['id'] = \
            id
        return self.update_notifications_v1_integration_endpoint.call_with_http_info(**kwargs)
