...
class ConsumerGroupV3Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_kafka_consumer_endpoint = _Endpoint(
            settings={
                'response_type': (ConsumerData,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/consumer-groups/{consumer_group_id}/consumers/{consumer_id}',
                'operation_id': 'get_kafka_consumer',
                'http_method': 'GET',
                'servers': [
                    {
        ...
        self.get_kafka_consumer_group_endpoint = _Endpoint(
            settings={
                'response_type': (ConsumerGroupData,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/consumer-groups/{consumer_group_id}',
                'operation_id': 'get_kafka_consumer_group',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
        ...
        self.get_kafka_consumer_group_lag_summary_endpoint = _Endpoint(
            settings={
                'response_type': (ConsumerGroupLagSummaryData,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/consumer-groups/{consumer_group_id}/lag-summary',
                'operation_id': 'get_kafka_consumer_group_lag_summary',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
        ...
        self.get_kafka_consumer_lag_endpoint = _Endpoint(
            settings={
                'response_type': (ConsumerLagData,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/consumer-groups/{consumer_group_id}/lags/{topic_name}/partitions/{partition_id}',
                'operation_id': 'get_kafka_consumer_lag',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
        ...
        self.list_kafka_consumer_groups_endpoint = _Endpoint(
            settings={
                'response_type': (ConsumerGroupDataList,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/consumer-groups',
        ...
        self.list_kafka_consumer_lags_endpoint = _Endpoint(
            settings={
                'response_type': (ConsumerLagDataList,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/consumer-groups/{consumer_group_id}/lags',
                'operation_id': 'list_kafka_consumer_lags',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
        ...
        self.list_kafka_consumers_endpoint = _Endpoint(
            settings={
                'response_type': (ConsumerDataList,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/consumer-groups/{consumer_group_id}/consumers',
                'operation_id': 'list_kafka_consumers',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
    ...
    def get_kafka_consumer(
        ...
        **kwargs
        ...
        kwargs['consumer_id'] = \
            consumer_id
        return self.get_kafka_consumer_endpoint.call_with_http_info(**kwargs)
    ...
    def get_kafka_consumer_group(
        ...
        **kwargs
        ...
        kwargs['consumer_group_id'] = \
            consumer_group_id
        return self.get_kafka_consumer_group_endpoint.call_with_http_info(**kwargs)

    def get_kafka_consumer_group_lag_summary(
        self,
        cluster_id,
        consumer_group_id,
        **kwargs
        ...
        kwargs['consumer_group_id'] = \
            consumer_group_id
        return self.get_kafka_consumer_group_lag_summary_endpoint.call_with_http_info(**kwargs)
    ...
    def get_kafka_consumer_lag(
        ...
        **kwargs
        ...
        kwargs['partition_id'] = \
            partition_id
        return self.get_kafka_consumer_lag_endpoint.call_with_http_info(**kwargs)
    ...
    def list_kafka_consumer_groups(
        ...
        **kwargs
        ...
        kwargs['cluster_id'] = \
            cluster_id
        return self.list_kafka_consumer_groups_endpoint.call_with_http_info(**kwargs)

    def list_kafka_consumer_lags(
        self,
        cluster_id,
        consumer_group_id,
        **kwargs
        ...
        kwargs['consumer_group_id'] = \
            consumer_group_id
        return self.list_kafka_consumer_lags_endpoint.call_with_http_info(**kwargs)
    ...
    def list_kafka_consumers(
        ...
        **kwargs
        ...
        kwargs['consumer_group_id'] = \
            consumer_group_id
        return self.list_kafka_consumers_endpoint.call_with_http_info(**kwargs)
