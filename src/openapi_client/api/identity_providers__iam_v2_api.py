...
class IdentityProvidersIamV2Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_iam_v2_identity_provider_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/iam/v2/identity-providers',
                'operation_id': 'create_iam_v2_identity_provider',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_iam_v2_identity_provider_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'api-key',
                ...
                'endpoint_path': '/iam/v2/identity-providers/{id}',
                'operation_id': 'delete_iam_v2_identity_provider',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_iam_v2_identity_provider_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key',
                ...
                'endpoint_path': '/iam/v2/identity-providers/{id}',
                'operation_id': 'get_iam_v2_identity_provider',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_iam_v2_identity_providers_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key',
                ...
                'endpoint_path': '/iam/v2/identity-providers',
                'operation_id': 'list_iam_v2_identity_providers',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.update_iam_v2_identity_provider_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key',
                ...
                'endpoint_path': '/iam/v2/identity-providers/{id}',
                'operation_id': 'update_iam_v2_identity_provider',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'id': 'path',
                    'iam_v2_identity_provider_update': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def create_iam_v2_identity_provider(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.create_iam_v2_identity_provider(async_req=True)
        >>> result = thread.get()
        ...
        return self.create_iam_v2_identity_provider_endpoint.call_with_http_info(**kwargs)

    def delete_iam_v2_identity_provider(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.delete_iam_v2_identity_provider_endpoint.call_with_http_info(**kwargs)

    def get_iam_v2_identity_provider(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.get_iam_v2_identity_provider_endpoint.call_with_http_info(**kwargs)

    def list_iam_v2_identity_providers(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.list_iam_v2_identity_providers(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_iam_v2_identity_providers_endpoint.call_with_http_info(**kwargs)

    def update_iam_v2_identity_provider(
        self,
        id,
        **kwargs
    ):
        ...
        >>> thread = api.update_iam_v2_identity_provider(id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            iam_v2_identity_provider_update (IamV2IdentityProviderUpdate): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['id'] = \
            id
        return self.update_iam_v2_identity_provider_endpoint.call_with_http_info(**kwargs)
