...
class GroupMappingsIamV2SsoApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_iam_v2_sso_group_mapping_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/iam/v2/sso/group-mappings',
                'operation_id': 'create_iam_v2_sso_group_mapping',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_iam_v2_sso_group_mapping_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/iam/v2/sso/group-mappings/{id}',
                'operation_id': 'delete_iam_v2_sso_group_mapping',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_iam_v2_sso_group_mapping_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/iam/v2/sso/group-mappings/{id}',
                'operation_id': 'get_iam_v2_sso_group_mapping',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_iam_v2_sso_group_mappings_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/iam/v2/sso/group-mappings',
                'operation_id': 'list_iam_v2_sso_group_mappings',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.update_iam_v2_sso_group_mapping_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/iam/v2/sso/group-mappings/{id}',
                'operation_id': 'update_iam_v2_sso_group_mapping',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def create_iam_v2_sso_group_mapping(
        self,
        **kwargs
    ):
        """Create a Group Mapping  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to create a group mapping.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_iam_v2_sso_group_mapping(async_req=True)
        >>> result = thread.get()
        ...
        return self.create_iam_v2_sso_group_mapping_endpoint.call_with_http_info(**kwargs)

    def delete_iam_v2_sso_group_mapping(
        self,
        id,
        **kwargs
    ):
        ...
        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to delete a group mapping.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['id'] = \
            id
        return self.delete_iam_v2_sso_group_mapping_endpoint.call_with_http_info(**kwargs)

    def get_iam_v2_sso_group_mapping(
        self,
        id,
        **kwargs
    ):
        ...
        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to read a group mapping.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['id'] = \
            id
        return self.get_iam_v2_sso_group_mapping_endpoint.call_with_http_info(**kwargs)
    ...
    def list_iam_v2_sso_group_mappings(
        ...
        **kwargs
        ...
        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Retrieve a sorted, filtered, paginated list of all group mappings.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_iam_v2_sso_group_mappings(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_iam_v2_sso_group_mappings_endpoint.call_with_http_info(**kwargs)

    def update_iam_v2_sso_group_mapping(
        self,
        id,
        **kwargs
    ):
        ...
        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to update a group mapping.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_iam_v2_sso_group_mapping(id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            iam_v2_sso_group_mapping (IamV2SsoGroupMapping): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['id'] = \
            id
        return self.update_iam_v2_sso_group_mapping_endpoint.call_with_http_info(**kwargs)
