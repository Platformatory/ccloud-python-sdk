...
class UsersIamV2Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_iam_v2_user_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/iam/v2/users/{id}',
                'operation_id': 'delete_iam_v2_user',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_iam_v2_user_endpoint = _Endpoint(
            settings={
        ...
        self.list_iam_v2_users_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/iam/v2/users',
                'operation_id': 'list_iam_v2_users',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.update_iam_v2_user_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/iam/v2/users/{id}',
                'operation_id': 'update_iam_v2_user',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def delete_iam_v2_user(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.delete_iam_v2_user_endpoint.call_with_http_info(**kwargs)
    ...
    def get_iam_v2_user(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.get_iam_v2_user_endpoint.call_with_http_info(**kwargs)

    def list_iam_v2_users(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.list_iam_v2_users(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_iam_v2_users_endpoint.call_with_http_info(**kwargs)

    def update_iam_v2_user(
        self,
        id,
        **kwargs
    ):
        ...
        >>> thread = api.update_iam_v2_user(id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            iam_v2_user_update (IamV2UserUpdate): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['id'] = \
            id
        return self.update_iam_v2_user_endpoint.call_with_http_info(**kwargs)
