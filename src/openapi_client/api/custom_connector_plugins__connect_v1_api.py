...
class CustomConnectorPluginsConnectV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_connect_v1_custom_connector_plugin_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key'
                ],
                'endpoint_path': '/connect/v1/custom-connector-plugins',
                'operation_id': 'create_connect_v1_custom_connector_plugin',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_connect_v1_custom_connector_plugin_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cloud-api-key'
                ],
                'endpoint_path': '/connect/v1/custom-connector-plugins/{id}',
                'operation_id': 'delete_connect_v1_custom_connector_plugin',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_connect_v1_custom_connector_plugin_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key'
                ...
                'endpoint_path': '/connect/v1/custom-connector-plugins/{id}',
                'operation_id': 'get_connect_v1_custom_connector_plugin',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_connect_v1_custom_connector_plugins_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key'
                ...
                'endpoint_path': '/connect/v1/custom-connector-plugins',
                'operation_id': 'list_connect_v1_custom_connector_plugins',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.update_connect_v1_custom_connector_plugin_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key'
                ...
                'endpoint_path': '/connect/v1/custom-connector-plugins/{id}',
                'operation_id': 'update_connect_v1_custom_connector_plugin',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'id': 'path',
                    'connect_v1_custom_connector_plugin_update': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def create_connect_v1_custom_connector_plugin(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.create_connect_v1_custom_connector_plugin(async_req=True)
        >>> result = thread.get()
        ...
        return self.create_connect_v1_custom_connector_plugin_endpoint.call_with_http_info(**kwargs)

    def delete_connect_v1_custom_connector_plugin(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.delete_connect_v1_custom_connector_plugin_endpoint.call_with_http_info(**kwargs)

    def get_connect_v1_custom_connector_plugin(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.get_connect_v1_custom_connector_plugin_endpoint.call_with_http_info(**kwargs)

    def list_connect_v1_custom_connector_plugins(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.list_connect_v1_custom_connector_plugins(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_connect_v1_custom_connector_plugins_endpoint.call_with_http_info(**kwargs)

    def update_connect_v1_custom_connector_plugin(
        self,
        id,
        **kwargs
    ):
        ...
        >>> thread = api.update_connect_v1_custom_connector_plugin(id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            connect_v1_custom_connector_plugin_update (ConnectV1CustomConnectorPluginUpdate): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['id'] = \
            id
        return self.update_connect_v1_custom_connector_plugin_endpoint.call_with_http_info(**kwargs)
