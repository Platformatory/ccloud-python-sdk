...
class ServiceAccountsIamV2Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_iam_v2_service_account_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/iam/v2/service-accounts',
                'operation_id': 'create_iam_v2_service_account',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_iam_v2_service_account_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/iam/v2/service-accounts/{id}',
                'operation_id': 'delete_iam_v2_service_account',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_iam_v2_service_account_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/iam/v2/service-accounts/{id}',
                'operation_id': 'get_iam_v2_service_account',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_iam_v2_service_accounts_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/iam/v2/service-accounts',
                'operation_id': 'list_iam_v2_service_accounts',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.update_iam_v2_service_account_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/iam/v2/service-accounts/{id}',
                'operation_id': 'update_iam_v2_service_account',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'id': 'path',
                    'iam_v2_service_account_update': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def create_iam_v2_service_account(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.create_iam_v2_service_account(async_req=True)
        >>> result = thread.get()
        ...
        return self.create_iam_v2_service_account_endpoint.call_with_http_info(**kwargs)

    def delete_iam_v2_service_account(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.delete_iam_v2_service_account_endpoint.call_with_http_info(**kwargs)

    def get_iam_v2_service_account(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.get_iam_v2_service_account_endpoint.call_with_http_info(**kwargs)

    def list_iam_v2_service_accounts(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.list_iam_v2_service_accounts(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_iam_v2_service_accounts_endpoint.call_with_http_info(**kwargs)

    def update_iam_v2_service_account(
        self,
        id,
        **kwargs
    ):
        ...
        >>> thread = api.update_iam_v2_service_account(id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            iam_v2_service_account_update (IamV2ServiceAccountUpdate): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['id'] = \
            id
        return self.update_iam_v2_service_account_endpoint.call_with_http_info(**kwargs)
