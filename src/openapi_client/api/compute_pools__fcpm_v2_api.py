...
class ComputePoolsFcpmV2Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_fcpm_v2_compute_pool_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key'
                ],
                'endpoint_path': '/fcpm/v2/compute-pools',
                'operation_id': 'create_fcpm_v2_compute_pool',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_fcpm_v2_compute_pool_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cloud-api-key'
                ],
                'endpoint_path': '/fcpm/v2/compute-pools/{id}',
                'operation_id': 'delete_fcpm_v2_compute_pool',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_fcpm_v2_compute_pool_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key'
                ...
                'endpoint_path': '/fcpm/v2/compute-pools/{id}',
                'operation_id': 'get_fcpm_v2_compute_pool',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_fcpm_v2_compute_pools_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key'
                ...
                'endpoint_path': '/fcpm/v2/compute-pools',
                'operation_id': 'list_fcpm_v2_compute_pools',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.update_fcpm_v2_compute_pool_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key'
                ...
                'endpoint_path': '/fcpm/v2/compute-pools/{id}',
                'operation_id': 'update_fcpm_v2_compute_pool',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def create_fcpm_v2_compute_pool(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.create_fcpm_v2_compute_pool(async_req=True)
        >>> result = thread.get()
        ...
        return self.create_fcpm_v2_compute_pool_endpoint.call_with_http_info(**kwargs)

    def delete_fcpm_v2_compute_pool(
        self,
        environment,
        id,
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.delete_fcpm_v2_compute_pool_endpoint.call_with_http_info(**kwargs)

    def get_fcpm_v2_compute_pool(
        self,
        environment,
        id,
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.get_fcpm_v2_compute_pool_endpoint.call_with_http_info(**kwargs)

    def list_fcpm_v2_compute_pools(
        self,
        environment,
        **kwargs
    ):
        ...
        >>> thread = api.list_fcpm_v2_compute_pools(environment, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment'] = \
            environment
        return self.list_fcpm_v2_compute_pools_endpoint.call_with_http_info(**kwargs)

    def update_fcpm_v2_compute_pool(
        self,
        id,
        **kwargs
    ):
        ...
        >>> thread = api.update_fcpm_v2_compute_pool(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.update_fcpm_v2_compute_pool_endpoint.call_with_http_info(**kwargs)
