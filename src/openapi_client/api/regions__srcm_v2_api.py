...
class RegionsSrcmV2Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_srcm_v2_region_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key'
                ],
                'endpoint_path': '/srcm/v2/regions/{id}',
                'operation_id': 'get_srcm_v2_region',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_srcm_v2_regions_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key'
                ],
                'endpoint_path': '/srcm/v2/regions',
                'operation_id': 'list_srcm_v2_regions',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'spec_region_name': 'spec.region_name',
                    'spec_packages': 'spec.packages',
                    'page_size': 'page_size',
                    'page_token': 'page_token',
                },
                'location_map': {
                    'spec_cloud': 'query',
                    'spec_region_name': 'query',
                    'spec_packages': 'query',
                    'page_size': 'query',
                    'page_token': 'query',
                },
    ...
    def get_srcm_v2_region(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.get_srcm_v2_region_endpoint.call_with_http_info(**kwargs)

    def list_srcm_v2_regions(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.list_srcm_v2_regions(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_srcm_v2_regions_endpoint.call_with_http_info(**kwargs)
