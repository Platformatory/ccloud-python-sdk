...
class SearchV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.search_using_attribute_endpoint = _Endpoint(
            settings={
                'response_type': (SearchResult,),
                'auth': [],
                'endpoint_path': '/catalog/v1/search/attribute',
                'operation_id': 'search_using_attribute',
                'http_method': 'GET',
                'servers': [
                    {
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'attr': 'attr',
                    'attr_name': 'attrName',
                    'attr_value_prefix': 'attrValuePrefix',
                    'tag': 'tag',
                    'sort_by': 'sortBy',
        ...
        self.search_using_basic_endpoint = _Endpoint(
            settings={
                'response_type': (SearchResult,),
                'auth': [],
                'endpoint_path': '/catalog/v1/search/basic',
                'operation_id': 'search_using_basic',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
    ...
    def search_using_attribute(
        ...
        **kwargs
        ...
        >>> thread = api.search_using_attribute(async_req=True)
        >>> result = thread.get()
        ...
        return self.search_using_attribute_endpoint.call_with_http_info(**kwargs)

    def search_using_basic(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.search_using_basic(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.search_using_basic_endpoint.call_with_http_info(**kwargs)
