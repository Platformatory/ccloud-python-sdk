...
class NetworkLinkEndpointsNetworkingV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_networking_v1_network_link_endpoint_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/networking/v1/network-link-endpoints',
                'operation_id': 'create_networking_v1_network_link_endpoint',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_networking_v1_network_link_endpoint_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'api-key',
                ...
                'endpoint_path': '/networking/v1/network-link-endpoints/{id}',
                'operation_id': 'delete_networking_v1_network_link_endpoint',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_networking_v1_network_link_endpoint_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key',
                ...
                'endpoint_path': '/networking/v1/network-link-endpoints/{id}',
                'operation_id': 'get_networking_v1_network_link_endpoint',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_networking_v1_network_link_endpoints_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key',
                ...
                'endpoint_path': '/networking/v1/network-link-endpoints',
                'operation_id': 'list_networking_v1_network_link_endpoints',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'spec_network_link_service': 'spec.network_link_service',
                    'page_size': 'page_size',
                ...
                'location_map': {
                    ...
                    'status_phase': 'query',
                    'spec_network': 'query',
                    'spec_network_link_service': 'query',
                    'page_size': 'query',
                    'page_token': 'query',
                },
                'collection_format_map': {
        ...
        self.update_networking_v1_network_link_endpoint_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key',
                ...
                'endpoint_path': '/networking/v1/network-link-endpoints/{id}',
                'operation_id': 'update_networking_v1_network_link_endpoint',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def create_networking_v1_network_link_endpoint(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.create_networking_v1_network_link_endpoint(async_req=True)
        >>> result = thread.get()
        ...
        return self.create_networking_v1_network_link_endpoint_endpoint.call_with_http_info(**kwargs)

    def delete_networking_v1_network_link_endpoint(
        self,
        environment,
        id,
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.delete_networking_v1_network_link_endpoint_endpoint.call_with_http_info(**kwargs)

    def get_networking_v1_network_link_endpoint(
        self,
        environment,
        id,
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.get_networking_v1_network_link_endpoint_endpoint.call_with_http_info(**kwargs)
    ...
    def list_networking_v1_network_link_endpoints(
        ...
        **kwargs
        ...
        >>> thread = api.list_networking_v1_network_link_endpoints(environment, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment'] = \
            environment
        return self.list_networking_v1_network_link_endpoints_endpoint.call_with_http_info(**kwargs)

    def update_networking_v1_network_link_endpoint(
        self,
        id,
        **kwargs
    ):
        ...
        >>> thread = api.update_networking_v1_network_link_endpoint(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.update_networking_v1_network_link_endpoint_endpoint.call_with_http_info(**kwargs)
