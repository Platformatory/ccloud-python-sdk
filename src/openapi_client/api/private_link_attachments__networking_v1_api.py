...
class PrivateLinkAttachmentsNetworkingV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_networking_v1_private_link_attachment_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/networking/v1/private-link-attachments',
                'operation_id': 'create_networking_v1_private_link_attachment',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_networking_v1_private_link_attachment_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/networking/v1/private-link-attachments/{id}',
                'operation_id': 'delete_networking_v1_private_link_attachment',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_networking_v1_private_link_attachment_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/networking/v1/private-link-attachments/{id}',
                'operation_id': 'get_networking_v1_private_link_attachment',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_networking_v1_private_link_attachments_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/networking/v1/private-link-attachments',
                'operation_id': 'list_networking_v1_private_link_attachments',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.update_networking_v1_private_link_attachment_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/networking/v1/private-link-attachments/{id}',
                'operation_id': 'update_networking_v1_private_link_attachment',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def create_networking_v1_private_link_attachment(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.create_networking_v1_private_link_attachment(async_req=True)
        >>> result = thread.get()
        ...
        return self.create_networking_v1_private_link_attachment_endpoint.call_with_http_info(**kwargs)

    def delete_networking_v1_private_link_attachment(
        self,
        environment,
        id,
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.delete_networking_v1_private_link_attachment_endpoint.call_with_http_info(**kwargs)

    def get_networking_v1_private_link_attachment(
        self,
        environment,
        id,
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.get_networking_v1_private_link_attachment_endpoint.call_with_http_info(**kwargs)

    def list_networking_v1_private_link_attachments(
        self,
        environment,
        **kwargs
    ):
        ...
        >>> thread = api.list_networking_v1_private_link_attachments(environment, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment'] = \
            environment
        return self.list_networking_v1_private_link_attachments_endpoint.call_with_http_info(**kwargs)

    def update_networking_v1_private_link_attachment(
        self,
        id,
        **kwargs
    ):
        ...
        >>> thread = api.update_networking_v1_private_link_attachment(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.update_networking_v1_private_link_attachment_endpoint.call_with_http_info(**kwargs)
