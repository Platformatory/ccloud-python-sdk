...
class ACLV3Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.batch_create_kafka_acls_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                ...
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/acls:batch',
                'operation_id': 'batch_create_kafka_acls',
                'http_method': 'POST',
                'servers': [
                    {
            ...
            root_map={
                ...
                'location_map': {
                    'cluster_id': 'path',
                    'create_acl_request_data_list': 'body',
                },
        ...
        self.create_kafka_acls_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/acls',
                'operation_id': 'create_kafka_acls',
                'http_method': 'POST',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
        ...
        self.delete_kafka_acls_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/acls',
                'operation_id': 'delete_kafka_acls',
                'http_method': 'DELETE',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
        ...
        self.get_kafka_acls_endpoint = _Endpoint(
            settings={
                'response_type': (AclDataList,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/acls',
                'operation_id': 'get_kafka_acls',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
    ...
    def batch_create_kafka_acls(
        ...
        **kwargs
        ...
        >>> thread = api.batch_create_kafka_acls(cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            create_acl_request_data_list (CreateAclRequestDataList): The batch ACL creation request.. [optional]
        ...
        kwargs['cluster_id'] = \
            cluster_id
        return self.batch_create_kafka_acls_endpoint.call_with_http_info(**kwargs)

    def create_kafka_acls(
        self,
        cluster_id,
        **kwargs
    ):
        ...
        >>> thread = api.create_kafka_acls(cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            create_acl_request_data (CreateAclRequestData): The ACL creation request.. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['cluster_id'] = \
            cluster_id
        return self.create_kafka_acls_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_kafka_acls(
        ...
        **kwargs
        ...
        >>> thread = api.delete_kafka_acls(cluster_id, resource_type, pattern_type, operation, permission, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['permission'] = \
            permission
        return self.delete_kafka_acls_endpoint.call_with_http_info(**kwargs)
    ...
    def get_kafka_acls(
        ...
        **kwargs
        ...
        >>> thread = api.get_kafka_acls(cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['cluster_id'] = \
            cluster_id
        return self.get_kafka_acls_endpoint.call_with_http_info(**kwargs)
