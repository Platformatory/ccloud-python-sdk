...
class ClustersCmkV2Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_cmk_v2_cluster_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/cmk/v2/clusters',
                'operation_id': 'create_cmk_v2_cluster',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_cmk_v2_cluster_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/cmk/v2/clusters/{id}',
                'operation_id': 'delete_cmk_v2_cluster',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_cmk_v2_cluster_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/cmk/v2/clusters/{id}',
                'operation_id': 'get_cmk_v2_cluster',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_cmk_v2_clusters_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/cmk/v2/clusters',
                'operation_id': 'list_cmk_v2_clusters',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.update_cmk_v2_cluster_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/cmk/v2/clusters/{id}',
                'operation_id': 'update_cmk_v2_cluster',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def create_cmk_v2_cluster(
        ...
        **kwargs
        ...
        >>> thread = api.create_cmk_v2_cluster(async_req=True)
        >>> result = thread.get()
        ...
        return self.create_cmk_v2_cluster_endpoint.call_with_http_info(**kwargs)

    def delete_cmk_v2_cluster(
        self,
        environment,
        id,
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.delete_cmk_v2_cluster_endpoint.call_with_http_info(**kwargs)

    def get_cmk_v2_cluster(
        self,
        environment,
        id,
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.get_cmk_v2_cluster_endpoint.call_with_http_info(**kwargs)
    ...
    def list_cmk_v2_clusters(
        ...
        **kwargs
        ...
        >>> thread = api.list_cmk_v2_clusters(environment, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment'] = \
            environment
        return self.list_cmk_v2_clusters_endpoint.call_with_http_info(**kwargs)

    def update_cmk_v2_cluster(
        self,
        id,
        **kwargs
    ):
        ...
        >>> thread = api.update_cmk_v2_cluster(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.update_cmk_v2_cluster_endpoint.call_with_http_info(**kwargs)
