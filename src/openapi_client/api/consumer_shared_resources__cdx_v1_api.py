...
class ConsumerSharedResourcesCdxV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_cdx_v1_consumer_shared_resource_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key'
                ],
                'endpoint_path': '/cdx/v1/consumer-shared-resources/{id}',
                'operation_id': 'get_cdx_v1_consumer_shared_resource',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.image_cdx_v1_consumer_shared_resource_endpoint = _Endpoint(
            settings={
                'response_type': (file_type,),
                'auth': [
                    'api-key'
                ],
                'endpoint_path': '/cdx/v1/consumer-shared-resources/{id}/images/{file_name}',
                'operation_id': 'image_cdx_v1_consumer_shared_resource',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_cdx_v1_consumer_shared_resources_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key'
                ],
                'endpoint_path': '/cdx/v1/consumer-shared-resources',
                'operation_id': 'list_cdx_v1_consumer_shared_resources',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.network_cdx_v1_consumer_shared_resource_endpoint = _Endpoint(
            settings={
                'response_type': (CdxV1Network,),
                'auth': [
                    'api-key'
                ],
                'endpoint_path': '/cdx/v1/consumer-shared-resources/{id}:network',
                'operation_id': 'network_cdx_v1_consumer_shared_resource',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_cdx_v1_consumer_shared_resource(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.get_cdx_v1_consumer_shared_resource_endpoint.call_with_http_info(**kwargs)

    def image_cdx_v1_consumer_shared_resource(
        self,
        id,
        file_name,
        **kwargs
        ...
        kwargs['file_name'] = \
            file_name
        return self.image_cdx_v1_consumer_shared_resource_endpoint.call_with_http_info(**kwargs)

    def list_cdx_v1_consumer_shared_resources(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.list_cdx_v1_consumer_shared_resources(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_cdx_v1_consumer_shared_resources_endpoint.call_with_http_info(**kwargs)

    def network_cdx_v1_consumer_shared_resource(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.network_cdx_v1_consumer_shared_resource_endpoint.call_with_http_info(**kwargs)
