...
class NotificationTypesNotificationsV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_notifications_v1_notification_type_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key'
                ],
                'endpoint_path': '/notifications/v1/notification-types/{id}',
                'operation_id': 'get_notifications_v1_notification_type',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_notifications_v1_notification_types_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key'
                ],
                'endpoint_path': '/notifications/v1/notification-types',
                'operation_id': 'list_notifications_v1_notification_types',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_notifications_v1_notification_type(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.get_notifications_v1_notification_type_endpoint.call_with_http_info(**kwargs)

    def list_notifications_v1_notification_types(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.list_notifications_v1_notification_types(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_notifications_v1_notification_types_endpoint.call_with_http_info(**kwargs)
