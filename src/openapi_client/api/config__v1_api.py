...
class ConfigV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_subject_config_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                ...
                'endpoint_path': '/config/{subject}',
                'operation_id': 'delete_subject_config',
                'http_method': 'DELETE',
                'servers': [
                    {
        ...
        self.delete_top_level_config_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                    'external-access-token',
                ...
                'operation_id': 'delete_top_level_config',
                'http_method': 'DELETE',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.get_cluster_config_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/clusterconfig',
                'operation_id': 'get_cluster_config',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.get_subject_level_config_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/config/{subject}',
                'operation_id': 'get_subject_level_config',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
            ...
            root_map={
                ...
                'attribute_map': {
                    'subject': 'subject',
                    'default_to_global': 'defaultToGlobal',
                },
                'location_map': {
                    'subject': 'path',
                    'default_to_global': 'query',
                },
                'collection_format_map': {
                }
            },
        ...
        self.get_top_level_config_endpoint = _Endpoint(
            settings={
                'response_type': (Config,),
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/config',
                'operation_id': 'get_top_level_config',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.update_subject_level_config_endpoint = _Endpoint(
            settings={
                'response_type': (ConfigUpdateRequest,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/config/{subject}',
                'operation_id': 'update_subject_level_config',
                'http_method': 'PUT',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.update_top_level_config_endpoint = _Endpoint(
            settings={
                'response_type': (ConfigUpdateRequest,),
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/config',
                'operation_id': 'update_top_level_config',
                'http_method': 'PUT',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
    ...
    def delete_subject_config(
        ...
        **kwargs
        ...
        kwargs['subject'] = \
            subject
        return self.delete_subject_config_endpoint.call_with_http_info(**kwargs)

    def delete_top_level_config(
        self,
        **kwargs
    ):
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.delete_top_level_config_endpoint.call_with_http_info(**kwargs)
    ...
    def get_cluster_config(
        ...
        **kwargs
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.get_cluster_config_endpoint.call_with_http_info(**kwargs)

    def get_subject_level_config(
        self,
        subject,
        **kwargs
    ):
        ...
        >>> thread = api.get_subject_level_config(subject, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['subject'] = \
            subject
        return self.get_subject_level_config_endpoint.call_with_http_info(**kwargs)
    ...
    def get_top_level_config(
        ...
        **kwargs
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.get_top_level_config_endpoint.call_with_http_info(**kwargs)

    def update_subject_level_config(
        self,
        subject,
        config_update_request,
        **kwargs
        ...
        Args:
            subject (str): Name of the subject
            config_update_request (ConfigUpdateRequest): Config Update Request
        ...
        kwargs['subject'] = \
            subject
        kwargs['config_update_request'] = \
            config_update_request
        return self.update_subject_level_config_endpoint.call_with_http_info(**kwargs)

    def update_top_level_config(
        self,
        config_update_request,
        **kwargs
    ):
        ...
        kwargs['config_update_request'] = \
            config_update_request
        return self.update_top_level_config_endpoint.call_with_http_info(**kwargs)
