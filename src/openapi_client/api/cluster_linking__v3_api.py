...
class ClusterLinkingV3Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_kafka_link_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                ...
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/links',
                'operation_id': 'create_kafka_link',
                'http_method': 'POST',
                'servers': [
                    {
        ...
        self.create_kafka_mirror_topic_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/links/{link_name}/mirrors',
                'operation_id': 'create_kafka_mirror_topic',
                'http_method': 'POST',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
            ...
            root_map={
                ...
                'location_map': {
                    'cluster_id': 'path',
                    'link_name': 'path',
                    'create_mirror_topic_request_data': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.delete_kafka_link_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/links/{link_name}',
                'operation_id': 'delete_kafka_link',
                'http_method': 'DELETE',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
        ...
        self.delete_kafka_link_config_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/links/{link_name}/configs/{config_name}',
                'operation_id': 'delete_kafka_link_config',
                'http_method': 'DELETE',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
        ...
        self.get_kafka_link_endpoint = _Endpoint(
            settings={
                'response_type': (ListLinksResponseData,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/links/{link_name}',
                'operation_id': 'get_kafka_link',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
        ...
        self.get_kafka_link_configs_endpoint = _Endpoint(
            settings={
                'response_type': (ListLinkConfigsResponseData,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/links/{link_name}/configs/{config_name}',
                'operation_id': 'get_kafka_link_configs',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
        ...
        self.list_kafka_link_configs_endpoint = _Endpoint(
            settings={
                'response_type': (ListLinkConfigsResponseDataList,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/links/{link_name}/configs',
                'operation_id': 'list_kafka_link_configs',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
        ...
        self.list_kafka_links_endpoint = _Endpoint(
            settings={
                'response_type': (ListLinksResponseDataList,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/links',
                'operation_id': 'list_kafka_links',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
        ...
        self.list_kafka_mirror_topics_endpoint = _Endpoint(
            settings={
                'response_type': (ListMirrorTopicsResponseDataList,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/links/-/mirrors',
                'operation_id': 'list_kafka_mirror_topics',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
        ...
        self.list_kafka_mirror_topics_under_link_endpoint = _Endpoint(
            settings={
                'response_type': (ListMirrorTopicsResponseDataList,),
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/links/{link_name}/mirrors',
                'operation_id': 'list_kafka_mirror_topics_under_link',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
        ...
        self.read_kafka_mirror_topic_endpoint = _Endpoint(
            settings={
                'response_type': (ListMirrorTopicsResponseData,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/links/{link_name}/mirrors/{mirror_topic_name}',
                'operation_id': 'read_kafka_mirror_topic',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
        ...
        self.update_kafka_link_config_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/links/{link_name}/configs/{config_name}',
                'operation_id': 'update_kafka_link_config',
                'http_method': 'PUT',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'link_name': 'path',
                    'config_name': 'path',
                    'update_link_config_request_data': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.update_kafka_link_config_batch_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/links/{link_name}/configs:alter',
                'operation_id': 'update_kafka_link_config_batch',
                'http_method': 'PUT',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'link_name': 'path',
                    'validate_only': 'query',
                    'alter_config_batch_request_data': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.update_kafka_mirror_topics_failover_endpoint = _Endpoint(
            settings={
                'response_type': (AlterMirrorStatusResponseDataList,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/links/{link_name}/mirrors:failover',
                'operation_id': 'update_kafka_mirror_topics_failover',
                'http_method': 'POST',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'link_name': 'path',
                    'validate_only': 'query',
                    'alter_mirrors_request_data': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.update_kafka_mirror_topics_pause_endpoint = _Endpoint(
            settings={
                'response_type': (AlterMirrorStatusResponseDataList,),
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/links/{link_name}/mirrors:pause',
                'operation_id': 'update_kafka_mirror_topics_pause',
                'http_method': 'POST',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
        ...
        self.update_kafka_mirror_topics_promote_endpoint = _Endpoint(
            settings={
                'response_type': (AlterMirrorStatusResponseDataList,),
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/links/{link_name}/mirrors:promote',
                'operation_id': 'update_kafka_mirror_topics_promote',
                'http_method': 'POST',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
        ...
        self.update_kafka_mirror_topics_resume_endpoint = _Endpoint(
            settings={
                'response_type': (AlterMirrorStatusResponseDataList,),
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/links/{link_name}/mirrors:resume',
                'operation_id': 'update_kafka_mirror_topics_resume',
                'http_method': 'POST',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
    ...
    def create_kafka_link(
        ...
        **kwargs
        ...
        >>> thread = api.create_kafka_link(cluster_id, link_name, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            ...
            create_link_request_data (CreateLinkRequestData): Create a cluster link. [optional]
        ...
        kwargs['link_name'] = \
            link_name
        return self.create_kafka_link_endpoint.call_with_http_info(**kwargs)

    def create_kafka_mirror_topic(
        self,
        cluster_id,
        link_name,
        **kwargs
        ...
        >>> thread = api.create_kafka_mirror_topic(cluster_id, link_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['link_name'] = \
            link_name
        return self.create_kafka_mirror_topic_endpoint.call_with_http_info(**kwargs)

    def delete_kafka_link(
        self,
        cluster_id,
        link_name,
        **kwargs
        ...
        >>> thread = api.delete_kafka_link(cluster_id, link_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['link_name'] = \
            link_name
        return self.delete_kafka_link_endpoint.call_with_http_info(**kwargs)

    def delete_kafka_link_config(
        self,
        cluster_id,
        link_name,
        config_name,
        **kwargs
        ...
        kwargs['config_name'] = \
            config_name
        return self.delete_kafka_link_config_endpoint.call_with_http_info(**kwargs)
    ...
    def get_kafka_link(
        ...
        **kwargs
        ...
        kwargs['link_name'] = \
            link_name
        return self.get_kafka_link_endpoint.call_with_http_info(**kwargs)

    def get_kafka_link_configs(
        self,
        cluster_id,
        link_name,
        config_name,
        **kwargs
        ...
        kwargs['config_name'] = \
            config_name
        return self.get_kafka_link_configs_endpoint.call_with_http_info(**kwargs)

    def list_kafka_link_configs(
        self,
        cluster_id,
        link_name,
        **kwargs
        ...
        kwargs['link_name'] = \
            link_name
        return self.list_kafka_link_configs_endpoint.call_with_http_info(**kwargs)

    def list_kafka_links(
        self,
        cluster_id,
        **kwargs
    ):
        ...
        kwargs['cluster_id'] = \
            cluster_id
        return self.list_kafka_links_endpoint.call_with_http_info(**kwargs)

    def list_kafka_mirror_topics(
        self,
        cluster_id,
        **kwargs
    ):
        ...
        >>> thread = api.list_kafka_mirror_topics(cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['cluster_id'] = \
            cluster_id
        return self.list_kafka_mirror_topics_endpoint.call_with_http_info(**kwargs)
    ...
    def list_kafka_mirror_topics_under_link(
        ...
        **kwargs
        ...
        >>> thread = api.list_kafka_mirror_topics_under_link(cluster_id, link_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['link_name'] = \
            link_name
        return self.list_kafka_mirror_topics_under_link_endpoint.call_with_http_info(**kwargs)

    def read_kafka_mirror_topic(
        self,
        cluster_id,
        link_name,
        mirror_topic_name,
        **kwargs
        ...
        kwargs['link_name'] = \
            link_name
        kwargs['mirror_topic_name'] = \
            mirror_topic_name
        return self.read_kafka_mirror_topic_endpoint.call_with_http_info(**kwargs)
    ...
    def update_kafka_link_config(
        ...
        **kwargs
        ...
        >>> thread = api.update_kafka_link_config(cluster_id, link_name, config_name, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            update_link_config_request_data (UpdateLinkConfigRequestData): Link config value to update. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['config_name'] = \
            config_name
        return self.update_kafka_link_config_endpoint.call_with_http_info(**kwargs)
    ...
    def update_kafka_link_config_batch(
        ...
        **kwargs
        ...
        >>> thread = api.update_kafka_link_config_batch(cluster_id, link_name, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            validate_only (bool): To validate the action can be performed successfully or not. Default: false. [optional]
            alter_config_batch_request_data (AlterConfigBatchRequestData): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['link_name'] = \
            link_name
        return self.update_kafka_link_config_batch_endpoint.call_with_http_info(**kwargs)

    def update_kafka_mirror_topics_failover(
        self,
        cluster_id,
        link_name,
        **kwargs
        ...
        >>> thread = api.update_kafka_mirror_topics_failover(cluster_id, link_name, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            validate_only (bool): To validate the action can be performed successfully or not. Default: false. [optional]
            alter_mirrors_request_data (AlterMirrorsRequestData): Mirror topics to be altered.. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['link_name'] = \
            link_name
        return self.update_kafka_mirror_topics_failover_endpoint.call_with_http_info(**kwargs)

    def update_kafka_mirror_topics_pause(
        self,
        cluster_id,
        link_name,
        **kwargs
        ...
        >>> thread = api.update_kafka_mirror_topics_pause(cluster_id, link_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['link_name'] = \
            link_name
        return self.update_kafka_mirror_topics_pause_endpoint.call_with_http_info(**kwargs)

    def update_kafka_mirror_topics_promote(
        self,
        cluster_id,
        link_name,
        **kwargs
        ...
        >>> thread = api.update_kafka_mirror_topics_promote(cluster_id, link_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['link_name'] = \
            link_name
        return self.update_kafka_mirror_topics_promote_endpoint.call_with_http_info(**kwargs)

    def update_kafka_mirror_topics_resume(
        self,
        cluster_id,
        link_name,
        **kwargs
        ...
        >>> thread = api.update_kafka_mirror_topics_resume(cluster_id, link_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['link_name'] = \
            link_name
        return self.update_kafka_mirror_topics_resume_endpoint.call_with_http_info(**kwargs)
