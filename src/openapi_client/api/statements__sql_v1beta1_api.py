...
class StatementsSqlV1beta1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_sqlv1beta1_statement_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'resource-api-key'
                ],
                'endpoint_path': '/sql/v1beta1/organizations/{organization_id}/environments/{environment_id}/statements',
                'operation_id': 'create_sqlv1beta1_statement',
                'http_method': 'POST',
                'servers': [
                    {
        ...
        self.delete_sqlv1beta1_statement_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'resource-api-key'
                ],
                'endpoint_path': '/sql/v1beta1/organizations/{organization_id}/environments/{environment_id}/statements/{statement_name}',
                'operation_id': 'delete_sqlv1beta1_statement',
                'http_method': 'DELETE',
                'servers': [
                    {
                        'url': "https://flink.region.provider.confluent.cloud",
        ...
        self.get_sqlv1beta1_statement_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'resource-api-key'
                ...
                'endpoint_path': '/sql/v1beta1/organizations/{organization_id}/environments/{environment_id}/statements/{statement_name}',
                'operation_id': 'get_sqlv1beta1_statement',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://flink.region.provider.confluent.cloud",
        ...
        self.list_sqlv1beta1_statements_endpoint = _Endpoint(
            settings={
                'response_type': (SqlV1beta1StatementList,),
                'auth': [
                    'resource-api-key'
                ],
                'endpoint_path': '/sql/v1beta1/organizations/{organization_id}/environments/{environment_id}/statements',
                'operation_id': 'list_sqlv1beta1_statements',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://flink.region.provider.confluent.cloud",
            ...
            root_map={
                ...
                'attribute_map': {
                    'organization_id': 'organization_id',
                    'environment_id': 'environment_id',
                    'spec_compute_pool_id': 'spec.compute_pool_id',
                    'page_size': 'page_size',
        ...
        self.update_sqlv1beta1_statement_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'resource-api-key'
                ...
                'endpoint_path': '/sql/v1beta1/organizations/{organization_id}/environments/{environment_id}/statements/{statement_name}',
                'operation_id': 'update_sqlv1beta1_statement',
                'http_method': 'PUT',
                'servers': [
                    {
                        'url': "https://flink.region.provider.confluent.cloud",
    ...
    def create_sqlv1beta1_statement(
        self,
        organization_id,
        environment_id,
        **kwargs
    ):
        """Create a Statement  # noqa: E501

        [![Preview](https://img.shields.io/badge/Lifecycle%20Stage-Preview-%2300afba)](#section/Versioning/API-Lifecycle-Policy)  Make a request to create a statement.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_sqlv1beta1_statement(organization_id, environment_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment_id'] = \
            environment_id
        return self.create_sqlv1beta1_statement_endpoint.call_with_http_info(**kwargs)

    def delete_sqlv1beta1_statement(
        self,
        organization_id,
        environment_id,
        statement_name,
        **kwargs
        ...
        [![Preview](https://img.shields.io/badge/Lifecycle%20Stage-Preview-%2300afba)](#section/Versioning/API-Lifecycle-Policy)  Make a request to delete a statement.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_sqlv1beta1_statement(organization_id, environment_id, statement_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment_id'] = \
            environment_id
        kwargs['statement_name'] = \
            statement_name
        return self.delete_sqlv1beta1_statement_endpoint.call_with_http_info(**kwargs)

    def get_sqlv1beta1_statement(
        self,
        organization_id,
        environment_id,
        statement_name,
        **kwargs
        ...
        """Read a Statement  # noqa: E501

        [![Preview](https://img.shields.io/badge/Lifecycle%20Stage-Preview-%2300afba)](#section/Versioning/API-Lifecycle-Policy)  Make a request to read a statement.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_sqlv1beta1_statement(organization_id, environment_id, statement_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['statement_name'] = \
            statement_name
        return self.get_sqlv1beta1_statement_endpoint.call_with_http_info(**kwargs)

    def list_sqlv1beta1_statements(
        self,
        organization_id,
        environment_id,
        **kwargs
    ):
        """List of Statements  # noqa: E501

        [![Preview](https://img.shields.io/badge/Lifecycle%20Stage-Preview-%2300afba)](#section/Versioning/API-Lifecycle-Policy)  Retrieve a sorted, filtered, paginated list of all statements.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_sqlv1beta1_statements(organization_id, environment_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment_id'] = \
            environment_id
        return self.list_sqlv1beta1_statements_endpoint.call_with_http_info(**kwargs)

    def update_sqlv1beta1_statement(
        self,
        organization_id,
        environment_id,
        statement_name,
        **kwargs
        ...
        """Update a Statement  # noqa: E501

        [![Preview](https://img.shields.io/badge/Lifecycle%20Stage-Preview-%2300afba)](#section/Versioning/API-Lifecycle-Policy)  Make a request to update a statement.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_sqlv1beta1_statement(organization_id, environment_id, statement_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['statement_name'] = \
            statement_name
        return self.update_sqlv1beta1_statement_endpoint.call_with_http_info(**kwargs)
