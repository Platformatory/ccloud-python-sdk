...
class KeysByokV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_byok_v1_key_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key'
                ],
                'endpoint_path': '/byok/v1/keys',
                'operation_id': 'create_byok_v1_key',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_byok_v1_key_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cloud-api-key'
                ],
                'endpoint_path': '/byok/v1/keys/{id}',
                'operation_id': 'delete_byok_v1_key',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_byok_v1_key_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key'
        ...
        self.list_byok_v1_keys_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key'
                ...
                'endpoint_path': '/byok/v1/keys',
                'operation_id': 'list_byok_v1_keys',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def create_byok_v1_key(
        ...
        **kwargs
        ...
        >>> thread = api.create_byok_v1_key(async_req=True)
        >>> result = thread.get()
        ...
        return self.create_byok_v1_key_endpoint.call_with_http_info(**kwargs)

    def delete_byok_v1_key(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.delete_byok_v1_key_endpoint.call_with_http_info(**kwargs)
    ...
    def get_byok_v1_key(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.get_byok_v1_key_endpoint.call_with_http_info(**kwargs)

    def list_byok_v1_keys(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.list_byok_v1_keys(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_byok_v1_keys_endpoint.call_with_http_info(**kwargs)
