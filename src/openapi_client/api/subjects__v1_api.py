...
class SubjectsV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_schema_version_endpoint = _Endpoint(
            settings={
                'response_type': (int,),
                'auth': [
                ...
                'endpoint_path': '/subjects/{subject}/versions/{version}',
                'operation_id': 'delete_schema_version',
                'http_method': 'DELETE',
                'servers': [
                    {
        ...
        self.delete_subject_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/subjects/{subject}',
        ...
        self.get_referenced_by_endpoint = _Endpoint(
            settings={
                'response_type': ([int],),
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/subjects/{subject}/versions/{version}/referencedby',
                'operation_id': 'get_referenced_by',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.get_schema_by_version_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/subjects/{subject}/versions/{version}',
                'operation_id': 'get_schema_by_version',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.get_schema_only1_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/subjects/{subject}/versions/{version}/schema',
                'operation_id': 'get_schema_only1',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.list_versions_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/subjects/{subject}/versions',
        ...
        self.look_up_schema_under_subject_endpoint = _Endpoint(
            settings={
                'response_type': (Schema,),
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/subjects/{subject}',
                'operation_id': 'look_up_schema_under_subject',
                'http_method': 'POST',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.register_endpoint = _Endpoint(
            settings={
                'response_type': (RegisterSchemaResponse,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
    ...
    def delete_schema_version(
        ...
        **kwargs
        ...
        >>> thread = api.delete_schema_version(subject, version, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['version'] = \
            version
        return self.delete_schema_version_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_subject(
        ...
        **kwargs
        ...
        >>> thread = api.delete_subject(subject, async_req=True)
        >>> result = thread.get()
    ...
    def get_referenced_by(
        ...
        **kwargs
        ...
        kwargs['version'] = \
            version
        return self.get_referenced_by_endpoint.call_with_http_info(**kwargs)
    ...
    def get_schema_by_version(
        ...
        **kwargs
        ...
        >>> thread = api.get_schema_by_version(subject, version, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['version'] = \
            version
        return self.get_schema_by_version_endpoint.call_with_http_info(**kwargs)

    def get_schema_only1(
        self,
        subject,
        version,
        **kwargs
        ...
        >>> thread = api.get_schema_only1(subject, version, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['version'] = \
            version
        return self.get_schema_only1_endpoint.call_with_http_info(**kwargs)
    ...
    def list_versions(
        ...
        **kwargs
        ...
        >>> thread = api.list_versions(subject, async_req=True)
        >>> result = thread.get()
    ...
    def look_up_schema_under_subject(
        self,
        subject,
        register_schema_request,
        **kwargs
        ...
        >>> thread = api.look_up_schema_under_subject(subject, register_schema_request, async_req=True)
        >>> result = thread.get()

        Args:
            subject (str): Subject under which the schema will be registered
            register_schema_request (RegisterSchemaRequest): Schema
        ...
        kwargs['subject'] = \
            subject
        kwargs['register_schema_request'] = \
            register_schema_request
        return self.look_up_schema_under_subject_endpoint.call_with_http_info(**kwargs)
    ...
    def register(
        ...
        **kwargs
        ...
        >>> thread = api.register(subject, register_schema_request, async_req=True)
        >>> result = thread.get()
