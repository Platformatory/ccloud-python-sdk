...
class ConnectorsConnectV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_connectv1_connector_endpoint = _Endpoint(
            settings={
                'response_type': (ConnectV1Connector,),
                'auth': [
                    'cloud-api-key',
                    'confluent-sts-access-token'
                ],
                'endpoint_path': '/connect/v1/environments/{environment_id}/clusters/{kafka_cluster_id}/connectors',
                'operation_id': 'create_connectv1_connector',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.create_or_update_connectv1_connector_config_endpoint = _Endpoint(
            settings={
                'response_type': (ConnectV1Connector,),
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/connect/v1/environments/{environment_id}/clusters/{kafka_cluster_id}/connectors/{connector_name}/config',
                'operation_id': 'create_or_update_connectv1_connector_config',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
        ...
        self.delete_connectv1_connector_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/connect/v1/environments/{environment_id}/clusters/{kafka_cluster_id}/connectors/{connector_name}',
                'operation_id': 'delete_connectv1_connector',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_connectv1_connector_config_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/connect/v1/environments/{environment_id}/clusters/{kafka_cluster_id}/connectors/{connector_name}/config',
                'operation_id': 'get_connectv1_connector_config',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_connectv1_connectors_endpoint = _Endpoint(
            settings={
                'response_type': ([str],),
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/connect/v1/environments/{environment_id}/clusters/{kafka_cluster_id}/connectors',
                'operation_id': 'list_connectv1_connectors',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_connectv1_connectors_with_expansions_endpoint = _Endpoint(
            settings={
                'response_type': (ConnectV1ConnectorExpansionMap,),
                'auth': [
                    'cloud-api-key',
                    'confluent-sts-access-token'
                ],
                'endpoint_path': '/connect/v1/environments/{environment_id}/clusters/{kafka_cluster_id}/connectors?expand=info,status,id',
                'operation_id': 'list_connectv1_connectors_with_expansions',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.read_connectv1_connector_endpoint = _Endpoint(
            settings={
                'response_type': (ConnectV1Connector,),
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/connect/v1/environments/{environment_id}/clusters/{kafka_cluster_id}/connectors/{connector_name}',
                'operation_id': 'read_connectv1_connector',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def create_connectv1_connector(
        self,
        environment_id,
        kafka_cluster_id,
        **kwargs
        ...
        >>> thread = api.create_connectv1_connector(environment_id, kafka_cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment_id'] = \
            environment_id
        kwargs['kafka_cluster_id'] = \
            kafka_cluster_id
        return self.create_connectv1_connector_endpoint.call_with_http_info(**kwargs)
    ...
    def create_or_update_connectv1_connector_config(
        ...
        **kwargs
        ...
        >>> thread = api.create_or_update_connectv1_connector_config(connector_name, environment_id, kafka_cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['kafka_cluster_id'] = \
            kafka_cluster_id
        return self.create_or_update_connectv1_connector_config_endpoint.call_with_http_info(**kwargs)

    def delete_connectv1_connector(
        self,
        connector_name,
        environment_id,
        kafka_cluster_id,
        **kwargs
        ...
        kwargs['kafka_cluster_id'] = \
            kafka_cluster_id
        return self.delete_connectv1_connector_endpoint.call_with_http_info(**kwargs)
    ...
    def get_connectv1_connector_config(
        ...
        **kwargs
        ...
        kwargs['kafka_cluster_id'] = \
            kafka_cluster_id
        return self.get_connectv1_connector_config_endpoint.call_with_http_info(**kwargs)

    def list_connectv1_connectors(
        self,
        environment_id,
        kafka_cluster_id,
        **kwargs
        ...
        kwargs['kafka_cluster_id'] = \
            kafka_cluster_id
        return self.list_connectv1_connectors_endpoint.call_with_http_info(**kwargs)
    ...
    def list_connectv1_connectors_with_expansions(
        ...
        **kwargs
        ...
        >>> thread = api.list_connectv1_connectors_with_expansions(environment_id, kafka_cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['kafka_cluster_id'] = \
            kafka_cluster_id
        return self.list_connectv1_connectors_with_expansions_endpoint.call_with_http_info(**kwargs)
    ...
    def read_connectv1_connector(
        ...
        **kwargs
        ...
        kwargs['kafka_cluster_id'] = \
            kafka_cluster_id
        return self.read_connectv1_connector_endpoint.call_with_http_info(**kwargs)
