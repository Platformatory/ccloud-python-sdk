...
class ClientQuotasKafkaQuotasV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_kafka_quotas_v1_client_quota_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key'
                ],
                'endpoint_path': '/kafka-quotas/v1/client-quotas',
                'operation_id': 'create_kafka_quotas_v1_client_quota',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_kafka_quotas_v1_client_quota_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'api-key'
                ],
                'endpoint_path': '/kafka-quotas/v1/client-quotas/{id}',
                'operation_id': 'delete_kafka_quotas_v1_client_quota',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_kafka_quotas_v1_client_quota_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key'
                ...
                'endpoint_path': '/kafka-quotas/v1/client-quotas/{id}',
                'operation_id': 'get_kafka_quotas_v1_client_quota',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_kafka_quotas_v1_client_quotas_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key'
                ...
                'endpoint_path': '/kafka-quotas/v1/client-quotas',
                'operation_id': 'list_kafka_quotas_v1_client_quotas',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.update_kafka_quotas_v1_client_quota_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key'
                ...
                'endpoint_path': '/kafka-quotas/v1/client-quotas/{id}',
                'operation_id': 'update_kafka_quotas_v1_client_quota',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def create_kafka_quotas_v1_client_quota(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.create_kafka_quotas_v1_client_quota(async_req=True)
        >>> result = thread.get()
        ...
        return self.create_kafka_quotas_v1_client_quota_endpoint.call_with_http_info(**kwargs)

    def delete_kafka_quotas_v1_client_quota(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.delete_kafka_quotas_v1_client_quota_endpoint.call_with_http_info(**kwargs)

    def get_kafka_quotas_v1_client_quota(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.get_kafka_quotas_v1_client_quota_endpoint.call_with_http_info(**kwargs)
    ...
    def list_kafka_quotas_v1_client_quotas(
        ...
        **kwargs
        ...
        >>> thread = api.list_kafka_quotas_v1_client_quotas(spec_cluster, environment, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment'] = \
            environment
        return self.list_kafka_quotas_v1_client_quotas_endpoint.call_with_http_info(**kwargs)

    def update_kafka_quotas_v1_client_quota(
        self,
        id,
        **kwargs
    ):
        ...
        >>> thread = api.update_kafka_quotas_v1_client_quota(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.update_kafka_quotas_v1_client_quota_endpoint.call_with_http_info(**kwargs)
