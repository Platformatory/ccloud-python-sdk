...
class NetworkLinkServiceAssociationsNetworkingV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_networking_v1_network_link_service_association_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/networking/v1/network-link-service-associations/{id}',
                'operation_id': 'get_networking_v1_network_link_service_association',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_networking_v1_network_link_service_associations_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key',
                ...
                'endpoint_path': '/networking/v1/network-link-service-associations',
                'operation_id': 'list_networking_v1_network_link_service_associations',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_networking_v1_network_link_service_association(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.get_networking_v1_network_link_service_association_endpoint.call_with_http_info(**kwargs)
    ...
    def list_networking_v1_network_link_service_associations(
        ...
        **kwargs
        ...
        >>> thread = api.list_networking_v1_network_link_service_associations(spec_network_link_service, environment, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['spec_network_link_service'] = \
            spec_network_link_service
        kwargs['environment'] = \
            environment
        return self.list_networking_v1_network_link_service_associations_endpoint.call_with_http_info(**kwargs)
