...
class PrivateLinkAttachmentConnectionsNetworkingV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_networking_v1_private_link_attachment_connection_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/networking/v1/private-link-attachment-connections',
                'operation_id': 'create_networking_v1_private_link_attachment_connection',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_networking_v1_private_link_attachment_connection_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/networking/v1/private-link-attachment-connections/{id}',
                'operation_id': 'delete_networking_v1_private_link_attachment_connection',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_networking_v1_private_link_attachment_connection_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/networking/v1/private-link-attachment-connections/{id}',
                'operation_id': 'get_networking_v1_private_link_attachment_connection',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_networking_v1_private_link_attachment_connections_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/networking/v1/private-link-attachment-connections',
                'operation_id': 'list_networking_v1_private_link_attachment_connections',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'attribute_map': {
                    'environment': 'environment',
                    'spec_private_link_attachment': 'spec.private_link_attachment',
                    'page_size': 'page_size',
                    'page_token': 'page_token',
                },
                'location_map': {
                    'environment': 'query',
                    'spec_private_link_attachment': 'query',
                    'page_size': 'query',
                    'page_token': 'query',
                },
                'collection_format_map': {
        ...
        self.update_networking_v1_private_link_attachment_connection_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/networking/v1/private-link-attachment-connections/{id}',
                'operation_id': 'update_networking_v1_private_link_attachment_connection',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def create_networking_v1_private_link_attachment_connection(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.create_networking_v1_private_link_attachment_connection(async_req=True)
        >>> result = thread.get()
        ...
        return self.create_networking_v1_private_link_attachment_connection_endpoint.call_with_http_info(**kwargs)

    def delete_networking_v1_private_link_attachment_connection(
        self,
        environment,
        id,
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.delete_networking_v1_private_link_attachment_connection_endpoint.call_with_http_info(**kwargs)
    ...
    def get_networking_v1_private_link_attachment_connection(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.get_networking_v1_private_link_attachment_connection_endpoint.call_with_http_info(**kwargs)
    ...
    def list_networking_v1_private_link_attachment_connections(
        ...
        **kwargs
        ...
        >>> thread = api.list_networking_v1_private_link_attachment_connections(environment, spec_private_link_attachment, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment'] = \
            environment
        kwargs['spec_private_link_attachment'] = \
            spec_private_link_attachment
        return self.list_networking_v1_private_link_attachment_connections_endpoint.call_with_http_info(**kwargs)

    def update_networking_v1_private_link_attachment_connection(
        self,
        id,
        **kwargs
    ):
        ...
        >>> thread = api.update_networking_v1_private_link_attachment_connection(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.update_networking_v1_private_link_attachment_connection_endpoint.call_with_http_info(**kwargs)
