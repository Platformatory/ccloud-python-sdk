...
class ConfigsV3Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_kafka_cluster_config_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                ...
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/broker-configs/{name}',
                'operation_id': 'delete_kafka_cluster_config',
                'http_method': 'DELETE',
                'servers': [
                    {
        ...
        self.delete_kafka_topic_config_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/topics/{topic_name}/configs/{name}',
                'operation_id': 'delete_kafka_topic_config',
                'http_method': 'DELETE',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
        ...
        self.get_kafka_cluster_config_endpoint = _Endpoint(
            settings={
                'response_type': (ClusterConfigData,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/broker-configs/{name}',
                'operation_id': 'get_kafka_cluster_config',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
        ...
        self.get_kafka_topic_config_endpoint = _Endpoint(
            settings={
                'response_type': (TopicConfigData,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
        ...
        self.list_kafka_all_topic_configs_endpoint = _Endpoint(
            settings={
                'response_type': (TopicConfigDataList,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/topics/-/configs',
                'operation_id': 'list_kafka_all_topic_configs',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
        ...
        self.list_kafka_cluster_configs_endpoint = _Endpoint(
            settings={
                'response_type': (ClusterConfigDataList,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/broker-configs',
                'operation_id': 'list_kafka_cluster_configs',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
        ...
        self.list_kafka_default_topic_configs_endpoint = _Endpoint(
            settings={
                'response_type': (TopicConfigDataList,),
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/topics/{topic_name}/default-configs',
                'operation_id': 'list_kafka_default_topic_configs',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
        ...
        self.list_kafka_topic_configs_endpoint = _Endpoint(
            settings={
                'response_type': (TopicConfigDataList,),
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/topics/{topic_name}/configs',
                'operation_id': 'list_kafka_topic_configs',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
        ...
        self.update_kafka_cluster_config_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/broker-configs/{name}',
                'operation_id': 'update_kafka_cluster_config',
                'http_method': 'PUT',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
            ...
            root_map={
                ...
                'location_map': {
                    'cluster_id': 'path',
                    'name': 'path',
                    'update_config_request_data': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.update_kafka_cluster_configs_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/broker-configs:alter',
                'operation_id': 'update_kafka_cluster_configs',
                'http_method': 'POST',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
        ...
        self.update_kafka_topic_config_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/topics/{topic_name}/configs/{name}',
                'operation_id': 'update_kafka_topic_config',
                'http_method': 'PUT',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
        ...
        self.update_kafka_topic_config_batch_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/topics/{topic_name}/configs:alter',
                'operation_id': 'update_kafka_topic_config_batch',
                'http_method': 'POST',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
    ...
    def delete_kafka_cluster_config(
        self,
        cluster_id,
        name,
        **kwargs
        ...
        kwargs['name'] = \
            name
        return self.delete_kafka_cluster_config_endpoint.call_with_http_info(**kwargs)

    def delete_kafka_topic_config(
        self,
        cluster_id,
        topic_name,
        name,
        **kwargs
        ...
        kwargs['name'] = \
            name
        return self.delete_kafka_topic_config_endpoint.call_with_http_info(**kwargs)

    def get_kafka_cluster_config(
        self,
        cluster_id,
        name,
        **kwargs
        ...
        kwargs['name'] = \
            name
        return self.get_kafka_cluster_config_endpoint.call_with_http_info(**kwargs)
    ...
    def get_kafka_topic_config(
        ...
        **kwargs
        ...
        kwargs['name'] = \
            name
        return self.get_kafka_topic_config_endpoint.call_with_http_info(**kwargs)

    def list_kafka_all_topic_configs(
        self,
        cluster_id,
        **kwargs
    ):
        ...
        kwargs['cluster_id'] = \
            cluster_id
        return self.list_kafka_all_topic_configs_endpoint.call_with_http_info(**kwargs)

    def list_kafka_cluster_configs(
        self,
        cluster_id,
        **kwargs
    ):
        ...
        kwargs['cluster_id'] = \
            cluster_id
        return self.list_kafka_cluster_configs_endpoint.call_with_http_info(**kwargs)

    def list_kafka_default_topic_configs(
        self,
        cluster_id,
        topic_name,
        **kwargs
        ...
        kwargs['topic_name'] = \
            topic_name
        return self.list_kafka_default_topic_configs_endpoint.call_with_http_info(**kwargs)

    def list_kafka_topic_configs(
        self,
        cluster_id,
        topic_name,
        **kwargs
        ...
        kwargs['topic_name'] = \
            topic_name
        return self.list_kafka_topic_configs_endpoint.call_with_http_info(**kwargs)
    ...
    def update_kafka_cluster_config(
        ...
        **kwargs
        ...
        >>> thread = api.update_kafka_cluster_config(cluster_id, name, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            update_config_request_data (UpdateConfigRequestData): The cluster configuration parameter update request.. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['name'] = \
            name
        return self.update_kafka_cluster_config_endpoint.call_with_http_info(**kwargs)

    def update_kafka_cluster_configs(
        self,
        cluster_id,
        **kwargs
    ):
        ...
        >>> thread = api.update_kafka_cluster_configs(cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            alter_config_batch_request_data (AlterConfigBatchRequestData): The alter cluster configuration parameter batch request.. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['cluster_id'] = \
            cluster_id
        return self.update_kafka_cluster_configs_endpoint.call_with_http_info(**kwargs)
    ...
    def update_kafka_topic_config(
        ...
        **kwargs
        ...
        >>> thread = api.update_kafka_topic_config(cluster_id, topic_name, name, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            update_config_request_data (UpdateConfigRequestData): The topic configuration parameter update request.. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['name'] = \
            name
        return self.update_kafka_topic_config_endpoint.call_with_http_info(**kwargs)

    def update_kafka_topic_config_batch(
        self,
        cluster_id,
        topic_name,
        **kwargs
        ...
        >>> thread = api.update_kafka_topic_config_batch(cluster_id, topic_name, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            alter_config_batch_request_data (AlterConfigBatchRequestData): The alter topic configuration parameter batch request.. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['topic_name'] = \
            topic_name
        return self.update_kafka_topic_config_batch_endpoint.call_with_http_info(**kwargs)
