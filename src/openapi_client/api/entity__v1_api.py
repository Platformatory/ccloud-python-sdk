...
class EntityV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_business_metadata_endpoint = _Endpoint(
            settings={
                'response_type': ([BusinessMetadataResponse],),
                'auth': [],
                'endpoint_path': '/catalog/v1/entity/businessmetadata',
                'operation_id': 'create_business_metadata',
                'http_method': 'POST',
                'servers': [
                    {
        ...
        self.create_tags_endpoint = _Endpoint(
            settings={
                'response_type': ([TagResponse],),
                'auth': [],
                'endpoint_path': '/catalog/v1/entity/tags',
        ...
        self.delete_business_metadata_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
                'endpoint_path': '/catalog/v1/entity/type/{typeName}/name/{qualifiedName}/businessmetadata/{bmName}',
                'operation_id': 'delete_business_metadata',
                'http_method': 'DELETE',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.delete_tag_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
                'endpoint_path': '/catalog/v1/entity/type/{typeName}/name/{qualifiedName}/tags/{tagName}',
        ...
        self.get_business_metadata_endpoint = _Endpoint(
            settings={
                'response_type': ([BusinessMetadataResponse],),
                'auth': [],
                'endpoint_path': '/catalog/v1/entity/type/{typeName}/name/{qualifiedName}/businessmetadata',
                'operation_id': 'get_business_metadata',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.get_by_unique_attributes_endpoint = _Endpoint(
            settings={
                'response_type': (EntityWithExtInfo,),
                'auth': [],
                'endpoint_path': '/catalog/v1/entity/type/{typeName}/name/{qualifiedName}',
                'operation_id': 'get_by_unique_attributes',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.get_tags_endpoint = _Endpoint(
            settings={
                'response_type': ([TagResponse],),
                'auth': [],
                'endpoint_path': '/catalog/v1/entity/type/{typeName}/name/{qualifiedName}/tags',
        ...
        self.partial_entity_update_endpoint = _Endpoint(
            settings={
                'response_type': (EntityPartialUpdateResponse,),
                'auth': [],
                'endpoint_path': '/catalog/v1/entity',
                'operation_id': 'partial_entity_update',
                'http_method': 'PUT',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.update_business_metadata_endpoint = _Endpoint(
            settings={
                'response_type': ([BusinessMetadataResponse],),
                'auth': [],
                'endpoint_path': '/catalog/v1/entity/businessmetadata',
                'operation_id': 'update_business_metadata',
                'http_method': 'PUT',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.update_tags_endpoint = _Endpoint(
            settings={
                'response_type': ([TagResponse],),
                'auth': [],
                'endpoint_path': '/catalog/v1/entity/tags',
    ...
    def create_business_metadata(
        ...
        **kwargs
        ...
        >>> thread = api.create_business_metadata(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            business_metadata ([BusinessMetadata]): The business metadata. [optional]
        ...
        return self.create_business_metadata_endpoint.call_with_http_info(**kwargs)
    ...
    def create_tags(
        ...
        **kwargs
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.create_tags_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_business_metadata(
        ...
        **kwargs
        ...
        kwargs['type_name'] = \
            type_name
        kwargs['qualified_name'] = \
            qualified_name
        kwargs['bm_name'] = \
            bm_name
        return self.delete_business_metadata_endpoint.call_with_http_info(**kwargs)
    ...
    def get_business_metadata(
        ...
        **kwargs
        ...
        kwargs['qualified_name'] = \
            qualified_name
        return self.get_business_metadata_endpoint.call_with_http_info(**kwargs)
    ...
    def get_by_unique_attributes(
        ...
        **kwargs
        ...
        >>> thread = api.get_by_unique_attributes(type_name, qualified_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['qualified_name'] = \
            qualified_name
        return self.get_by_unique_attributes_endpoint.call_with_http_info(**kwargs)
    ...
    def partial_entity_update(
        ...
        **kwargs
        ...
        >>> thread = api.partial_entity_update(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            entity_with_ext_info (EntityWithExtInfo): The entity to update. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.partial_entity_update_endpoint.call_with_http_info(**kwargs)
    ...
    def update_business_metadata(
        ...
        **kwargs
        ...
        >>> thread = api.update_business_metadata(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.update_business_metadata_endpoint.call_with_http_info(**kwargs)
    ...
    def update_tags(
        ...
        **kwargs
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.update_tags_endpoint.call_with_http_info(**kwargs)
