...
class PipelinesSdV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_sd_v1_pipeline_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key'
                ],
                'endpoint_path': '/sd/v1/pipelines',
                'operation_id': 'create_sd_v1_pipeline',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_sd_v1_pipeline_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'api-key'
                ],
                'endpoint_path': '/sd/v1/pipelines/{id}',
                'operation_id': 'delete_sd_v1_pipeline',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'spec_kafka_cluster': 'spec.kafka_cluster',
                    'id': 'id',
                },
                'location_map': {
                    'environment': 'query',
                    'spec_kafka_cluster': 'query',
                    'id': 'path',
                },
                'collection_format_map': {
                }
        ...
        self.get_sd_v1_pipeline_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key'
                ...
                'endpoint_path': '/sd/v1/pipelines/{id}',
                'operation_id': 'get_sd_v1_pipeline',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_sd_v1_pipelines_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key'
                ...
                'endpoint_path': '/sd/v1/pipelines',
                'operation_id': 'list_sd_v1_pipelines',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.update_sd_v1_pipeline_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key'
                ...
                'endpoint_path': '/sd/v1/pipelines/{id}',
                'operation_id': 'update_sd_v1_pipeline',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def create_sd_v1_pipeline(
        ...
        **kwargs
        ...
        >>> thread = api.create_sd_v1_pipeline(async_req=True)
        >>> result = thread.get()
        ...
        return self.create_sd_v1_pipeline_endpoint.call_with_http_info(**kwargs)

    def delete_sd_v1_pipeline(
        self,
        environment,
        spec_kafka_cluster,
        id,
        **kwargs
        ...
        kwargs['environment'] = \
            environment
        kwargs['spec_kafka_cluster'] = \
            spec_kafka_cluster
        kwargs['id'] = \
            id
        return self.delete_sd_v1_pipeline_endpoint.call_with_http_info(**kwargs)

    def get_sd_v1_pipeline(
        self,
        environment,
        spec_kafka_cluster,
        id,
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.get_sd_v1_pipeline_endpoint.call_with_http_info(**kwargs)

    def list_sd_v1_pipelines(
        self,
        environment,
        spec_kafka_cluster,
        **kwargs
        ...
        >>> thread = api.list_sd_v1_pipelines(environment, spec_kafka_cluster, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['spec_kafka_cluster'] = \
            spec_kafka_cluster
        return self.list_sd_v1_pipelines_endpoint.call_with_http_info(**kwargs)

    def update_sd_v1_pipeline(
        self,
        id,
        **kwargs
    ):
        ...
        >>> thread = api.update_sd_v1_pipeline(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.update_sd_v1_pipeline_endpoint.call_with_http_info(**kwargs)
