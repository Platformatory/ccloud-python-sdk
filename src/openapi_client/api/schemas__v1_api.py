...
class SchemasV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_schema_endpoint = _Endpoint(
            settings={
                'response_type': (SchemaString,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/schemas/ids/{id}',
        ...
        self.get_schema_only_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/schemas/ids/{id}/schema',
                'operation_id': 'get_schema_only',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.get_schema_types_endpoint = _Endpoint(
            settings={
                'response_type': ([str],),
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/schemas/types',
                'operation_id': 'get_schema_types',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.get_subjects_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/schemas/ids/{id}/subjects',
        ...
        self.get_versions_endpoint = _Endpoint(
            settings={
                'response_type': ([SubjectVersion],),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/schemas/ids/{id}/versions',
    ...
    def get_schema_only(
        ...
        **kwargs
        ...
        >>> thread = api.get_schema_only(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.get_schema_only_endpoint.call_with_http_info(**kwargs)
    ...
    def get_schema_types(
        ...
        **kwargs
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.get_schema_types_endpoint.call_with_http_info(**kwargs)
    ...
    def get_subjects(
        ...
        **kwargs
        ...
        >>> thread = api.get_subjects(id, async_req=True)
        >>> result = thread.get()
