...
class PartitionV3Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_kafka_partition_endpoint = _Endpoint(
            settings={
                'response_type': (PartitionData,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/topics/{topic_name}/partitions/{partition_id}',
                'operation_id': 'get_kafka_partition',
                'http_method': 'GET',
                'servers': [
                    {
        ...
        self.list_kafka_partitions_endpoint = _Endpoint(
            settings={
                'response_type': (PartitionDataList,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/kafka/v3/clusters/{cluster_id}/topics/{topic_name}/partitions',
                'operation_id': 'list_kafka_partitions',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://pkc-00000.region.provider.confluent.cloud",
    ...
    def get_kafka_partition(
        ...
        **kwargs
        ...
        kwargs['partition_id'] = \
            partition_id
        return self.get_kafka_partition_endpoint.call_with_http_info(**kwargs)

    def list_kafka_partitions(
        self,
        cluster_id,
        topic_name,
        **kwargs
        ...
        kwargs['topic_name'] = \
            topic_name
        return self.list_kafka_partitions_endpoint.call_with_http_info(**kwargs)
