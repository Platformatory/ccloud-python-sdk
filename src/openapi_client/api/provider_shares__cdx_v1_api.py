...
class ProviderSharesCdxV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_cdx_v1_provider_share_endpoint = _Endpoint(
            settings={
                'response_type': (CdxV1ProviderShare,),
                'auth': [
                    'api-key'
                ],
                'endpoint_path': '/cdx/v1/provider-shares',
                'operation_id': 'create_cdx_v1_provider_share',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_cdx_v1_provider_share_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'api-key'
                ],
                'endpoint_path': '/cdx/v1/provider-shares/{id}',
                'operation_id': 'delete_cdx_v1_provider_share',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_cdx_v1_provider_share_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/cdx/v1/provider-shares/{id}',
                'operation_id': 'get_cdx_v1_provider_share',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_cdx_v1_provider_shares_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key'
                ...
                'endpoint_path': '/cdx/v1/provider-shares',
                'operation_id': 'list_cdx_v1_provider_shares',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.resend_cdx_v1_provider_share_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'api-key'
                ],
                'endpoint_path': '/cdx/v1/provider-shares/{id}:resend',
                'operation_id': 'resend_cdx_v1_provider_share',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def create_cdx_v1_provider_share(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.create_cdx_v1_provider_share(async_req=True)
        >>> result = thread.get()
        ...
        return self.create_cdx_v1_provider_share_endpoint.call_with_http_info(**kwargs)

    def delete_cdx_v1_provider_share(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.delete_cdx_v1_provider_share_endpoint.call_with_http_info(**kwargs)

    def get_cdx_v1_provider_share(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.get_cdx_v1_provider_share_endpoint.call_with_http_info(**kwargs)
    ...
    def list_cdx_v1_provider_shares(
        ...
        **kwargs
        ...
        >>> thread = api.list_cdx_v1_provider_shares(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_cdx_v1_provider_shares_endpoint.call_with_http_info(**kwargs)

    def resend_cdx_v1_provider_share(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.resend_cdx_v1_provider_share_endpoint.call_with_http_info(**kwargs)
