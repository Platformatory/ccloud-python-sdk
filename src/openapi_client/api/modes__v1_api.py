...
class ModesV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_subject_mode_endpoint = _Endpoint(
            settings={
                'response_type': (Mode,),
                'auth': [
                ...
                'endpoint_path': '/mode/{subject}',
                'operation_id': 'delete_subject_mode',
                'http_method': 'DELETE',
                'servers': [
                    {
        ...
        self.get_mode_endpoint = _Endpoint(
            settings={
                'response_type': (Mode,),
                'auth': [
                    'external-access-token',
        ...
        self.get_top_level_mode_endpoint = _Endpoint(
            settings={
                'response_type': (Mode,),
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/mode',
                'operation_id': 'get_top_level_mode',
                'http_method': 'GET',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.update_mode_endpoint = _Endpoint(
            settings={
                'response_type': (ModeUpdateRequest,),
                'auth': [
                    'external-access-token',
                    'resource-api-key'
                ],
                'endpoint_path': '/mode/{subject}',
                'operation_id': 'update_mode',
                'http_method': 'PUT',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
        ...
        self.update_top_level_mode_endpoint = _Endpoint(
            settings={
                'response_type': (ModeUpdateRequest,),
                'auth': [
                    'external-access-token',
                ...
                'endpoint_path': '/mode',
                'operation_id': 'update_top_level_mode',
                'http_method': 'PUT',
                'servers': [
                    {
                        'url': "https://psrc-00000.region.provider.confluent.cloud",
    ...
    def delete_subject_mode(
        ...
        **kwargs
        ...
        kwargs['subject'] = \
            subject
        return self.delete_subject_mode_endpoint.call_with_http_info(**kwargs)
    ...
    def get_mode(
        ...
        **kwargs
        ...
        >>> thread = api.get_mode(subject, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['subject'] = \
            subject
        return self.get_mode_endpoint.call_with_http_info(**kwargs)

    def get_top_level_mode(
        self,
        **kwargs
    ):
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.get_top_level_mode_endpoint.call_with_http_info(**kwargs)
    ...
    def update_mode(
        ...
        **kwargs
        ...
        >>> thread = api.update_mode(subject, mode_update_request, async_req=True)
        >>> result = thread.get()

        Args:
            subject (str): Name of the subject
            mode_update_request (ModeUpdateRequest): Update Request
        ...
        kwargs['subject'] = \
            subject
        kwargs['mode_update_request'] = \
            mode_update_request
        return self.update_mode_endpoint.call_with_http_info(**kwargs)

    def update_top_level_mode(
        self,
        mode_update_request,
        **kwargs
    ):
        ...
        >>> thread = api.update_top_level_mode(mode_update_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['mode_update_request'] = \
            mode_update_request
        return self.update_top_level_mode_endpoint.call_with_http_info(**kwargs)
