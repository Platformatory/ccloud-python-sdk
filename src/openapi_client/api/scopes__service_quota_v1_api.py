...
class ScopesServiceQuotaV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_service_quota_v1_scope_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key'
                ],
                'endpoint_path': '/service-quota/v1/scopes/{id}',
                'operation_id': 'get_service_quota_v1_scope',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_service_quota_v1_scopes_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key'
                ],
                'endpoint_path': '/service-quota/v1/scopes',
                'operation_id': 'list_service_quota_v1_scopes',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_service_quota_v1_scope(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.get_service_quota_v1_scope_endpoint.call_with_http_info(**kwargs)

    def list_service_quota_v1_scopes(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.list_service_quota_v1_scopes(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_service_quota_v1_scopes_endpoint.call_with_http_info(**kwargs)
