...
class ProviderSharedResourcesCdxV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_image_cdx_v1_provider_shared_resource_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'api-key'
                ],
                'endpoint_path': '/cdx/v1/provider-shared-resources/{id}/images/{file_name}',
                'operation_id': 'delete_image_cdx_v1_provider_shared_resource',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_cdx_v1_provider_shared_resource_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key'
                ],
                'endpoint_path': '/cdx/v1/provider-shared-resources/{id}',
                'operation_id': 'get_cdx_v1_provider_shared_resource',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_cdx_v1_provider_shared_resources_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key'
                ],
                'endpoint_path': '/cdx/v1/provider-shared-resources',
                'operation_id': 'list_cdx_v1_provider_shared_resources',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.update_cdx_v1_provider_shared_resource_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key'
                ...
                'endpoint_path': '/cdx/v1/provider-shared-resources/{id}',
                'operation_id': 'update_cdx_v1_provider_shared_resource',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'id': 'path',
                    'cdx_v1_provider_shared_resource_update': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.upload_image_cdx_v1_provider_shared_resource_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'api-key'
                ...
                'endpoint_path': '/cdx/v1/provider-shared-resources/{id}/images/{file_name}',
                'operation_id': 'upload_image_cdx_v1_provider_shared_resource',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.view_image_cdx_v1_provider_shared_resource_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/cdx/v1/provider-shared-resources/{id}/images/{file_name}',
                'operation_id': 'view_image_cdx_v1_provider_shared_resource',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def delete_image_cdx_v1_provider_shared_resource(
        self,
        id,
        file_name,
        **kwargs
        ...
        kwargs['file_name'] = \
            file_name
        return self.delete_image_cdx_v1_provider_shared_resource_endpoint.call_with_http_info(**kwargs)

    def get_cdx_v1_provider_shared_resource(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.get_cdx_v1_provider_shared_resource_endpoint.call_with_http_info(**kwargs)
    ...
    def list_cdx_v1_provider_shared_resources(
        ...
        **kwargs
        ...
        >>> thread = api.list_cdx_v1_provider_shared_resources(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_cdx_v1_provider_shared_resources_endpoint.call_with_http_info(**kwargs)

    def update_cdx_v1_provider_shared_resource(
        self,
        id,
        **kwargs
    ):
        ...
        >>> thread = api.update_cdx_v1_provider_shared_resource(id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            cdx_v1_provider_shared_resource_update (CdxV1ProviderSharedResourceUpdate): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['id'] = \
            id
        return self.update_cdx_v1_provider_shared_resource_endpoint.call_with_http_info(**kwargs)

    def upload_image_cdx_v1_provider_shared_resource(
        self,
        id,
        file_name,
        **kwargs
        ...
        >>> thread = api.upload_image_cdx_v1_provider_shared_resource(id, file_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['file_name'] = \
            file_name
        return self.upload_image_cdx_v1_provider_shared_resource_endpoint.call_with_http_info(**kwargs)

    def view_image_cdx_v1_provider_shared_resource(
        self,
        id,
        file_name,
        **kwargs
        ...
        kwargs['file_name'] = \
            file_name
        return self.view_image_cdx_v1_provider_shared_resource_endpoint.call_with_http_info(**kwargs)
