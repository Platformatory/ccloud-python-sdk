...
class IdentityPoolsIamV2Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_iam_v2_identity_pool_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/iam/v2/identity-providers/{provider_id}/identity-pools',
                'operation_id': 'create_iam_v2_identity_pool',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_iam_v2_identity_pool_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'api-key',
                ...
                'endpoint_path': '/iam/v2/identity-providers/{provider_id}/identity-pools/{id}',
                'operation_id': 'delete_iam_v2_identity_pool',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_iam_v2_identity_pool_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key',
                ...
                'endpoint_path': '/iam/v2/identity-providers/{provider_id}/identity-pools/{id}',
                'operation_id': 'get_iam_v2_identity_pool',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_iam_v2_identity_pools_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key',
                ...
                'endpoint_path': '/iam/v2/identity-providers/{provider_id}/identity-pools',
                'operation_id': 'list_iam_v2_identity_pools',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.update_iam_v2_identity_pool_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key',
                ...
                'endpoint_path': '/iam/v2/identity-providers/{provider_id}/identity-pools/{id}',
                'operation_id': 'update_iam_v2_identity_pool',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def create_iam_v2_identity_pool(
        self,
        provider_id,
        **kwargs
    ):
        ...
        >>> thread = api.create_iam_v2_identity_pool(provider_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['provider_id'] = \
            provider_id
        return self.create_iam_v2_identity_pool_endpoint.call_with_http_info(**kwargs)

    def delete_iam_v2_identity_pool(
        self,
        provider_id,
        id,
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.delete_iam_v2_identity_pool_endpoint.call_with_http_info(**kwargs)

    def get_iam_v2_identity_pool(
        self,
        provider_id,
        id,
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.get_iam_v2_identity_pool_endpoint.call_with_http_info(**kwargs)

    def list_iam_v2_identity_pools(
        self,
        provider_id,
        **kwargs
    ):
        ...
        >>> thread = api.list_iam_v2_identity_pools(provider_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['provider_id'] = \
            provider_id
        return self.list_iam_v2_identity_pools_endpoint.call_with_http_info(**kwargs)

    def update_iam_v2_identity_pool(
        self,
        provider_id,
        id,
        **kwargs
        ...
        >>> thread = api.update_iam_v2_identity_pool(provider_id, id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            iam_v2_identity_pool (IamV2IdentityPool): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['id'] = \
            id
        return self.update_iam_v2_identity_pool_endpoint.call_with_http_info(**kwargs)
