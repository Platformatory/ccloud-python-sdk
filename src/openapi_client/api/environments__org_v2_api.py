...
class EnvironmentsOrgV2Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_org_v2_environment_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/org/v2/environments',
                'operation_id': 'create_org_v2_environment',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_org_v2_environment_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/org/v2/environments/{id}',
                'operation_id': 'delete_org_v2_environment',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_org_v2_environment_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/org/v2/environments/{id}',
                'operation_id': 'get_org_v2_environment',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_org_v2_environments_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/org/v2/environments',
                'operation_id': 'list_org_v2_environments',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.update_org_v2_environment_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key',
                ...
                'endpoint_path': '/org/v2/environments/{id}',
                'operation_id': 'update_org_v2_environment',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def create_org_v2_environment(
        ...
        **kwargs
        ...
        >>> thread = api.create_org_v2_environment(async_req=True)
        >>> result = thread.get()
        ...
        return self.create_org_v2_environment_endpoint.call_with_http_info(**kwargs)

    def delete_org_v2_environment(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.delete_org_v2_environment_endpoint.call_with_http_info(**kwargs)

    def get_org_v2_environment(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.get_org_v2_environment_endpoint.call_with_http_info(**kwargs)

    def list_org_v2_environments(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.list_org_v2_environments(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_org_v2_environments_endpoint.call_with_http_info(**kwargs)

    def update_org_v2_environment(
        self,
        id,
        **kwargs
    ):
        ...
        >>> thread = api.update_org_v2_environment(id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            org_v2_environment (OrgV2Environment): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['id'] = \
            id
        return self.update_org_v2_environment_endpoint.call_with_http_info(**kwargs)
