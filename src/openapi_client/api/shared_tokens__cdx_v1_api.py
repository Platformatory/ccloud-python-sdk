...
class SharedTokensCdxV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.redeem_cdx_v1_shared_token_endpoint = _Endpoint(
            settings={
                'response_type': (CdxV1RedeemTokenResponse,),
                'auth': [
                    'api-key'
                ],
                'endpoint_path': '/cdx/v1/shared-tokens:redeem',
                'operation_id': 'redeem_cdx_v1_shared_token',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.resources_cdx_v1_shared_token_endpoint = _Endpoint(
            settings={
                'response_type': (InlineResponse2005,),
                'auth': [
                    'api-key'
                ],
                'endpoint_path': '/cdx/v1/shared-tokens:resources',
                'operation_id': 'resources_cdx_v1_shared_token',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def redeem_cdx_v1_shared_token(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.redeem_cdx_v1_shared_token(async_req=True)
        >>> result = thread.get()
        ...
        return self.redeem_cdx_v1_shared_token_endpoint.call_with_http_info(**kwargs)

    def resources_cdx_v1_shared_token(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.resources_cdx_v1_shared_token(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.resources_cdx_v1_shared_token_endpoint.call_with_http_info(**kwargs)
