...
class ClustersKsqldbcmV2Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_ksqldbcm_v2_cluster_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/ksqldbcm/v2/clusters',
                'operation_id': 'create_ksqldbcm_v2_cluster',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_ksqldbcm_v2_cluster_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'api-key',
                ...
                'endpoint_path': '/ksqldbcm/v2/clusters/{id}',
                'operation_id': 'delete_ksqldbcm_v2_cluster',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_ksqldbcm_v2_cluster_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key',
                ...
                'endpoint_path': '/ksqldbcm/v2/clusters/{id}',
                'operation_id': 'get_ksqldbcm_v2_cluster',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_ksqldbcm_v2_clusters_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'api-key',
                ...
                'endpoint_path': '/ksqldbcm/v2/clusters',
                'operation_id': 'list_ksqldbcm_v2_clusters',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def create_ksqldbcm_v2_cluster(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.create_ksqldbcm_v2_cluster(async_req=True)
        >>> result = thread.get()
        ...
        return self.create_ksqldbcm_v2_cluster_endpoint.call_with_http_info(**kwargs)

    def delete_ksqldbcm_v2_cluster(
        self,
        environment,
        id,
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.delete_ksqldbcm_v2_cluster_endpoint.call_with_http_info(**kwargs)

    def get_ksqldbcm_v2_cluster(
        self,
        environment,
        id,
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.get_ksqldbcm_v2_cluster_endpoint.call_with_http_info(**kwargs)

    def list_ksqldbcm_v2_clusters(
        self,
        environment,
        **kwargs
    ):
        ...
        >>> thread = api.list_ksqldbcm_v2_clusters(environment, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment'] = \
            environment
        return self.list_ksqldbcm_v2_clusters_endpoint.call_with_http_info(**kwargs)
