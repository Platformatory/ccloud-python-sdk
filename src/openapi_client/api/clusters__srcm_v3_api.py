...
class ClustersSrcmV3Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_srcm_v3_cluster_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key'
                ],
                'endpoint_path': '/srcm/v3/clusters/{id}',
                'operation_id': 'get_srcm_v3_cluster',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_srcm_v3_clusters_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'cloud-api-key'
                ],
                'endpoint_path': '/srcm/v3/clusters',
                'operation_id': 'list_srcm_v3_clusters',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_srcm_v3_cluster(
        ...
        **kwargs
        ...
        [![Preview](https://img.shields.io/badge/Lifecycle%20Stage-Preview-%2300afba)](#section/Versioning/API-Lifecycle-Policy)  Make a request to read a cluster.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_srcm_v3_cluster(environment, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.get_srcm_v3_cluster_endpoint.call_with_http_info(**kwargs)

    def list_srcm_v3_clusters(
        self,
        environment,
        **kwargs
    ):
        ...
        [![Preview](https://img.shields.io/badge/Lifecycle%20Stage-Preview-%2300afba)](#section/Versioning/API-Lifecycle-Policy)  Retrieve a sorted, filtered, paginated list of all clusters.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_srcm_v3_clusters(environment, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment'] = \
            environment
        return self.list_srcm_v3_clusters_endpoint.call_with_http_info(**kwargs)
