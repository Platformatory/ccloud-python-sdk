...
class SignupPartnerV2Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.activate_signup_endpoint = _Endpoint(
            settings={
                'response_type': (PartnerSignupResponse,),
                'auth': [
                    'oauth'
                ],
                'endpoint_path': '/partner/v2/signup/activate',
                'operation_id': 'activate_signup',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'activate_partner_signup_request': 'body',
                },
        ...
        self.signup_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/partner/v2/signup',
                'operation_id': 'signup',
                'http_method': 'POST',
                'servers': None,
            },
        ...
        self.signup_partner_v2_link_endpoint = _Endpoint(
            settings={
                'response_type': (PartnerSignupResponse,),
                'auth': [
                    'oauth'
                ],
                'endpoint_path': '/partner/v2/signup/link',
                'operation_id': 'signup_partner_v2_link',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def activate_signup(
        ...
        **kwargs
        ...
        >>> thread = api.activate_signup(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            activate_partner_signup_request (ActivatePartnerSignupRequest): A JSON object containing signup information. [optional]
        ...
        return self.activate_signup_endpoint.call_with_http_info(**kwargs)
    ...
    def signup(
        ...
        **kwargs
        ...
        >>> thread = api.signup(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            dry_run (bool): If true, only perform validation of signup. [optional]
            partner_signup_request (PartnerSignupRequest): A JSON object containing signup information. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
    ...
    def signup_partner_v2_link(
        ...
        **kwargs
        ...
        >>> thread = api.signup_partner_v2_link(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            dry_run (bool): If true, only perform validation of signup. [optional]
            partner_link_request (PartnerLinkRequest): A JSON object containing signup information. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.signup_partner_v2_link_endpoint.call_with_http_info(**kwargs)
