...
class StatusConnectV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.list_connectv1_connector_tasks_endpoint = _Endpoint(
            settings={
                'response_type': (ConnectV1Connectors,),
                'auth': [
                    'cloud-api-key',
                    'confluent-sts-access-token'
                ],
                'endpoint_path': '/connect/v1/environments/{environment_id}/clusters/{kafka_cluster_id}/connectors/{connector_name}/tasks',
                'operation_id': 'list_connectv1_connector_tasks',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.read_connectv1_connector_status_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/connect/v1/environments/{environment_id}/clusters/{kafka_cluster_id}/connectors/{connector_name}/status',
                'operation_id': 'read_connectv1_connector_status',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def list_connectv1_connector_tasks(
        ...
        **kwargs
        ...
        kwargs['kafka_cluster_id'] = \
            kafka_cluster_id
        return self.list_connectv1_connector_tasks_endpoint.call_with_http_info(**kwargs)

    def read_connectv1_connector_status(
        self,
        connector_name,
        environment_id,
        kafka_cluster_id,
        **kwargs
        ...
        kwargs['kafka_cluster_id'] = \
            kafka_cluster_id
        return self.read_connectv1_connector_status_endpoint.call_with_http_info(**kwargs)
